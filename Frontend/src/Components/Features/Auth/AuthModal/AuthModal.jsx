            ...
            {isOpen && (
                ...
                >
                    <motion.div
                        ...
                        className='relative w-full max-w-md bg-whitesmoke border border-primary rounded-[9px] 
                            shadow-2xl overflow-hidden backdrop-blur-sm'
                        onClick={(e) => e.stopPropagation()}
                    >
                        <div className='absolute inset-0 bg-neutral-900 bg-gradient-to-br from-neutral-700 
                            via-neutral-800 to-[#2c0f4a] pointer-events-none -z-10' />
                        ...
                        <div className='relative px-8 pt-10 pb-6'>
                            ...
                            >
                                <X
                                    size={20}
                                    className='group-hover:rotate-90 text-muted transition-transform duration-200'
                                />
                            </button>
                            <motion.div
                            ...
                            >
                                ...
                                <div className='space-y-2'>
                                    <h2 className='text-2xl text-white font-bold text-foreground tracking-[0.7px]'>
                                        {" "}
                                        Welcome to Fitlab{" "}
                                    </h2>
                                    <p className='text-white text-[15px] leading-relaxed'>
                                        You need to sign in to access {accessFor}. Join thousands of users enjoying our
                                        platform.
                                    </p>
                                </div>
                            </motion.div>
                        ...
                        <div className='px-8 pb-12 space-y-4'>
                            ...
                            <motion.button
                                ...
                                className='w-full flex items-center justify-center px-6 py-[13px] rounded-[7px]
                                    text-foreground text-white bg-purple-600 hover:bg-purple-700 transition-all
                                    duration-200 font-medium shadow-sm hover:shadow-md gap-2 group'
                            >
                                <UserPlus
                                    size={19}
                                    className='text-whitesmoke group-hover:rotate-6 transition-transform duration-200'
                                />
                                Create New Account
                            </motion.button>
