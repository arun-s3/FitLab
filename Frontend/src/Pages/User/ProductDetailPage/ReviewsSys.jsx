    ...
    const reviews = [
        {
            ...
            rating: 5,
            comment:
                "The product got delivered a day ago, they are very easy to handle but they have to be handled carefully... Hope they last long, they appear much bigger than most dumbbells but it offers a good grip, while placing the dumbbells back care must be taken...",
        },
        {
            id: 2,
            name: "Sam T",
            ...
            rating: 5,
            comment:
                "Super easy to use and makes changing weights a breeze. The weights hold in place quite well after a nice audible click. Their support team is quite active and is very prompt in signing any issues you have. Overall, I would definitely recommend getting these.",
        },
        {
            id: 3,
            name: "Ajith Kavil",
            ...
            rating: 5,
            comment:
                "I got this looking for adjustable dumbbells and was happy to receive really cool looking dumbbells with great built quality. I find them to be totally worth the money - only hope is that their after sales is good in Kolkata where I'm using the pair.",
        },
    ]
                ...
                <div className='space-y-[16px]'>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            name='comment'
                            rows={3}
                            className='mt-[4px] block w-full text-[14px] border-gray-300 rounded-md'
