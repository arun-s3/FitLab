...
export default function FilterModule({
                ...
                if (!error.response) {
                    ...
                    sonnerToast.error(
                        error.response.data.message ||
                            "Error while loading the category specific products. Pleae try later",
                    )
                } else {
    ...
    const popularProductsHandler = (e, product) => {
        ...
        if (!e.target.checked) {
            ...
            setFilter((filter) => ({ ...filter, products: updatedProducts }))
        }
    }
        ...
        <aside className='hidden xx-md:flex flex-col gap-[10px] basis-[15rem] mb-[5rem]'>
            ...
            <div className='pb-[10px] border-b border-[#DEE2E7]'>
                ...
                <AnimatePresence>
                    {showFilter.category && (
                        <motion.ul
                            className='list-none cursor-pointer pr-[7px]'
                            id='filter-body'
            ...
            <div className='pb-[10px] border-b border-[#DEE2E7]'>
                <div id='filter-header' onClick={() => toggleFilterSection("popularProducts")}>
                    ...
                    {showFilter.popularProducts && (
                        ...
                        >
                            {popularProducts.slice(0, 5 + morePopularProducts).map((product) => (
                                <motion.li key={product} variants={child} whileHover={{ scale: 1.08 }}>
                                    <div>
                                        <motion.input
                                            type='checkbox'
                                        ...
                                        />
                                        <label HTMLfor='gymbell' className=''>
                                            {" "}
            ...
            <div className='pb-[10px] border-b border-[#DEE2E7]'>
                <div id='filter-header' onClick={() => toggleFilterSection("price")}>
                    <h4>Price Range</h4>
                    <span className='cursor-pointer'>
                        {" "}
                        <RiArrowDropUpLine />{" "}
            ...
            <div className='pb-[10px] border-b border-[#DEE2E7]'>
                <div id='filter-header' onClick={() => toggleFilterSection("rating")}>
                    <h4> Ratings </h4>
                    <span className='cursor-pointer'>
                        {" "}
                        <RiArrowDropUpLine />{" "}
            ...
            <div className='pb-[10px] border-b border-[#DEE2E7]'>
                <div id='filter-header' onClick={() => toggleFilterSection("brand")}>
                    <h4>By Brands</h4>
                    <span className='cursor-pointer'>
                        {" "}
                        <RiArrowDropUpLine />{" "}
            ...
            <div className='pb-[10px]'>
                <div id='filter-header' onClick={() => toggleFilterSection("targetMuscles")}>
