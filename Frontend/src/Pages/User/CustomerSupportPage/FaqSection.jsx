    ...
    return (
        <div className='min-h-screen bg-white'>
            <div className='relative'>
                ...
                <div
                    ref={faqContainerRef}
                    className='-mt-[3px] pb-8 bg-black relative overflow-hidden'
                        ...
                        <div className='relative z-10 container mx-auto px-4 pt-0 pb-12'>
                            ...
                            >
                                ...
                                <p className='text-gray-300 text-[13px] max-w-3xl'>
                                    ...
                                    about our gym and fitness services!
                                </p>
                            </motion.div>
                                            ...
                                            {faqData &&
                                                Object.entries(faqData).map(([topic, data]) => {
                                                    ...
                                                    return (
                                                        <motion.button
                                                            key={topic}
                                                            className={`block w-full text-left py-2.5 px-4 rounded-lg 
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <motion.div
                                                                ...
                                                                transition={{ duration: 0.15, ease: "easeOut" }}>
                                                                {/* Question button with full lighting */}
                                                                <motion.button
                                                                ...
                                                                >
                                                                    <div className='flex justify-between items-center'>
                                                                        <h3 className='text-[14px] text-white pr-4'>
                                                                            {faq.question}
                                                                        </h3>
                                                                        <motion.div
