...
import { X, SlidersHorizontal, ChevronDown, ChevronUp, Clock, CheckCircle, XCircle, Shield } from "lucide-react"

import CategoryDisplay from "../../Category/CategoryDisplay/CategoryDisplay"
import PriceSliderAndFilter from "../../../Tools/PriceSliderAndFilter/PriceSliderAndFilter"
import RatingSlider from "../../../UI/RatingSlider/RatingSlider"
import StockFilter from "./StockFilter"

import { capitalizeFirstLetter } from "../../../../Utils/helperFunctions"
import { DateSelector } from "../../../UI/Calender/Calender"
...
export default function ProductFilterSidebar({
    ...
    const handleProductChange = (product) => {
        setSelectedFilters((prev) => ({
            ...prev,
            popularProducts: prev.popularProducts.includes(product)
                ? prev.popularProducts.filter((p) => p !== product)
                : [...prev.popularProducts, product],
        }))
    }
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className='fixed left-0 top-0 h-full w-80 bg-inputBgSecondary shadow-xl z-50 overflow-y-auto'
                    >
                        <div className='flex items-center justify-between p-4 border-b border-dropdownBorder'>
                        ...
                        <div className='p-4 space-y-6 mb-16'>
                            ...
                            <button
                                ...
                                className='w-full text-sm text-right text-red-600 dark:text-red-400 hover:text-red-700 
                            ...
                            <div className='space-y-3'>
                                ...
                                >
                                    <h3 className='text-[15px] font-medium tracking-[0.5px] text-gray-900 '>
                                        {" "}
                                        Category{" "}
                                    </h3>
                                ...
                                {expandedSections.category && (
                                    <div className='ml-[10px] w-[96%]'>
                                        ...
                                        savedFilters.categoryFilter.categories.length > 0 ? (
                                            <div className='flex gap-[7px]'>
                                                <div className='border border-inputBorderLow px-4 py-[7px] rounded-[8px] max-w-[15rem]'>
                                                    <p className='flex items-start gap-[7px]'>
                                                        <span className='text-[12px] font-medium text-muted whitespace-nowrap'>
                                                            {" "}
                                                            Categories:{" "}
                                                        </span>
                                                        <span className='text-[12px] text-secondary whitespace-pre-wrap 
                                                ...
                                                <X
                                                    className='w-[15px] h-[15px] text-red-500 cursor-pointer hover:scale-110'
                                                    onClick={() => {
                                ...
                                <>
                                    <div className='space-y-3 relative'>
                                        <button
                                            ...
                                            className='flex items-center justify-between w-full text-left'
                                        >
                                            <h3 className='text-[15px] font-medium tracking-[0.5px] text-gray-900 dark:text-white'>
                                                {" "}
                                                Product Status{" "}
                                            </h3>
                                                ...
                                                >
                                                    <div className=''>
                                                        <motion.button
                                                            ...
                                                            className='w-full flex items-center justify-between px-3 py-[8px] 
                                                                bg-whitesmoke border border-dropdownBorder rounded-lg text-white
                                                                    ...
                                                                    return (
                                                                        <>
                                                                            <div>
                                                                                <IconComponent
                                                                                    className={`w-4 h-4 
                                                                                        ${selectedOption?.color || "text-neutral-400"}`}
                                                                                />
                                                                            </div>
                                                        ...
                                                        <AnimatePresence>
                                                            {isStatusDropdownOpen && (
                                                                <motion.div
                                                                    ...
                                                                    className='absolute top-full left-0 right-0 w-full mt-2
                                                                      bg-whitesmoke text-[13px] border border-dropdownBorder 
                                                                        ...
                                                                        return (
                                                                            <motion.button
                                                                                ...
                                                                                className={`w-full flex items-center gap-3
                                                                                    px-3 py-[10px] text-left transition-all 
                                                                                    duration-200 cursor-pointer ${
                                                                                    selectedFilters.productStatus ===
                                                                                    option.value
                                                                                        ? `bg-purple-500/20 border-l-4 
                                                                                            border-purple-400`
                                                    ...
                                                    >
                                                        ...
                                                        {(selectedFilters.startDate || selectedFilters.endDate) && (
                                                            <motion.div
                                                                ...
                                                                className='text-center px-3 py-[4px] bg-whitesmoke 
                                ...
                                {expandedSections.popularProducts && (
                                    <ul className='list-none ml-[10px] space-y-2 overflow-visible'>
                                        {popularProducts.slice(0, 5 + morePopularProducts).map((product) => (
                                            ...
                                            >
                                                <div className='flex items-center space-x-2 text-gray-700 hover:text-secondary 
                                                    cursor-pointer'
                                                >
                                                    <motion.input
                                                        type='checkbox'
                                        ...
                                        <span
                                            className='mt-[5px] text-secondary text-[13px] cursor-pointer hover:underline transition duration-500'
                            ...
                            <div className='space-y-3'>
                                ...
                                {expandedSections.price && (
                                    <div className='ml-[10px] w-[95%]'>
                                        ...
                                        <PriceSliderAndFilter
                                            priceGetter={{ minPrice, maxPrice }}
                                            ...
                                            {brands.map((brand) => (
                                                ...
                                                >
                                                    <motion.input
                                                        ...
                                                        className='w-4 h-4 text-purple-600 border-gray-300 rounded focus:ring-0'
                                                    />
                                                    <span className='text-sm text-inherit dark:text-gray-300'>
                                                        {" "}
                                                        {brand}{" "}
                                                    </span>
                                                </motion.label>
                        ...
                        <div className='sticky bottom-0 p-4 bg-white dark:bg-gray-900 border-t border-gray-200 z-[100]'>
                            <button
                                onClick={applyFilters}
                                className='w-full bg-purple-500 hover:bg-purple-600 text-white font-medium py-3 px-4 
