...
export default function FeaturesSection() {
    ...
    const features = [
        ...
        },
        {
            ...
            learnMoreAction: () => setTimeout(() => navigate("/fitness/training"), 500)
        },
        {
            id: 3,
            icon: Heart,
            ...
            <div className='max-w-7xl mx-auto'>
                ...
                >
                    ...
                    <p className='text-sm sm:text-base text-slate-600 max-w-2xl mx-auto leading-relaxed'>
                        An end-to-end fitness platform combining training, tracking, commerce, and smart experiences in
                        one ecosystem.
                    </p>
                </motion.div>
                    ...
                    {features.map((feature) => {
                        ...
                        return (
                            <motion.div
                                ...
                                whileHover='hover'
                                className='group relative bg-white rounded-xl p-3 sm:p-4 border border-slate-200 
                                    cursor-pointer overflow-hidden transition-shadow duration-300 hover:shadow-lg'
                            >
                                <motion.div
                                ...
                                <div className='relative z-10'>
                                    ...
                                    <h3 className='text-base sm:text-lg font-bold text-slate-900 mb-1 group-hover:text-slate-700 
                                    ...
                                    >
                                        Learn more
                                        <motion.span
                                            animate={{ x: hoveredId === feature.id ? 4 : 0 }}
                                            transition={{ duration: 0.3 }}>
                                            →
                                        </motion.span>
                                    </motion.button>
