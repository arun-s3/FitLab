...
import { AdminSocketContext } from "../../../Socket-providers/AdminSocketProvider/AdminSocketProvider"
                ...
                <>
                    ...
                    <div className='fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none'>
                        <motion.div
                            ...
                            className='bg-white rounded-[9px] shadow-2xl w-full max-w-2xl max-h-[85vh] flex flex-col 
                        ...
                        >
                            <motion.div
                                ...
                                className='bg-gradient-to-r from-purple-600 to-purple-700 px-6 py-4 flex items-center 
                                    justify-between'
                            >
                            ...
                            >
                                <div className='bg-purple-50 border border-purple-200 rounded-[7px] p-4 mb-4'>
                                    <div className='flex items-start gap-3'>
                                        ...
                                        <div>
                                            <h3 className='text-purple-900 font-medium text-sm mb-1'>
                                                Send Quick Message
                                            </h3>
                                            <p className='text-purple-700 text-sm leading-relaxed'>
                                                {`Compose a one-way message to notify this customer. ${
                                                    addSubtitle
                                                        ? addSubtitle
                                ...
                                <div className='space-y-4'>
                                    <div className='space-y-2'>
                                        ...
                                        <input
                                            ...
                                            className='w-full px-4 py-3 text-[15px] placeholder:text-[14px] bg-white border border-gray-300 
                                                rounded-[7px] focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent 
                                                text-gray-800 placeholder-gray-400 text-sm md:text-base shadow-sm'
                                        />
                                    </div>
                                    <div className='space-y-2'>
                                        ...
                                        <textarea
                                            ...
                                            rows='8'
                                            className='w-full px-4 py-3 text-[15px] placeholder:text-[14px] bg-white border 
                                                border-gray-300 rounded-[7px] resize-none focus:outline-none focus:ring-2 
                                                focus:ring-purple-500 focus:border-transparent text-gray-800 placeholder-gray-400 
                                        ...
                                        <div className='flex flex-wrap gap-2'>
                                            {[
                                                ...
                                                <motion.button
                                                    ...
                                                    className='px-3 py-1.5 bg-white hover:bg-gray-100 text-gray-700 text-xs 
                                                        md:text-sm rounded-lg transition-colors border border-gray-200 shadow-sm'
                                                >
                                                    {quick}
                                                </motion.button>
                                            ))}
                                ...
                                <div className='flex gap-3 flex-col sm:flex-row'>
                                    <motion.button
                                        ...
                                        className='flex-1 bg-purple-600 hover:bg-purple-700 disabled:bg-gray-300 disabled:cursor-not-allowed
                                            text-white rounded-[8px] px-4 py-3 transition-colors shadow-md hover:shadow-lg font-medium 
