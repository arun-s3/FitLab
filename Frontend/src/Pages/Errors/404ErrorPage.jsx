                    ...
                    <div className='grid lg:grid-cols-2 gap-12 items-center'>
                        ...
                        >
                            ...
                            >
                                ...
                                <h1 className='text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 text-primaryDark mb-4'>
                                    Page not found!
                                </h1>
                            ...
                            >
                                <motion.button
                                    ...
                                    className='inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 
                                        text-white font-semibold py-3 px-8 rounded-[10px] transition-colors duration-200 
                        ...
                        <motion.figure className='ml-8 xs-sm:ml-0 w-[20rem] h-[8rem] xxs-sm:w-[25rem] xxs-sm:h-[8rem] 
                            xs-sm:w-[32rem] xs-sm:h-[12rem] sm:w-[35rem] sm:h-[16rem] lg:w-[32rem] lg:h-[12rem] 
                            x-lg:w-[37rem] x-lg:h-[16rem] lg:ml-[-2rem] x-lg:ml-[-5rem] xl:ml-0'
                        >
                            <motion.img src='/Images/404Error.png' className='w-full h-full' />
                        </motion.figure>
