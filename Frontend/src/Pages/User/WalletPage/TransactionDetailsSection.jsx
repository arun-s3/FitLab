...
export default function TransactionDetailsSection({ transactions, queryOptions, setQueryOptions }) {
    ...
    const sortTypes = [
        { name: "Recent to Oldest Transactions", value: "-1", sortBy: "createdAt" },
        { name: "Oldest to Recent Transactions", value: "1", sortBy: "createdAt" },
        { name: "Biggest to smallest amount", value: "-1", sortBy: "amount" },
        { name: "Smallest to biggest amount", value: "1", sortBy: "amount" },
    ]
    ...
    return (
        ...
        >
            <div
                className={`px-3 mob:px-4 s-sm:px-5 md:px-6 pt-5 md:pt-6 
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <FunnelPlus
                            className='w-[21px] mob:w-[22px] h-[21px] mob:h-[22px] p-[3px] text-muted border 
                                border-inputBorderLow rounded-[4px] hover:text-secondary hover:shadow-md hover:border-muted
                                hover:bg-whitesmoke hover:scale-105 transition-all duration-200 cursor-pointer'
                            onClick={(e) => {
                        ...
                        >
                            ...
                            {openDropdowns.sortDropdown && (
                                <ul
                                    className='list-none w-[12rem] mob:w-[13rem] px-[10px] py-[0.8rem] absolute top-[2.3rem] right-0
                                        flex flex-col gap-[8px] justify-center text-[10px] bg-white border border-borderLight2 
                                        rounded-[8px] z-[5] cursor-pointer shadow-md'
                                >
                                    {sortTypes.map((sortType) => (
                                        <li key={`${sortType.value}-${sortType.sortBy}`}>
                                            <span className='flex items-center gap-[6px]'>
                                                ...
                                                />
                                                <span
                                                    className='text-[10px] mob:text-[11px] whitespace-nowrap text-muted font-medium
                    ...
                    >
                        ...
                        >
                            {transactions.slice(0, sliceIt).map((transaction) => {
                                ...
                                const transactionColor = getTransactionTypeStyle(
                                    transaction.type,
                                    transaction.status,
                                )?.color
                                ...
                                const transactionBorder =
                                    transaction.status === "pending"
                                        ...
                                        : ""
                                const TransactionIcon = getTransactionTypeStyle(
                                    transaction.type,
                                    transaction.status,
                                )?.icon
                                ...
                                return (
                                    <motion.tr
                                        key={transaction._id}
                                        className='text-[12px] mob:text-[13px] sm:text-[14px] text-nowrap 
                                    ...
                                    >
                                        <td
                                            className={`${transactionBorder && `border border-dashed border-r-0 rounded-[7px] 
                                                ${transactionBorder}`}`}
                                        >
                                        ...
                                        >
                                            {getTransactionSource(
                                                transaction.transactionAccountDetails,
                                                transaction.type,
                                            )}
                                        </td>
                                                ...
                                                <td>
                                                    <div className='flex flex-col gap-[8px] items-center'>
                                                        <div
                                                            ...
                                                            <Check
                                                                className='w-[18px] h-[18px] p-[3px] text-green-500 
                                                                    bg-green-200 rounded-[10px] border border-green-500'
                                                            />
                                                            <span
                                                        ...
                                                        <div
                                                            ...
                                                            <X className='w-[18px] h-[18px] p-[3px] text-red-500 
                                                                bg-red-200 rounded-[10px] border border-red-500' />
                                                            <span
                                                                className={`absolute bottom-[1.3rem] right-[0.5rem] whitespace-nowrap
                                                                    bg-gray-800 text-white text-xs rounded px-2 py-1
                                                                    opacity-0 group-hover:opacity-100 transition-all duration-300 z-10
            ...
            >
                {transactions && totalPages && (
                    <PaginationV2
                        ...
                        bgColorStyle='mob:bg-primary max-mob:text-primary'
                        onPageChange={(page) => {
                            setCurrentPage(page)
                            setSliceIt(6)
                        }}
