    ...
    const extraTestimonials = [
        {
            _id: 1,
            comment:
                "I recently ordered some equipment including a squat rack, barbell, weighted plates and a at bench. Having used them over the last few weeks, I have to say that the quality and finish of all the products is absolutely fantastic.totally satisfied",
            name: "Jacob Vargeese",
            location: "Ernakuiam",
        ...
        },
        {
            _id: 3,
            comment:
                "Outstanding service and exceptional quality. The attention to detail is remarkable and the customer support team is always ready to help. Highly recommended!",
            name: "Priya Singh",
            location: "Mumbai",
        ...
        },
        {
            _id: 4,
            comment:
                "Best purchase I've made in years. The durability and build quality are unmatched. Worth every penny and I've already recommended to all my friends.",
            name: "Rajesh Kumar",
            location: "Delhi",
            profilePic: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop",
        },
                    ...
                    <div className='flex gap-4'>
                        <motion.button
                            ...
                            className='w-12 h-12 md:w-14 md:h-14 rounded-full bg-white hover:bg-primary text-black 
                                ...
                                shadow-[0_0_8px_2px_var(--PRIMARY)]'
                        >
                            <ArrowLeft size={24} />
                        </motion.button>
                        <motion.button
                        ...
                        {visibleTestimonials &&
                            ...
                            visibleTestimonials.map((testimonial, index) => (
                                ...
                                >
                                    ...
                                    <div
                                        className='absolute bottom-4 right-8 text-muted text-9xl md:text-10xl font-bold opacity-15 
                                    ...
                                    <div className='h-full flex flex-col justify-between gap-8'>
                                        <p
                                            className='text-gray-600 text-base md:text-lg leading-relaxed mb-8 relative z-10 pr-8 pl-4 
