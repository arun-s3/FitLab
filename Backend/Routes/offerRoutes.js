...
offerRouter.post("/update/:offerId", isLogin, authorizeAdmin, upload.single("offerBanner"), updateOffer)
offerRouter.delete("/delete/:offerId", isLogin, authorizeAdmin, deleteOffer) 
