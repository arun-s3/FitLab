        ...
        <>
            {!checkboxType ? (
                ...
                >
                    ...
                    />
                    <p
                        className={` ${fontSize ? `text-[${fontSize}]` : "text-xs"} text-gray-500 text-center 
                    ...
                    >
                        ...
                        <a
                            ...
                            target='_blank'
                            rel='noopener noreferrer'
                            className='text-secondary hover:underline decoration-secondary transition duration-150 
                                underline-offset-2'
                        >
                            {" "}
                            Terms & Conditions
