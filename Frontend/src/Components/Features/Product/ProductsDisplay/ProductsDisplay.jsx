                  ...
                  return (
                      <div className='mx-[1.5rem] mb-[1rem] p-[1rem] flex flex-col gap-[15px] bg-inputBgSecondary rounded-[8px] shadow-sm'>
                          <h2 className='flex justify-between items-center'>
                              ...
                              <span
                                  className={`px-[12px] py-[2px] ${wishlistPriorityDetails[index].bg} ${wishlistPriorityDetails[index].color} 
                   ...
                   xx-lg:justify-between x-xl:justify-normal text-secondary'>
                        ...
                        l-md:border-inputBorderLow xx-lg:border-mutedDashedSeperation x-xl:border-inputBorderLow admin-control'
                            ...
                            <div
                                ...
                                {!gridView && (
                                    <p
                                        className={`${(admin && !gridView) || wishlistDisplay ? "text-[12px]" : "text-[14px]"} text-wrap 
                                    ...
                                    {(couponApplicableItems &&
                                        ...
                                        (couponApplicableItems &&
                                            ...
                                            couponApplicableItems.products.some((item) => item._id === product._id) && (
                                                <p
                                                    className='mt-[10px] w-fit px-[7px] py-[3px] text-[13px] text-secondary font-medium italic
                                    ...
                                    {wishlistDisplay && (
                                        <div>
                                            ...
                                            {product?.productPriority && (
                                                <p
                                                    className={`mt-[5px] flex items-center gap-[5px] text-[13px] font-[500] tracking-[0.5px]`}>
                                                    <span className='text-[12px] capitalize flex items-center gap-[4px]'>
                                                        <ShieldAlert className='w-[14px] h-[14px] text-muted' />
                                                        <div>
                                                            <span className='text-muted'> Priority: </span>
                                                            <span
                                                                className={`${wishlistPriorityDetails.find((status) => status.value === product.productPriority).color}`}>
                                                                {
                                                                    wishlistPriorityDetails.find(
                                                                        (status) =>
                                                                            status.value === product.productPriority,
                                                                    ).name
                                                                }
                                                            </span>
                                                        </div>
