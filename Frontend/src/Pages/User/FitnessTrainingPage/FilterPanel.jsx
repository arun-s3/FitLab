    ...
    <div className="max-xxs-sm:w-full max-xxs-sm:self-start flex flex-col xxs-sm:flex-row items-start sm:items-center gap-3 flex-wrap">
      <div className="relative">
        <button
          ...
          className={`flex items-center gap-2 text-[12px] md:text-sm px-[12px] md:px-4 py-2 rounded-lg max-xxs-sm:whitespace-nowrap
            font-medium transition-all duration-200 max-xxs-sm:w-[13rem] max-xxs-sm:justify-center ${
                ...
                <div className="grid grid-cols-1 gap-2">
                  {
                    availableMuscles.map((muscle) => (
                      <motion.button
                        ...
                        className={`w-full text-left text-[12px] md:text-sm px-[12px] md:px-4 py-2 rounded-md font-medium transition-all ${
      ...
      {hasActiveFilters && (
        <motion.button
          ...
          className="flex items-center gap-2 text-[12px] md:text-sm px-[12px] py-2 rounded-lg font-medium bg-red-100 text-red-700
           hover:bg-red-200 transition-all max-xxs-sm:w-[13rem] max-xxs-sm:justify-center max-xxs-sm:whitespace-nowrap">
          <X size={16} />
          Clear
        </motion.button>
      )}
