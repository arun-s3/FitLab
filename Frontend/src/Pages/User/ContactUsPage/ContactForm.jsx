            ...
            <div className='grid md:grid-cols-2 gap-8 lg:gap-12 items-start'>
                ...
                >
                    ...
                    <p className='text-gray-600 text-[17px] mb-8'>
                        Reach out for support, feedback, or assistance with FitLab. Our team is ready to assist you at
                        every step of your fitness journey. Email, call, or complete the form for queries.
                    </p>
                                ...
                                >
                                    <div className='flex items-center gap-[7px] mb-1'>
                                        ...
                                        {option.title === "Customer Support" && (
                                            <motion.div
                                                className={`w-[5px] h-[5px] rounded-full 
                                                    ${isSupportConnected ? "bg-green-400" : "bg-red-400"}`}
                                        ...
                                        {option.title === "Coach+ Assistance" && (
                                            <motion.div
                                                className={`w-[5px] h-[5px] rounded-full 
                                                    ${isCoachConnected ? "bg-green-400" : "bg-red-400"}`}
                                                animate={{ scale: [1, 1.4, 1] }}
                                                transition={{ repeat: Number.POSITIVE_INFINITY, duration: 2 }}
                                            />
                                        )}
                    ...
                    <form onSubmit={submitDetails} className='space-y-6'>
                        <div className='grid grid-cols-2 gap-4'>
                            ...
                            >
                                ...
                                />
                                <p className='absolute -bottom-[17px] left-0 text-[11px] text-red-500 tracking-[0.3px]'>
                                    {" "}
                            ...
                            >
                                <input
                                    ...
                                    className={`w-full px-4 py-3 text-[15px] placeholder:text-[14px] bg-gray-100 border
                                        border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 
                                        focus:border-transparent text-gray-900 placeholder-gray-400 transition-all
                        ...
                        >
                            <input
                                ...
                                className={`w-16 px-3 py-3 text-[15px] placeholder:text-[14px] bg-gray-100 border
                                    border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 text-gray-900
                            ...
                            <input
                                ...
                                className={`flex-1 px-4 py-3 text-[15px] placeholder:text-[14px] bg-gray-100 border 
                                    border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 
                                    focus:border-transparent text-gray-900 placeholder-gray-400 transition-all
                                    ${error.phone ? "bg-red-50 border-red-300" : "bg-gray-100 border-gray-200 "}`}
                            />
                            <p className='absolute -bottom-[17px] right-0 text-[11px] text-red-500 tracking-[0.3px]'>
                                {" "}
                        ...
                        >
                            <textarea
                                ...
                                rows='5'
                                maxLength={5000}
                                className='w-full px-4 py-3 text-[15px] placeholder:text-[15px] bg-gray-100 border 
                                    border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 
                                    focus:border-transparent text-gray-900 placeholder-gray-400 transition-all resize-none'
                            />
                            <p className='text-[11px] text-muted tracking-[0.3px]'>
                                {" "}
                                {`${formData.message.length}/ 5000 charaters typed`}{" "}
                            </p>
                        </motion.div>
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            type='submit'
                            className='w-full min-h-10 bg-purple-600 hover:bg-purple-700 text-white font-semibold py-3 
                                px-4 rounded-lg transition-colors flex items-center justify-center gap-2'
                        >
                            {loading ? (
