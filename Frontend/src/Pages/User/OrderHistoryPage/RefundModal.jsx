...
export default function RefundModal({
    ...
    useEffect(() => {
        if (orderReturnRequested && isOpen) {
            sonnerToast.info("Your return request has been sent.", {
                description: "The request will be processed within 24 hrs",
                duration: 4500,
            })
            setStep("success")
            setTimeout(() => {
                        ...
                        {step === "warning" && (
                            ...
                            >
                                <motion.div className='flex items-center gap-4 mb-10' variants={itemVariants}>
                                    ...
                                    <div>
                                        <h1 className='text-[22px] md:text-[30px] font-bold text-secondary'>
                                            Return Request
                                        </h1>
                                        <p className='-mt-[5px] text-[14px] text-gray-600'>
                                            Thank you for initiating the return process
                                        </p>
                                    </div>
                                </motion.div>

                                <motion.div
                                    className='grid grid-cols-1 md:grid-cols-2 gap-4 mb-[10px]'
                                ...
                                >
                                        ...
                                        <div className='flex items-start gap-3'>
                                            ...
                                            <div>
                                                ...
                                                <p className='text-gray-700 text-[13px]'>
                                                    Your refund will be{" "}
                                                    <span className='font-bold'>thoroughly reviewed</span> and initiated
                                    ...
                                    <div className='bg-green-50 border-2 border-green-200 rounded-xl p-6 hover:shadow-md 
                                        transition-shadow'
                                    >
                                        <div className='flex items-start gap-3'>
                                ...
                                <motion.div className='mb-[10px] bg-gray-50 rounded-xl p-6' variants={itemVariants}>
                                    <h3 className='text-[16px] font-semibold text-gray-900 mb-[10px]'>
                                        What Happens Next
                                    </h3>
                                    <ul className='space-y-3 text-gray-700'>
                                        ...
                                        <li className='flex gap-3'>
                                            ...
                                            <span className='text-[15px]'>
                                                Upload 2-3 product images showing the current condition (Optional)
                                            </span>
                                        </li>
                                        <li className='flex gap-3'>
                                            <span className='font-bold text-secondary flex-shrink-0'>3.</span>
                                            <span className='text-[15px]'>
                                                Our quality team will review your return request thoroughly
                                            </span>
                                        </li>
                                        <li className='flex gap-3'>
                                            <span className='font-bold text-secondary flex-shrink-0'>4.</span>
                                            <span className='text-[15px]'>
                                                Refund will be processed and initiated within 24 hours
                                            </span>
                                        </li>
                                        <li className='flex gap-3'>
                                            <span className='font-bold text-secondary flex-shrink-0'>5.</span>
                                            <span className='text-[15px]'>
                                                The refund amount will appear in your Fitlab wallet only
                                            </span>
                                        </li>
                                    </ul>
                                </motion.div>
                                ...
                                {orderOrProduct === "order" && (
                                    <motion.div className='mb-4' variants={itemVariants}>
                                        <label
                                            htmlFor='problemDesc'
                                            className='block text-[15px] text-secondary font-semibold text-gray-900 mb-[7px]'>
                                        ...
                                        <textarea
                                            ...
                                            onChange={(e) =>
                                                onReasonWritten({ reasonTitle: "", reason: e.target.value })
                                            }
                                            ...
                                            className='w-full px-4 py-3 border-2 border-gray-300 rounded-lg 
                                                ...
                                                transition-all resize-none text-gray-700 placeholder-gray-400
                                                text-[14px] placeholder:text-[13px]'
                                            rows='4'
                                        />
                                        <p className='text-[12px] text-gray-500'>
                                            {reasonWritten.reason.length}/500 characters
                                        </p>
                                    </motion.div>
                                )}
                                ...
                                <motion.div className='mb-6' variants={itemVariants}>
                                    <h3 className='text-[15px] text-secondary font-semibold text-gray-900 mb-4'>
                                ...
                                >
                                    <p className='text-[13px] text-amber-900'>
                                        ...
                                        Refunds will only be processed for items that meet our return criteria. Detailed
                                        review is mandatory before any refund is initiated.
                                    </p>
                                </motion.div>

                                <motion.div
                                    className='relative flex flex-col sm:flex-row gap-4 justify-end'
                                    variants={itemVariants}
                                >
                                    <button
                                        onClick={onClose}
                  ...
                  >
                    
                    {
                      loading ? <CustomHashLoader loading={loading} customStyle={{color: 'rgba(215, 241, 72, 1)'}}/> : "Confirm & Submit" 
                                    ...
                                    <div
                                        onMouseEnter={() =>
                                            !reasonWritten.reason.trim() &&
                                            setErrorMsg(
                                                "The description of the problem faced with the product must be entered!",
                                            )
                                        }
                                    ...
                                    <p className='mt-[10px] absolute top-[2.8rem] text-right text-red-500 text-[11px] '>
                                        {" "}
                                        {errorMsg && errorMsg}{" "}
                                    </p>
                                </motion.div>
                        ...
                        {step === "success" && (
                            ...
                            >
                                ...
                                <p className='text-gray-600 text-center text-[15px]'>
                                    Your return has been successfully submitted. You'll receive an update within 24
                                    hours.
                                </p>
                            </motion.div>
                        )}
