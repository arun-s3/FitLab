            ...
            <div className='max-w-6xl mx-auto px-6'>
                ...
                >
                    ...
                    <h2 className='text-[28px] md:text-[50px] font-bold text-gray-900 max-w-3xl'>
                        Building the Future of Fitness, Step by Step
                    </h2>
                </motion.div>
                ...
                >
                    From a simple idea to a full-scale fitness ecosystem, FitLab’s journey reflects continuous
                    innovation—uniting technology, commerce, coaching, and community to help people train smarter and
                    live healthier.
                </motion.p>
