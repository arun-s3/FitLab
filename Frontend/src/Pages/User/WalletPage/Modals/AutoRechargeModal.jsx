...
export default function AutoRechargeModal({ isOpen, onClose, onSave, currentSettings = null }) {
    ...
    const confirmStripeCardSetup = async (clientSecret) => {
        ...
        try {
            ...
            if (!error.response) {
                sonnerToast.error(
                    "Network error while saving the saving the card. Please check your internet and try again!",
                )
            } else {
    ...
    const paymentOptions = [
        { name: "razorpay", iconSrc: "/Images/razorpay.png" },
        { name: "stripe", iconSrc: "/Images/stripe.png" },
    ]
                ...
                >
                    <motion.div
                        ...
                        className='relative bg-white rounded-lg shadow-xl w-full max-w-md 
                            t:max-w-[95%] mob:max-w-[90%] s-sm:max-w-[85%] x-sm:max-w-[500px] max-h-[90vh] 
                    ...
                    >
                        <motion.div
                            ...
                            className='flex items-center justify-between p-3 mob:p-4 border-b'
                        >
                            <h2
                                className='flex items-center gap-[8px] t:gap-[6px] text-[17px] mob:text-[18px] font-semibold 
                                    tracking-[0.3px] leading-tight first-letter:text-[20px]'
                            >
                            ...
                            >
                                {saveSuccess ? (
                                    <div className='p-5 flex flex-col items-center justify-center text-center'>
                                        <div
                                            className='w-14 h-14 mob:w-16 mob:h-16 bg-green-100 rounded-full flex 
                                                items-center justify-center mb-4'>
                                            <CheckCircle className='h-7 w-7 mob:h-8 mob:w-8 text-green-600 ' />
                                        </div>
                                        <h3 className='text-[15px] mob:text-[16px] text-secondary font-semibold mb-2'>
                                            Settings Saved!
                                        </h3>
                                        <p className='text-[12px] mob:text-[13px] text-gray-600 '>
                                        ...
                                        <div className='p-4 mob:p-5 space-y-5'>
                                            <div className='flex items-center justify-between flex-wrap'>
                                                <div className='w-[70%] mob:w-[80%] t:w-full'>
                                                    <h3
                                                        className={`${isEnabled ? "text-[14px]" : "text-[15px]"} text-secondary 
                                                            font-medium`}
                                                    >
                                                        Enable Auto-Recharge
                                                    </h3>
                                                    <p
                                                        className={`${isEnabled ? "text-[11px]" : "text-[12px]"} 
                                                            text-gray-500`}
                                                    >
                                                ...
                                                <label className='relative inline-flex items-center cursor-pointer mt-2 t:mt-3'>
                                                    ...
                                                    />
                                                    <div
                                                        className="w-10 mob:w-11 h-5 mob:h-6 bg-gray-200 peer-focus:outline-none 
                                                            peer-focus:ring-0 rounded-full peer
                                                            peer-checked:after:translate-x-full after:content-[''] after:absolute 
                                                            after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 
                                                            after:border after:rounded-full after:h-4 mob:after:h-5 after:w-4 
                                                            mob:after:w-5 after:transition-all 
...
\                                                    </div>
                                            ...
                                            {isEnabled && (
                                                <>
                                                    <div className='flex flex-col s-sm:flex-row items-start s-sm:items-start gap-5 
                                                        s-sm:gap-[2rem]'
                                                    >
                                                        <div className='relative w-full space-y-2'>
                                                            <div className='flex items-center justify-between'>
                                                                <label
                                                                    ...
                                                                    className='text-[13px] mob:text-[14px] font-medium'>
                                                                    Threshold Amount
                                                                </label>
                                                                <button
                                                                    type='button'
                                                            ...
                                                            <div className='relative'>
                                                                <IndianRupee
                                                                    ...
                                                                    h-[15px] mob:h-[16px] w-[15px] mob:w-[16px] text-gray-500'
                                                                />
                                                                <input
                                                                    id='thresholdAmount'
                                                                    type='text'
                                                                    ...
                                                                    placeholder='25.00'
                                                                    className={`w-full h-[2.4rem] pl-9 pr-4 py-2 text-[13px] 
                                                                        mob:text-[14px] placeholder:text-[13px] mob:placeholder:text-[14px] 
                                                                        rounded-md border 
                                                                ...
                                                                />
                                                                <p className='mt-[5px] text-[10px] mob:text-[11px] text-gray-500'>
                                                        ...
                                                        <div className='relative w-full space-y-2'>
                                                            ...
                                                            <div className='relative'>
                                                                <IndianRupee
                                                                    className='absolute left-3 top-[33%] -translate-y-1/2 h-[15px] 
                                                                        mob:h-[16px] w-[15px] mob:w-[16px] text-gray-500'
                                                                />
                                                                <input
                                                                    id='rechargeAmount'
                                                                    type='text'
                                                                    ...
                                                                    placeholder='50.00'
                                                                    className={`w-full h-[2.4rem] pl-9 pr-4 py-2 text-[13px] 
                                                                        mob:text-[14px] placeholder:text-[13px] border 
                                                    ...
                                                    <div className='mt-[2rem] space-y-3'>
                                                        ...
                                                        <div className='space-y-2'>
                                                            {paymentOptions.map((option) => (
                                                                <div
                                                                    key={option.name}
                                                                    className={`border rounded-lg p-[8px] mob:p-[10px] flex 
                                                                        items-center justify-between 
                                                                        ${paymentMethod === option.name 
                                                                            ? "bg-primaryLight border-primaryDark" 
                                                                            : ""
                                                                ...
                                                                >
                                                                    <div className='flex items-center gap-2 mob:gap-3'>
                                                                        <div className='bg-blue-100 p-[6px] mob:p-2 rounded-full'>
                                                                            <img
                                                                                src={option.iconSrc}
                                                                                className='w-[14px] h-[14px] mob:w-[15px] mob:h-[15px]'
                                                                            />
                                                                        </div>
                                                                        <span
                                                                            className={`text-[13px] mob:text-[14px] font-medium capitalize
                                                                                ${option.name !== "stripe" 
                                                                    ...
                                                                    <div>
                                                                        <span
                                                                            className={`mr-4 text-[11px] mob:text-[12px] font-medium 
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            onChange={() =>
                                                                                selectPaymentMethod(option.name)
                                                                            }
                                                                        />
                                                                    </div>
                                                                </div>
                                                        ...
                                                        {errors.paymentMethod && (
                                                            <p className='text-[10px] mob:text-[11px] text-red-500 flex 
                                                                items-center mt-1'
                                                            >
                                                                <AlertCircle className='h-[13px] w-[13px] mr-1' />
                                                                {errors.paymentMethod}
                                                    ...
                                                    >
                                                        <Info className='h-5 w-5 text-blue-600 mb-1 
                                                            mob:mb-0 mob:mr-2 flex-shrink-0' />
                                                        <div className='text-[12px] mob:text-[13px] text-blue-800'>
                                                            <p className='font-medium mb-1'>How Auto-Recharge Works</p>
                                                            <p>
                                                                When your wallet balance falls below the threshold, the
                                                                recharge amount is added automatically using your chosen
                                                                payment method. You’ll be notified each time.
                                                            </p>
                                                        </div>
                                                    </div>
                                        ...
                                        <div className='flex flex-col mob:flex-row !justify-end gap-2 mob:gap-3 p-4 border-t'>
                                            <button
                                                type='button'
                                                onClick={onClose}
                                                className='px-4 py-2 text-[12px] mob:text-[13px] font-medium text-gray-700 
                                                    bg-white border border-gray-300 rounded-md 
                                                     hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-secondary'
                                            >
                                                Cancel
                                            </button>
                                            <div
                                            ...
                                            >
                                                <button
                                                    ...
                                                    className='w-full px-4 py-2 text-[12px] mob:text-[13px] font-medium text-white 
                                                        bg-secondary rounded-md hover:bg-purple-800 focus:outline-none focus:ring-2
                                                        focus:ring-secondary disabled:cursor-not-allowed'
                                                >
                                                    {isLoading ? (
                                                        <CustomHashLoader
                                                            loading={isLoading}
                                                            color='#d7f148'
                                                            customStyle={{ borderColor: "#d7f148" }}
                                                        />
                                                    ) : (
                                                        "Save Settings"
                                                    )}
