...
export const createList = createAsyncThunk("wishlist/add", async ({ wishlistDetails }, thunkAPI) => {
    try {
        const response = await apiClient.post("/wishlist/add", wishlistDetails, {
...
export const addProductToList = createAsyncThunk(
    "addProductToList",
    async ({ listName, productId, productNote, productPriority }, thunkAPI) => {
        try {
            const response = await apiClient.post("/wishlist/product/add", {
                listName,
                productId,
                productNote,
                productPriority,
...
export const removeProductFromList = createAsyncThunk(
    ...
    async ({ listName, productId }, thunkAPI) => {
        try {
...
export const updateList = createAsyncThunk("updateList", async ({ updateListDetails }, thunkAPI) => {
    try {
        const response = await apiClient.put("/wishlist/list/update", updateListDetails, {
            headers: { "Content-Type": "multipart/form-data" },
        })
        return response.data
    } catch (error) {
