...
export default function PaymentManager({
    ...
    stripeOrPaypalPayment,
    onPaymentError,
    retryStripePaymentStatus,
    setRetryStripePaymentStatus,
}) {
                        ...
                        className={`px-[15px] py-[10px] 
                            ${
                                option.name === "cards"
                                    ...
                                    : "xx-xl:w-[18rem] deskt:w-[20rem]"
                            } xx-xl:w-[18rem] deskt:w-[20rem] w-full s-sm:w-auto 
                                ...
                                <span
                                    ...
                                    {option.name === "cards" && (
                                        <span className='ml-[5px] mt-[1px] text-[9px] lg:text-[12px] text-muted font-normal'>
                                            (All global cards accepted - Visa, Mastercard, American Express, Discover,
                                            JCB, etc)
                                        </span>
                                    )}
                                </span>
                                ...
                                {paymentMethod !== "cards" && (
                                    <div
                                      ...
                                      cursor-not-allowed z-[10]'
                                        ...
                                        onMouseEnter={() =>
                                            setCardsEnterError("Please select the cards' radiobutton first!")
                                        }
