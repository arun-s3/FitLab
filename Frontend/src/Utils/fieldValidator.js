        ...
        switch (fieldName) {
            ...
            case "subtitle":
                return regexPatterns.validator(
                    fieldName,
                    value,
                    "Please enter a valid product Subtitle! Must have atleast 20 characters and shouldn't cross 300 characters.",
                )
            case "description":
                return regexPatterns.validator(
                    fieldName,
                    value,
                    "Please enter a valid product Description! Must have atleast 30 characters.(Max 2000 characters only allowed)",
                )
            ...
            case "categoryName":
                return regexPatterns.validator(
                    fieldName,
                    value,
                    "Please enter a valid Category name! Must be under 50 characters.",
                )
            case "categoryDescription":
                return regexPatterns.validator(
                    fieldName,
                    value,
                    "Please enter a valid Category description! Must be under 200 words.",
                )
            ...
            case "categoryBadge":
                return regexPatterns.validator(
                    fieldName,
                    value,
                    "Please enter a valid Category badge! Must be under 30 characters.",
                )
            ...
            case "nickName":
                return regexPatterns.validator(
                    fieldName,
                    value,
                    "Please enter a valid Nickname! The nickname must be under 20 characters (letters or digits) and must have atleast 3 characters.",
                )
            case "district":
            ...
            case "street":
                return regexPatterns.validator(
                    fieldName,
                    value,
                    "Please enter a valid street! Must be under 100 words.",
                )
            case "pincode":
            ...
            case "landmark":
                return regexPatterns.validator(
                    fieldName,
                    value,
                    "Please enter a valid landmark! Must be under 100 words..",
                )
            case "mobile":
            ...
            case "deliveryInstructions":
                return regexPatterns.validator(
                    fieldName,
                    value,
                    "Please enter a valid instructions! Must have atleast 30 characters and under 200 words. Also ;^*+=~`{}|<> are not allowed",
                )
        }
    }
}
