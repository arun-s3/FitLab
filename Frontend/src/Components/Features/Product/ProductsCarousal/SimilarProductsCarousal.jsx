...
import StarGenerator from "../../../Tools/StarGenerator/StarGenerator"
...
export default function SimilarProductsCarousal({ titleColor = null, referenceProductIds }) {
    ...
    return (
        similarProducts && similarProducts.length > 0 && (
            <section>
                <h2
                    className={`text-[1.5rem] ${titleColor ? `text-${titleColor}` : "text-secondary"} font-bold mb-[2rem]`}
                >
                    Similar Products
                </h2>
                ...
                <div className='relative h-auto min-h-[400px] cursor-pointer'>
                    <AnimatePresence custom={direction} initial={false}>
                        <motion.div
                            ...
                            exit='exit'
                        >
                            {similarProducts.slice(currentProductIndex, currentProductIndex + 4).map((product, i) => (
                                <motion.div
                                    key={product.id}
                                ...
                                >
                                    {product.discount && (
                                        <span
                                            className='absolute top-[8px] left-[8px] bg-purple-600 text-white px-[8px] py-[4px] 
                                    ...
                                    <div className='p-[1rem] flex flex-col justify-between w-[300px] sm:w-auto'>
                                        ...
                                        <div>
                                            ...
                                            <h3 className='font-medium break-words whitespace-pre-wrap line-clamp-3'>
                                                {product.name}
                                            </h3>
