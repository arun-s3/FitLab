        ...
        >
            <div className='flex items-start justify-between mb-4'>
                <div className='flex items-center gap-3 flex-1'>
                    ...
                    >
                        <img
                            src={review.userId.profilePic || "/placeholder.svg"}
            ...
            <h4 className='relative font-semibold text-gray-900 dark:text-white mb-3 text-[16px] flex items-start gap-[10px]'>
                ...
                {user && review.userId.username === user.username && (
                    <>
                        <UserPen
                        ...
                        {editTooltip && (
                            <motion.span
                                ...
                                className='absolute left-[28%] top-0 px-[10px] text-[11px] text-muted font-medium 
                                    bg-whitesmoke rounded-[3px]'
                            >
                                Edit
                            </motion.span>
                        )}
            ...
            >
                <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                >
                    {isHelpful ? <FaThumbsUp scale={15} /> : <FaRegThumbsUp scale={15} />}
