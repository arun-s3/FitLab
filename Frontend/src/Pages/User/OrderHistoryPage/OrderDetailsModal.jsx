                        ...
                        >
                            ...
                            >
                                <div className='flex items-start justify-between'>
                                    <div>
                                        ...
                                        <p className='text-sm text-muted font-medium ml-[2.3rem]'>
                                            {order.fitlabOrderId}
                                        </p>
                                    </div>
                                    <motion.button
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div
                                        className={`flex items-center gap-2 px-4 py-2.5 rounded-lg font-medium text-sm border 
                                            ${getStatusColor(order.paymentDetails.paymentStatus)}`}
                                    >
                                    ...
                                    <div className='space-y-4'>
                                        {order.products.map((product, idx) => (
                                            <motion.div
                                                ...
                                                className='border border-slate-200 rounded-xl p-5 hover:shadow-lg 
                                                    hover:border-slate-300 transition-all duration-200 bg-slate-50/50'
                                            >
                                                <div className='flex gap-4 mb-4'>
                                                    <img
                                                        src={product.thumbnail || "/placeholder.svg"}
                                                        alt={product.title}
                                                        className='w-24 h-24 object-cover rounded-lg bg-white border 
                                                ...
                                                <div className='grid grid-cols-2 md:grid-cols-4 gap-3 mb-3'>
                                                    ...
                                                    <div
                                                        className={`p-3 rounded-lg border ${getStatusColor(product.productStatus)}`}>
                                                ...
                                                {product.offerDiscount > 0 && (
                                                    <div className='flex items-center gap-3 bg-emerald-50 border 
                                                        border-emerald-200 p-4 rounded-lg mt-3'
                                                    >
                                                        ...
                                                        <span className='font-bold text-emerald-700'>
                                                            {formatCurrency(product.offerDiscount)}
                                                        </span>
                                                    </div>
                                                )}
                                                ...
                                                {product.extraQuantity > 0 && (
                                                    <p className='text-sm text-emerald-700 mt-3 font-semibold 
                                                        bg-emerald-50 px-3 py-2 rounded-lg inline-block'
                                                    >
                                ...
                                <motion.div
                                    ...
                                    className='bg-gradient-to-br from-purple-50 to-purple-100 border 
                                ...
                                >
                                    ...
                                    {order.deliveryNote && (
                                        <p className='text-sm text-slate-600 mt-4 border-t border-purple-200 pt-4'>
                                            <span className='font-semibold text-slate-900'>Delivery Note:</span>{" "}
                                            {order.deliveryNote}
                                        </p>
                                    )}
                                </motion.div>
                                    ...
                                    <div className='space-y-4'>
                                        ...
                                        {order.paymentDetails.transactionId && (
                                            <div className='py-3'>
                                                ...
                                                <span className='font-mono text-xs bg-white/60 text-slate-800 px-3 py-2 
                                                    rounded-lg inline-block border border-purple-200'
                                                >
                                                    {order.paymentDetails.transactionId}
                                                </span>
                                            </div>
                                ...
                                <motion.div
                                    ...
                                    className='bg-gradient-to-br from-slate-50 to-slate-100 border 
                                        border-slate-200 rounded-xl p-6 space-y-4'
                                >
                                    ...
                                    <div className='bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg p-5 mt-6 
                            ...
                            >
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    onClick={onClose}
                                    className='w-full px-6 py-3 bg-purple-600 text-white font-semibold
                                        rounded-lg hover:bg-slate-800 transition-colors shadow-sm hover:shadow-md'
                                >
                                    Close
                                </motion.button>
                            </motion.div>
