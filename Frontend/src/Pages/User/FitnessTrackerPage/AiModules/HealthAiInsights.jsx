    ...
    const getInsightDataSources = async () => {
        ...
        try {
            ...
            if (latestHealthResponse.status === 200) {
                ...
                const canUseCachedAnalysis =
                    hasAIAnalysis &&
                    ((!hasPrevProfile && !isRelativeAnalysis) || (hasPrevProfile && isRelativeAnalysis))
                ...
                const healthDatas = {
                    analysisType: "latestHealthProfile",
                    latestProfile,
                    prevProfile: prevProfile || null,
                }
            ...
            setError(
                "Something went wrong while finding your health profiles! Please check your network and retry later",
            )
        } finally {
            setLoading(false)
        }
