                                              ...
                                              <motion.tr
                                                          ...
                                                          <div className='w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5 mr-2'>
                                                              <div
                                                                  ...
                                                                  style={{
                                                                      ...
                                                                      backgroundColor: getStockColor(product.totalStock, 5),
                                                                  }}></div>
                                                          </div>
                                                          <span
                                                  ...
                                                  <td className='py-3 px-4'>
                                                      <button
                                                          ...
                                                          className='text-sm font-medium bg-purple-600 hover:bg-purple-700 text-white transition duration-300
                                      ...
                                      font-medium mr-3'>
                                          ...
                                          lowStockDatas.length === 0 && (
                                              <tr>
                                                  <td
                                                      colSpan={4}
                                                      className='w-full h-[5rem] text-[15px] text-muted text-center font-medium tracking-[0.3px]'
