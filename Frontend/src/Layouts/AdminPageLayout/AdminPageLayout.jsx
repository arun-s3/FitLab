...
export default function AdminPageLayout() {
    ...
    const adminContentBgImg = {
        backgroundImage:
            "linear-gradient(to right,rgba(255,255,255,0.9),rgba(255,255,255,0.9)), url('/Images/admin-bg.jpg')",
    }
            ...
            submenu: [
                {
                    ...
                    desc: "Sales, Orders and Customers Insights",
                },
                {
                    id: "operations-overview",
                    label: "Operations Overview",
                    path: "/admin/dashboard/operations",
                    desc: "Inventory, Payments, Offers and Coupons Insights",
                },
            ],
        },
        {
    ...
    return (
        <div id='admin-wrapper'>
            ...
            <div className='flex fixed top-[5rem] w-full'>
                <aside className='hidden xx-md:inline-flex gap-0 z-[10]' id='admin-wrapper-aside'>
                    <div className='h-screen w-[14rem] bg-black' style={asideBgImg} id='aside-content'>
                        ...
                        <nav className='flex justify-center items-center mt-[3.3rem]'>
                            <motion.ul
                                className='w-full ml-[3rem] list-none flex flex-col gap-[1.5rem] justify-center
                            ...
                            >
                                {menuItems.map((item) => (
                                    <motion.li
                                        key={item.id}
                                        className={`${compressList && item.id !== "dashboard" ? "mt-[-10px]" : "mt-0"}`}
                                    ...
                                    >
                                        {item.hasSubmenu ? (
                                            <>
                                                <div
                                                    className={`${showSubmenu[item.id] && "toggleSublist-custom-after"} flex items-start
                                                ...
                                                >
                                                    <span className='flex justify-center items-center gap-[5px] cursor-pointer list-name'>
                                                        <item.icon
                                                            className={`inline-block ${item.id === "support" && "w-[16px] h-[16px]"}`}
                                                        />
                                                        <span
                                                            className={`${showSubmenu[item.id] && "text-primaryDark"}`}>
                                                            {item.label}
                                                        </span>
                                                    </span>
                                                    <RiArrowDropDownLine />
                                                ...
                                                {showSubmenu[item.id] &&
                                                    item.submenu.map((subItem, index) => (
                                                        <AnimatePresence key={subItem?.id || index}>
                                                            <motion.ul
                                                                className='pt-[1rem] pl-[1rem] list-none flex flex-col
                                                                     gap-[10px] justify-center items-start text-white 
                                                                     text-[12.5px] sublist'
                                                                variants={container}
                                                                initial='hidden'
                                                                animate='show'
                                                                ...
                                                                <motion.li variants={child}>
                                                                    <div>
                                                                        ...
                                                                        >
                                                                            <CiSquareChevRight
                                                                                className={`
                                                                                    ${subItem.id === "operations-overview" 
                                                                                        ? "!w-[28px] !h-[28px]" 
                                                                                        : ""
                                                                                    }
                                                                                `}
                                            ...
                                            <div
                                                className={`${showSubmenu[item.id] && "toggleSublist-custom-after"} option`}>
                                                <Link to={item.path} state={{ from: location.pathname }}>
                                                    <item.icon className='w-[13px] h-[13px]' />
                                                    <span
                                                        className={`${showSubmenu[item.id] && "text-primaryDark"} ml-[5px]`}>
                                                        {item.label}
                                                    </span>
                                                </Link>
                                            </div>
                                ...
                                <div
                                    className={`bg-[#5c5858] w-[85%] h-[1.3px] ${showSubmenu.dashboard ? "mt-[2px]" : "mt-[5px]"}`}></div>
                                <li
                                    className={`mt-[-10px] text-[14px] tracking-[0.5px] 
                                ...
                                >
                                    <div className={`${showSubmenu.settings && "toggleSublist-custom-after"} option`}>
                                        <Link to={"/admin/settings"}>
                                            ...
                                            <span className={`${showSubmenu.settings && "text-primaryDark"}`}>
                                                {" "}
                                                Settings{" "}
                                            </span>
                                        </Link>
                ...
                {pageBgUrl && (
                    <div
                        className='basis-full pt-[2rem] pl-[3rem] flex-grow overflow-scroll h-screen'
