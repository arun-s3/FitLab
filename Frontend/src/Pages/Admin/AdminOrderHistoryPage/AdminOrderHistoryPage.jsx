...
export default function AdminOrderHistoryPage() {
    ...
    setPageBgUrl(
        `linear-gradient(to right,rgba(255,255,255,0.93),rgba(255,255,255,0.93)), url('/Images/admin-ProductsListBg.jpg')`,
    )
    ...
    const cancelReasonHandler = (e, options) => {
        if (options.admin) {
            setOpenSelectReasons((selectReason) => ({ ...selectReason, reasonTitle: "Cancelled By Admin:" }))
        }
        if (options.content) {
            setOpenSelectReasons((selectReason) => ({ ...selectReason, reason: e.target.value }))
        }
    }
    ...
    const initiateRefundProcess = () => {
        const refundInfos = {
            ...
            productId: refundDetails.productId,
            refundType: refundDetails.refundType,
        }
        ...
        <section id='AdminOrderHistoryPage'>
            ...
            <header className='mb-[2.5rem] flex justify-between items-center'>
                <div className='basis-[40%]'>
                    <AdminTitleSection
                        heading='Orders'
                        subHeading="Detailed records of every users' orders, enabling you to track and manage order statuses and
                                    history seamlessly."
                    />
                </div>
            </header>
                ...
                <div className='bg-gray-50 min-h-screen'>
                    <div className='mb-[3rem] grid grid-cols-4 gap-6'>
                        {metrics &&
                            ...
                            metrics.map((metric, index) => (
                                <div
                                    key={index}
                                    className='bg-white p-[10px] flex items-start gap-[10px] border border-primary rounded-xl'
                                >
                                    <div className='p-3 bg-primaryDark rounded-lg'>{metric.icon}</div>
                                ...
                                <div className='flex justify-center items-center gap-[5px] w-full h-full'>
                                    ...
                                    <p className='flex flex-col'>
                                        <span className='flex items-center gap-[7px] text-[17px] text-[#686262] font-medium'>
                                            Unable to load
                                            <RotateCcw
                                                className='w-[20px] h-[20px] text-muted p-1 rounded-full border 
                                                    border-dropdownBorder cursor-pointer 
                    ...
                    <div id='order-menu' className='mb-[2rem] flex justify-between items-center'>
                        ...
                        <div className='flex items-center gap-[1rem]'>
                            <div
                                className='h-[35px] text-[14px] text-muted bg-white flex items-center gap-[10px]
                                    justify-between border border-dropdownBorder rounded-[8px] shadow-sm cursor-pointer 
                            ...
                            >
                                <span className='relative flex items-center border-r border-dropdownBorder py-[8px] pl-[10px] pr-[2px]'>
                                    ...
                                    {limit && openDropdowns.limitDropdown && (
                                        <ul
                                            className='absolute top-[44px] left-[3px] right-0 py-[10px] w-[101%] rounded-b-[4px] 
                                                flex flex-col items-center gap-[10px] text-[13px] bg-white border 
                                                border-dropdownBorder rounded-[6px] cursor-pointer'
                                        >
                                            <li onClick={() => limitHandler(10)}> 10 </li>
                                            <li onClick={() => limitHandler(20)}> 20 </li>
                                            <li onClick={() => limitHandler(30)}> 30 </li>
                                            <li className='pb-[5px]' onClick={() => limitHandler(18)}>
                                                {" "}
                                                40{" "}
                                            </li>
                                        </ul>
                            ...
                            <div
                                className='relative h-[35px] px-[16px] py-[8px] text-[14px] text-muted bg-white flex 
                                    items-center gap-[10px] justify-between border border-dropdownBorder rounded-[8px] 
                                    shadow-sm cursor-pointer hover:bg-gray-50 transition-colors
                                    optionDropdown sort-dropdown'
                            ...
                            >
                                ...
                                {openDropdowns.sortDropdown && (
                                    <ul
                                        className='list-none  px-[10px] py-[1rem] absolute top-[44px] left-0 flex flex-col 
                                            gap-[10px] justify-center W-[12rem] text-[10px] bg-white border 
                                            border-borderLight2 rounded-[8px] z-[5] cursor-pointer'
                                        onMouseLeave={() => (mouseInSort.current = false)}
                                        onMouseEnter={() => (mouseInSort.current = true)}
                                    >
                                        <li>
                                            <span>
                                                <input
                                                    ...
                                                    onChange={(e) => radioChangeHandler(e, -1)}
                                                    checked={queryDetails.sort === -1}
                                                />
                            ...
                            <div
                                className='relative h-[35px] px-[16px] py-[8px] text-[13px] text-muted font-500 bg-white flex i
                                    tems-center gap-[10px] justify-between border border-dropdownBorder rounded-[8px] 
                                    shadow-sm cursor-pointer hover:bg-gray-50 transition-colors optionDropdown'
                                id='duration-options'
                                onClick={() => toggleDropdown("durationDropdown")}
                                ref={dropdownRefs.durationDropdown}
                            >
                                ...
                                {openDropdowns.durationDropdown && (
                                    <div className='options'>
                                        {[
                                            ...
                                            <span key={option} onClick={(e) => orderDurationHandler(e)}>
                                                {" "}
                                                {option}{" "}
                                            </span>
                                        ))}
                    ...
                    <div
                        className={`${orders && orders.length && "bg-white rounded-xl shadow-lg"}`}
                        id='order-list-table'
                    >
                                ...
                                <div className='p-[5px] flex gap-2 bg-gray-100 rounded-[9px]'>
                                    {tabs.slice(0, 5).map((tab) => (
                                        <button
                                            ...
                                            style={
                                                activeTab === tab
                                                    ? { boxShadow: "2px 2px 8px 1px rgba(0,0,0,0.09)" }
                                                    : {}
                                            }
                                    ...
                                    <button className='relative px-4 py-2 text-gray-500 hover:bg-gray-50 rounded-lg'>
                                        <Plus
                                            className='w-4 h-4'
                                            onClick={() => toggleDropdown("showTab")}
                                            ref={dropdownRefs.showTab}
                                        />
                        ...
                        {orders && orders.length > 0 ? (
                                    ...
                                    <thead>
                                        <tr className='border-b border-gray-100'>
                                            {[
                                                ...
                                                <th
                                                    key={tableHeader}
                                                    className='px-6 py-3 text-left text-sm font-medium text-gray-500 capitalize'>
                                                    {" "}
                                                    {tableHeader}{" "}
                                                </th>
                                            ))}
                                            <th className='px-6 py-3 text-center text-sm font-medium text-gray-500 capitalize'>
                                                {" "}
                                                Action{" "}
                                            </th>
                                        </tr>
                                                ...
                                                <React.Fragment key={order._id}>
                                                    <tr className='border-b border-gray-100 hover:bg-gray-50'>
                                                        ...
                                                        <td className='px-6 py-4 text-sm text-gray-500 flex items-center gap-[15px]'>
                                                            ...
                                                            <button
                                                                className='relative overflow-hidden rounded-[8px] p-[2px]'
                                                                onMouseEnter={() =>
                                                                    setIsHovered({ orderId: order._id })
                                                                }
                                                                ...
                                                                <div className='relative flex items-center gap-[2px] rounded-2xl  
                                                                    transition-all duration-300'
                                                                >
                                                                    <ShoppingBag
                                                                        className={`h-[15px] w-[15px] text-muted transition-all 
                                                                            duration-300 
                                                                            ${isHovered.orderId === order._id 
                                                                                ? "rotate-[-5deg] scale-110" 
                                                                                : ""
                                                                            }`
                                                                        }
                                                                    />
                                                                    <ChevronDown
                                                                        className={`h-[10px] w-[10px] text-secondary self-end 
                                                                            transition-all duration-300
                                                                            ${isHovered.orderId === order._id 
                                                                                ? "translate-y-[5px]" 
                                                                                : ""}`
                                                        ...
                                                        <td className='px-6 py-4 '>
                                                            {
                                                                <span className='px-[5px] py-[3px] w-[10%] flex gap-[10px] 
                                                                    items-center relative'
                                                                >
                                                                    <span
                                                                        className={`w-[3px] h-[3px] p-[3px] 
                                                                            ${findStyle("order", order.orderStatus, "bg")} rounded-[5px]`}
                                                                        style={{
                                                                            boxShadow: 
                                                                                `0px 0px 5px 2px  
                                                                                    ${findStyle("order", order.orderStatus, "shadow")}`,
                                                                        }}></span>
                                                                    <span
                                                                        className={`capitalize 
                                                                            ${findStyle("order", order.orderStatus, "textColor")} 
                                                                            text-[13px] font-[500] !whitespace-nowrap`}
                                                                    >
                                                                    ...
                                                                    {(order.orderReturnStatus === "accepted" ||
                                                                        ...
                                                                        <p className='absolute mt-[5px] top-[17px] 
                                                                            left-[21px] text-[11px] text-muted whitespace-nowrap'
                                                                        >
                                                        ...
                                                        <td
                                                            className={`px-6 py-4 text-sm text-gray-500 capitalize 
                                                                ${order.orderStatus !== "cancelled" 
                                                                    ? findStyle("payment", order.paymentDetails.paymentStatus, "textColor") 
                                                                    : ""
                                                                } `}
                                                        >
                                                            {order.orderStatus === "cancelled"
                                                        ...
                                                        <td className='px-6 py-4 relative'>
                                                            <div className='flex justify-center items-center gap-2'>
                                                                {[
                                                                    ...
                                                                    <button
                                                                        className='relative py-[4px] px-4 text-secondary 
                                                                            bg-white border border-secondary rounded-[6px]
                                                                            hover:bg-secondary hover:text-white transition 
                                                                            duration-300 cancel-button'
                                                                        data-label='Order'
                                                                        onClick={(e) =>
                                                                            preCancelTheOrder(e, order._id)
                                                                        }
                                                                    >
                                                                        <CircleOff className='w-4 h-4' />
                                                                    </button>
                                                                )}
                                                                {["delivered", "cancelled", "refunded"].every(
                                                                    (status) => status !== order.orderStatus,
                                                                ) && (
                                                                    <SiteSecondaryFillImpButton
                                                                        className='!py-[6px] text-[11px] capitalize'
                                                                        clickHandler={(e) => {
                                                                            const requiredStatus = changeStatus(
                                                                                order.orderStatus,
                                                                                order.orderReturnStatus,
                                                                            ).status
                                                                    ...
                                                                    >
                                                                        {(() => {
                                                                            const { status, icon: Icon } = changeStatus(
                                                                                order.orderStatus,
                                                                                order.orderReturnStatus,
                                                                            )
                                                                            return (
                                                            ...
                                                            {order.orderStatus === "returning" &&
                                                                !order.orderReturnStatus && (
                                                                    <p
                                                                        className='block absolute text-[11px] text-red-500 
                                                                            hover:underline transition-all duration-300 cursor-pointer'
                                                                        onClick={() =>
                                                                            setshowReturnRequestModal({
                                                                                status: true,
                                                                                order,
                                                                                product: null,
                                                                        ...
                                                                        View customer grievances with evidences and more
                                                                        for refund.
                                                                    </p>
                                                                )}
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td colSpan='9' className='pl-[4rem]'>
                                                            {showProducts.orderId === order._id &&
                                                                order.products.map((product, index) => (
                                                                    ...
                                                                    >
                                                                        <div className='flex items-center gap-[2rem]'>
                                                                            <figure className='w-[60px] h-[60px] bg-gray-50 
                                                                            ...
                                                                            <div className='flex-1'>
                                                                                <h4 className='mb-[8px] flex items-center gap-[4rem]'>
                                                                                    <span className='text-gray-800 text-[14px] 
                                                                                        font-[600] hover:text-secondary 
                                                                                        transition-colors cursor-pointer'
                                                                                    >
                                                                                        <span> {product.title} </span>
                                                                                        <span className='ml-[3px] capitalize 
                                                                                            text-[#a09fa8]'
                                                                                        >
                                                                                            {product.productId
                                                                                                ?.variantType
                                                                                    ...
                                                                                    {
                                                                                        <span className='px-[5px] py-[3px] w-[10%] 
                                                                                            flex gap-[10px] items-center relative'
                                                                                        >
                                                                                            <span
                                                                                            ...
                                                                                            {product.productReturnStatus ===
                                                                                                ...
                                                                                                (product.productReturnStatus ===
                                                                                                    "rejected" && (
                                                                                                    <p className='absolute text-[11px] 
                                                                                ...
                                                                                <p className='mb-[8px] text-[11px] text-gray-600'>
                                                                                    {product.subtitle}
                                                                                </p>
                                                                                {product.deliveryNote && (
                                                                                    <p className='mt-[8px] text-[13px] leading-[20px] 
                                                                                        text-gray-500 flex items-center gap-[4px]'
                                                                                    >
                                                                                ...
                                                                                <div className='flex items-center gap-[20px]'>
                                                                                    {[
                                                                                        ...
                                                                                        <button
                                                                                            className='relative py-[4px] px-4 
                                                                                                text-secondary bg-white border 
                                                                                                border-secondary rounded-[6px]
                                                                                                hover:bg-secondary hover:text-white 
                                                                                                transition duration-300  
                                                                                                before:bg-white cancel-button'
                                                                                            data-label='Product'
                                                                                            data-bottom='50'
                                                                                            onClick={(e) =>
                                                                                                cancelTheOrderProduct(
                                                                                                    product.productId,
                                                                                                    order._id,
                                                                                                )
                                                                                            }
                                                                        ...
                                                                        <div
                                                                            ref={productCancelFormRef}
                                                                            className='flex justify-center items-center'>
                                                                            {openCancelForm.type === "product" &&
                                                                                openCancelForm.options.productId ===
                                                                                    product.productId &&
                                                                                openCancelForm.options.orderId ===
                                                                                    order._id &&
                                                                                openCancelForm.status && (

                                                                                    <CancelForm
                                                                                        openSelectReasons={ openSelectReasons }
                                                                                        setOpenSelectReasons={ setOpenSelectReasons }
                                                                                        cancelReasonHandler={ setOpenSelectReasons }
                                                                                        setOpenCancelForm={ setOpenCancelForm }
                                                    ...
                                                    <tr ref={orderCancelFormRef}>
                                                        <td colSpan='9'>
                                                            {openCancelForm.type === "order" &&
                                                                openCancelForm.options.orderId === order._id &&
                                                                openCancelForm.status && (

                                                                    <CancelForm
                                                                        openSelectReasons={openSelectReasons}
                                                                        setOpenSelectReasons={setOpenSelectReasons}
                                                                        cancelReasonHandler={cancelReasonHandler}
                                                                        setOpenCancelForm={setOpenCancelForm}
                                                                        submitReason={submitReason}
                                                                        formFor='order'
                                                                        canceledByAdmin={true}
                            ...
                            <h3
                                className='w-full h-full flex justify-center items-center mt-[6rem] 
