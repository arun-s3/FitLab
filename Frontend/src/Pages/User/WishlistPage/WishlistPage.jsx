...
export default function WishlistPage() {
    ...
    const sortMenu = [
        { name: "Priority: High to Low", value: "priority", order: "-1" },
        { name: "Priority: Low to High", value: "priority", order: "1" },
        { name: "Price: High to Low", value: "price", order: "-1" },
        { name: "Price: Low to High", value: "price", order: "1" },
        { name: "Names: A to Z", value: "alphabetical", order: "1" },
        { name: "Names: Z to A", value: "alphabetical", order: "-1" },
        { name: "Newest First", value: "addedAt", order: "-1" },
        { name: "Oldest First", value: "addedAt", order: "1" },
    ]
    ...
    return (
        <section id='WishlistPage' className='flex gap-[13px] flex-col md:flex-row'>
            <div className='mt-[1rem] basis-[25%] lg:basis-[20%]'>
                ...
                >
                    <div className='flex gap-[10px] items-center'>
                        <TbShoppingCartHeart
                            size={32}
                            className='text-muted w-[28px] h-[28px] xxs-sm:w-[32px] xxs-sm:h-[32px]'
                        />
                        <h1 className='text-[22px] xxs-sm:text-[24px] font-[500] capitalize'>Wishlist</h1>
                    </div>
            ...
            <h3 className='inline-block md:hidden text-[17px] text-secondary font-[600] tracking-[0.3px]'>
                {" "}
                Saved Products{" "}
            </h3>
            <div
