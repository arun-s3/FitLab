                    ...
                    {features.map((feature) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className='group bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl 
                                    p-6 md:p-8 hover:shadow-xl transition-shadow duration-300 border border-gray-200
                            ...
                            >
                                <div className='flex items-start gap-6'>
                                    <div className='flex-1'>
                                        <div
                                            className={`w-12 h-12 rounded-full bg-gradient-to-br 
                                                ${feature.color} flex items-center justify-center mb-4 flex-shrink-0`}
                                        >
                                    ...
                                    <div className='hidden md:flex items-center justify-center flex-shrink-0'>
                                        <div className='w-32 h-32 rounded-2xl bg-gradient-to-br from-gray-50 
                                            to-gray-100 overflow-hidden relative'>
                                            <div className='w-full h-full flex items-center justify-center'>
                                                <img
                                                    className={`w-full h-full object-cover 
                                                        ${feature.id === 2 && "object-[left_-25px_top_0rem]"}`}
                                                    src={feature.image}
                                                />
                                            </div>
                                        </div>
