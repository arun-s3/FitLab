...
export default function ListingTabs({ showProducts, toggleTab, setShowByTable, setShowByGrid }) {
    ...
    return (
        <>
            <div
                className='h-[40px] w-[100px] md:w-[150px] text-[13px] md:text-[14px] bg-white border border-b-[#e5e7eb]
            ...
            <div
                className='h-[40px] w-[100px] md:w-[150px] text-[13px] md:text-[14px] bg-white border 
                    border-b-[#e5e7eb] flex justify-center items-center absolute cursor-pointer
                    top-[-39px] left-[100px] md:left-[150px] tab'
            ...
            <div
                className='h-[40px] w-[100px] md:w-[150px] text-[13px] md:text-[14px] bg-white border 
                    border-b-[#e5e7eb] rounded-tr-[5px] flex justify-center items-center cursor-pointer
                    absolute top-[-39px] left-[200px] md:left-[300px] tab'
                onClick={() => showProducts("blocked")}
            ...
            <div className='hidden md:flex items-center gap-[7px] absolute right-[5px] top-[-30px] view-type'>
                ...
                <span
                    data-label='List View'
                    className='hidden xx-lg:inline-block'
                    onClick={() => {
                        setShowByTable(false)
                        setShowByGrid(false)
                    }}
                >
