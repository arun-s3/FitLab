...
export default function VideoChat({
    socketContextItems,
    ImmediateVideoCallsessionId = null,
    scheduledCallReceived = false,
    scheduledVideoCallSessionId = null,
    onEndCall,
}) {
    ...
    useEffect(() => {
        ...
        const initializeMedia = async () => {
            try {
                ...
                sonnerToast.error(
                    "Error accessing media devices. Please check your browser settings and give us required permissions",
                )
            }
        }
        ...
        <div className='relative overflow-hidden rounded-3xl shadow-2xl bg-white'>
                ...
                <div className='h-full flex flex-col p-6'>
                            ...
                            >
                                <div
                                    className={`max-w-xs px-4 py-2 text-[14px] border border-gray-300 rounded-[5px] shadow-sm ${
                                        msg.sender === "user" ? "bg-gray-200 text-black" : "bg-white text-gray-800"
                                    }`}>
                                    <p>{msg.text}</p>
                    ...
                    <form onSubmit={sendMessage} className='flex gap-3 z-20'>
                        <input
                            ...
                            className='flex-1 px-4 py-[10px] text-[14px] placeholder:text-[13px] border border-gray-300 
                                rounded-[7px] focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent 
                                bg-white shadow-sm'
                        />
                        <button
                            type='submit'
                            className='bg-primary text-[#6C6C77] px-6 py-3 rounded-[7px] hover:bg-primaryDark 
                                transition-all duration-300 font-medium shadow-lg hover:shadow-xl transform hover:scale-105'
                        >
                            Send
                        </button>
                    </form>
            ...
            {sessionId && (
                <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className='p-6 bg-gradient-to-r from-white to-gray-50 flex items-center justify-between 
                        rounded-b-3xl border-t border-gray-200'
                >
                    ...
                    <motion.button
                        ...
                        className='p-4 rounded-2xl bg-gradient-to-br from-red-500 to-red-600 text-white shadow-lg 
                            hover:shadow-xl hover:from-red-600 hover:to-red-700 transition-all duration-300'
                    >
            ...
            {!sessionId && scheduledCallReceived && (
                ...
                >
                    <VideoChatInfoTab
                        startVideoCall={() => startScheduledVideoCall()}
                        declineVideoCall={() => declineScheduledVideoCall()}
                    />
