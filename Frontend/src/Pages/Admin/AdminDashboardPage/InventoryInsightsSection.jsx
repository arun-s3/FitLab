    ...
    return (
        ...
        >
            <h2 className='text-xl text-secondary font-bold flex items-center gap-[10px]'>
                <span className={`w-fit whitespace-nowrap ${!showOperationsAnalytics.inventory && "text-muted"}`}>
                    {" "}
                    Inventory & Stock{" "}
                </span>
                <div
                    ...
                    onClick={() =>
                        togglerEnabled &&
                        setShowOperationsAnalytics((status) => ({ ...status, inventory: !status.inventory }))
                    }
                >
                    <hr
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className={`bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border
                                ${dashboardQuery.trim() && !"Low Stock Alerts".toLowerCase().trim().includes(dashboardQuery.trim()) 
                                    ? "hidden" 
                                    : "inline-block"
                                }`
                            }
                                        ...
                                        {status.lowStockDatas === "success" && lowStockDatas.length > 0 ? (
                                                    ...
                                                    <td className='py-3 px-4'>
                                                        <div className='flex items-center'>
                                                            <div className='w-8 h-8 rounded-full bg-gray-100 flex items-center 
                                                                justify-center text-gray-600 font-medium mr-3'
                                                            >
                                                                <Package size={16} />
                                                            </div>
                                                        ...
                                                        <div className='flex items-center'>
                                                            ...
                                                            >
                                                                <div
                                                                    ...
                                                                    style={{
                                                                        width: `${getStockPercentage(product.totalStock, 5)}%`,
                                                            ...
                                                            <span
                                                                ...
                                                                style={{ color: getStockColor(product.totalStock, 5) }}
                                                            >
                                                                {getStockPercentage(product.totalStock, 5).toFixed(0)}%
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td className='py-3 px-4'>
                                                        <button
                                                            ...
                                                            className='text-sm font-medium bg-purple-600 hover:bg-purple-700 
                                                                ...
                                                                py-[7px] px-4 border border-inputBorderLow rounded-[6px] shadow-md'
                                                        >
                                                            Restock
                                                        </button>
                                                    </td>
                                            ...
                                            [...Array(5)].map((_, index) => (
                                                <motion.tr
                                                    ...
                                                    className='skeleton-loader border-b dark:border-gray-700 hover:bg-gray-50'
                                                >
                                                    <td className='py-3 px-4'>
                                                        <div className='flex items-center'>
                                                            <div
                                                            ...
                                                            <span className='invisible text-[15px]'>
                                                                {" "}
                                                                Product name{" "}
                                                            </span>
                                                        </div>
                                            ...
                                            status.lowStockDatas !== "loading" &&
                                            status.lowStockDatas !== "error" &&
                                            lowStockDatas.length === 0 && (
                                                <tr>
                                                    <td
                                                        colSpan={4}
                                                        className='w-full h-[5rem] text-[15px] text-muted text-center 
                        ...
                        <motion.div
                            ...
                            className={`bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border
                                ${
                                    dashboardQuery.trim() &&
                                    !"Stock Distribution by Category".toLowerCase().trim().includes(dashboardQuery.trim())
                                        ? "hidden"
                                        : "inline-block"
                                }
                            `}
