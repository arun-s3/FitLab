...
const {createProduct, getSingleProduct, getAllProducts, updateProduct, toggleProductStatus, exportProductsAsCsv, exportProductsAsPdf} = require('../Controllers/productController')
