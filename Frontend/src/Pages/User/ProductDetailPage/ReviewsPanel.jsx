    ...
    const handleAddReview = async (newReview) => {
        ...
        try {
            ...
            if (!error.response) {
                ...
                sonnerToast.error(
                    error.response.data.message || "Error while submitting your review. Please try again later!",
                )
            } else {
    ...
    const handleEditReview = async (review) => {
        ...
        try {
            ...
            if (!error.response) {
                ...
                sonnerToast.error(
                    error.response.data.message || "Error while updating your review. Please try again later!",
                )
            } else {
                sonnerToast.error("Internal server error")
            }
                    ...
                    {showForm && (
                        ...
                        >
                            ...
                            <ReviewForm
                                ...
                                onEditSubmission={handleEditReview}
                            />
                    ...
                    {(totalReviewCount > 0 || totalReviews > 0) && (
                        <motion.div className='mb-6 flex items-center gap-4' variants={itemVariants}>
                            ...
                            <select
                                ...
                                className='!w-40 px-4 py-[4px] text-[14px] bg-white dark:bg-zinc-900 border border-gray-300
                                    dark:border-gray-700 rounded-lg text-gray-900 dark:text-white focus:outline-none 
                        ...
                        <motion.button
                            ...
                            onClick={() => {
                                reviewSet.lastIndex === 3
                                    ? setReviewSet({ firstIndex: 0, lastIndex: 6 })
                                    : setReviewSet({ firstIndex: 0, lastIndex: 3 })
                            }}
                        >
                            {reviewSet.lastIndex === 3 ? (
