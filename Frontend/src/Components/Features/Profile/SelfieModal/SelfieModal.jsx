                ...
                <>
                    ...
                    >
                        ...
                        >
                                    ...
                                    >
                                        ...
                                        <motion.button
                                            ...
                                            className='px-8 py-3 bg-gradient-to-r from-purple-500 to-purple-600 
                                                ...
                                                hover:to-purple-700 transition-all duration-200 shadow-lg'
                                        >
                                            Open Camera
                                        </motion.button>
                                    ...
                                    <div className='flex gap-4 w-full justify-center flex-wrap'>
                                        <motion.button
                                            ...
                                            className='px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white 
                                                font-semibold rounded-lg hover:from-green-600 hover:to-emerald-700 transition-all
                                        ...
                                        <motion.button
                                            ...
                                            className='px-6 py-3 bg-slate-500 text-white font-semibold rounded-lg 
                                                hover:bg-slate-600 transition-all duration-200 shadow-lg flex items-center gap-2'
                                        >
                                            <ArrowLeft size={20} />
                                            Back
                                        </motion.button>
                            ...
                            <motion.div className='w-full pb-6 xxs-sm:w-auto text-center'>
                                {!cameraActive && (
                                    <SiteButtonSquare
