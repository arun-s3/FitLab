            ...
            >
                ...
                {unreadCount > 0 && (
                    <motion.span
                        initial={{ scale: 0 }}
                        animate={{ scale: 1 }}
                        className='absolute -top-[3px] -right-[7px] w-5 h-5 bg-primary text-secondary 
                            text-[10px] font-[600] rounded-full flex items-center justify-center'
                    >
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className='absolute right-0 mt-2 w-80 sm:w-96 bg-white rounded-[8px] shadow-2xl border 
