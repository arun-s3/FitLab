        ...
        <div>
            <div
                ...
                >
                    ...
                    <span className='text-secondary typewriter' style={{ fontFamily: "inherit" }}>
                        {" "}
                        Fitness Zone{" "}
                    </span>
                </h1>
                <p
                    className='hero-paragraph text-[13px] xs-sm2:text-[14px] s-sm:text-descReg1 mt-[30px] leading-[27px]
                  mb-[45px] s-sm:mb-[60px] w-[70%] mob:w-[80%] xs-sm:w-[85%] sm:w-[80%] x-md:w-[70%]'
                >
                    At Fitlab, we deliver only the highest quality equipments with the next level precision, stability
                    and endurance. We also provide you with revolutionary supplements and accessories for men and women
                </p>
                <button
