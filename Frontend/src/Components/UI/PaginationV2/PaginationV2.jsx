...
const PaginationV2 = ({ currentPage, totalPages, onPageChange, bgColorStyle, headerStyle, miniVersion = false }) => {
    ...
    if (totalPages <= maxVisiblePages) {
        ...
        if (currentPage <= halfVisible + 1) {
            ...
            pagesToShow = [1, "...", ...pageNumbers.slice(currentPage - 2, currentPage + 1), "...", totalPages]
        }
    }
    ...
    return (
        <nav className={`flex justify-center items-center max-mob:gap-4 space-x-2 mt-8 ${headerStyle && headerStyle}`}>
            ...
            <button
                ...
                className={`${miniVersion ? "p-[4px]" : "px-0 xs-sm2:px-3 py-2"} rounded-lg bg-transparent 
                    xs-sm2:bg-white border-0 xs-sm2:border border-gray-300  text-secondary mob:text-gray-700 
                    ...
                    {page === "..." ? (
                        ...
                        <button
                            ...
                            className={`px-0 mob:px-4 ${miniVersion ? "mob:px-[13px] py-[4px]" : "mob:px-4 py-2"} rounded-lg text-sm 
                                ...
                                currentPage === page
                                    ? `${bgColorStyle ? bgColorStyle : "mob:bg-purple-600 max-mob:text-secondary"} 
            ...
            <button
                ...
                className={`${miniVersion ? "p-[4px]" : "px-0 xs-sm2:px-3 py-2"} rounded-lg bg-transparent xs-sm2:bg-white 
                    border-0 xs-sm2:border border-gray-300 text-secondary mob:text-gray-700 hover:bg-gray-50 
