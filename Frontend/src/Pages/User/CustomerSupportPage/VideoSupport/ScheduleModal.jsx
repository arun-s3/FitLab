...
export default function ScheduleModal({ userId, isOpen, onClose }) {
    ...
    const handleSubmit = async (e) => {
        ...
        if (userId && selectedDate && selectedTime) {
            const isSessionBooked = await bookSession({
                userId,
                scheduledDate: selectedDate,
                scheduledTime: selectedTime,
                subjectLine: selectedTopic,
                notes: notes.trim(),
            })
            if (isSessionBooked) {
                ...
                {isOpen && (
                    ...
                    >
                        ...
                        >
                            ...
                            <div className='relative bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/50 
                                p-8 text-center'
                            >
                                <button
                                    onClick={onClose}
                                ...
                                <p className='text-gray-600 text-[15px] mb-6'>
                                    Your video support session has been confirmed for:
                                </p>

                                <div className='bg-gradient-to-br from-green-50 to-emerald-100 p-6 rounded-2xl mb-6 border 
                                    border-green-200/50'
                                >
                                ...
                                <div className='bg-purple-50 p-4 rounded-2xl border border-blue-200/50'>
                                    ...
                                    <p className='text-purple-600 text-[13px] leading-relaxed'>
                                        You'll receive a video call from our expert at the time you scheduled. Make sure
                                        you are available and active at your scheduled time
                                    </p>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        <div className='relative bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/50 p-6 md:p-8'>
                            ...
                            <div className='flex justify-center mb-8'>
                                <div className='flex space-x-8 text-sm'>
                                    <span
                                        className={`font-medium ${currentStep >= 1 ? "text-blue-600" : "text-gray-400"}`}>
                                        Date & Time
                                    </span>
                                    <span
                                        className={`font-medium ${currentStep >= 2 ? "text-blue-600" : "text-gray-400"}`}>
                                        Details
                                    </span>
                                    <span
                                        className={`font-medium ${currentStep >= 3 ? "text-blue-600" : "text-gray-400"}`}>
                                        Confirm
                                    </span>
                                </div>
                            </div>
                            ...
                            <form
                                ...
                                className='h-[350px] px-[10px] overflow-y-scroll overflow-x-hidden'>
                                {currentStep === 1 && (
                                    <>
                                        {/* Date selection */}
                                        <div className='mb-8'>
                                            <label className='block text-primaryDark font-semibold mb-4 text-[15px]'>
                                                Select a Date
                                            </label>
                                                    ...
                                                    >
                                                        ...
                                                        {selectedDate === date.value && (
                                                            <motion.div
                                                                initial={{ scale: 0 }}
                                                                animate={{ scale: 1 }}
                                                                className='absolute -top-2 -right-2 w-6 h-6 bg-purple-500 
                                            ...
                                            >
                                                <button
                                                    ...
                                                    className='bg-gradient-to-r from-purple-500 to-purple-600 
                                                        text-white text-[15px] py-2 px-8 rounded-[8px] font-semibold
                                    ...
                                    >
                                        ...
                                        <div className='mb-8'>
                                            ...
                                            <select
                                                ...
                                                className='w-full px-4 py-[10px] text-[14px] placeholder:text-[13px]
                                                    placeholder:text-muted border-2 border-gray-200 rounded-[6px] 
                                        ...
                                        <div className='mb-8'>
                                            ...
                                            <textarea
                                                ...
                                                rows={4}
                                                className='w-full p-4 text-[14px] placeholder:text-[13px] placeholder:text-muted 
                                                    border-2 border-gray-200 rounded-[7px] focus:outline-none focus:ring-2 
                                                    focus:ring-secondary focus:border-transparent bg-white shadow-sm resize-none'
                                                maxLength={500}
                                            />
                                        ...
                                        {/* Session summary */}
                                        <div className='mb-8 bg-gradient-to-br from-gray-50 to-white p-6 rounded-2xl border 
                                            border-primary'
                                        >
                                            ...
                                            <div className='flex flex-col gap-[5px]'>
                                                ...
                                                {selectedTopic && (
                                                    <div className='flex justify-between items-start py-2 border-b border-gray-100'>
                                                        ...
                                                        <span className='font-semibold text-gray-800 text-[15px] text-right max-w-xs'>
                                                            {selectedTopic}
                                                        </span>
                                                    </div>
                                                )}
                                                {notes.trim() && (
                                                    <div className='py-2'>
                                                        <span className='text-gray-600 font-medium block mb-2 text-[14px]'>
                                                            Notes:
                                                        </span>
                                        ...
                                        <div className='flex justify-between'>
                                            <button
                                                ...
                                                className='bg-gray-200 hover:bg-gray-300 text-gray-700 text-[15px] 
                                                    py-[8px] px-6 rounded-[8px] font-semibold transition-all duration-300'>
                                                Back
                                            </button>
                                            <button
                                                type='button'
                                                onClick={handleNextStep}
                                                className='bg-gradient-to-r from-green-600 to-emerald-600 text-[15px] 
                                                    text-white py-[8px] px-8 rounded-[8px] font-semibold hover:from-green-700 
                                                    hover:to-emerald-700 transition-all duration-300 transform hover:scale-105 
                                ...
                                {currentStep === 3 && (
                                    ...
                                    >
                                        ...
                                        <div className='bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 
                                            px-8 py-4 rounded-3xl border border-blue-200/50 mb-8'
                                        >
                                            <div className='text-center mb-6'>
                                                <div className='h-[3.5rem] w-[3.5rem] bg-gradient-to-br from-purple-400 
                                                    to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4'
                                                >
                                            ...
                                            <div className='flex flex-col gap-4'>
                                                ...
                                                {notes.trim() && (
                                                    <div className='bg-white/70 backdrop-blur-sm py-2 px-[1.5rem] rounded-[7px]'>
                                                        <span className='text-gray-600 font-medium block mb-2 text-[15px]'>
                                                            Your Notes:
                                                        </span>
                                                        <p className='text-gray-700 text-sm leading-relaxed italic text-[14px]'>
                                                            "{notes}"
                                                        </p>
                                                    </div>
                                                )}
                                        ...
                                        <div className='flex justify-between'>
                                            <button
                                                type='button'
                                                onClick={handlePrevStep}
                                                className='bg-gray-200 hover:bg-gray-300 text-gray-700 text-[15px] py-[12px] 
                                                    px-6 rounded-[8px] font-semibold transition-all duration-300'
                                            >
                                                Back to Edit
                                            </button>
                                            <button
                                                type='submit'
                                                className='bg-gradient-to-r from-purple-600 to-purple-700 text-white py-[12px] 
                                                    px-12 rounded-[8px] font-semibold text-lg hover:from-green-600 
                                                    hover:to-green-700 transition-all duration-300 transform hover:scale-105 
