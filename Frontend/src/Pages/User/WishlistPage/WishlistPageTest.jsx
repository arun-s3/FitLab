...
export default function WishlistPageTest(){
    ...
    return(
        <section id='WishlistPage'>
                ...
                <BreadcrumbBar heading='Wishlist'/>
                
                <main className='flex gap-[2rem] pl-[4rem] pr-[2rem] mb-[10rem] bg-[#F9F9F9]'>
                    ...
                    <div className='basis-[85%] mt-[2rem] flex gap-[13px] content-tile'>
