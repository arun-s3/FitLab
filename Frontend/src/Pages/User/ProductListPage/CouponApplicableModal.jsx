...
export default function CouponApplicableModal({
    open,
    onClose,
    couponLabel = "Selected Coupon",
    products = [],
    categories = [],
}) {
    ...
    return createPortal(
        ...
        <AnimatePresence>
            {open ? (
                ...
                >
                    <motion.div className='absolute inset-0 bg-black/50 backdrop-blur-sm' variants={overlayVariants} />
                    <motion.div
                        key='panel'
                        ref={panelRef}
                        tabIndex={-1}
                            ...
                            <div className='flex items-center gap-2'>
                                ...
                                <div className='min-w-0'>
                                    <h2
                                        ...
                                        className='text-[20px] text-secondary capitalize font-semibold leading-6 text-gray-900'
                                    >
                                        Coupon Eligibility
                                    </h2>
                                        ...
                                        >
                                            <div className='aspect-square w-full overflow-hidden bg-white'>
                                                <img
                                                    src={
                                                        category.image.url ||
                                                        "/placeholder.svg?height=256&width=256&query=category-thumbnail"
                                                    }
                                                    alt={
                                                        category.name
                                            ...
                                            <div className='p-3'>
                                                <p className='line-clamp-1 text-sm capitalize font-semibold text-gray-900'>
                                                    {category.name}
                                                </p>
                                                <p className='mt-0.5 text-xs text-gray-500'>
                                                    Eligible with {couponLabel}
