            ...
            <motion.div variants={item} id='videoChat'>
                <div className='group relative overflow-hidden'>
                    ...
                    <button
                        ...
                        className="relative w-full rounded-2xl border border-t-[10px] border-primary before:content-[''] 
                            before:absolute before:top-0 before:left-0 before:h-full before:w-full before:rounded-2xl 
                            before:[background-image:linear-gradient(rgba(255,255,255,0.8),rgba(75,61,86,0.8))] 
                            before:backdrop-blur-[2px]"
                        style={bgImg}
                    >
                        <div
                            className='transition-all duration-500 p-8 flex flex-col items-center justify-center rounded-2xl 
                            ...
                            <div className='relative mb-6'>
                                ...
                                <div className='relative bg-gradient-to-br from-blue-100 to-blue-200 p-6 rounded-full 
                            ...
                            <div className='bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 px-8 rounded-full 
                                font-semibold shadow-lg transition-all duration-500 transform'
                            >
                                Join Waiting Room
                            </div>
            ...
            <motion.div variants={item}>
                <div className='group relative overflow-hidden'>
                    <div className='absolute inset-0 bg-gradient-to-br from-green-500 via-emerald-600 to-teal-700 
                        opacity-0 transition-opacity duration-500 rounded-2xl'>
                    </div>
                    <button
                    ...
                    >
                        <div className='relative mb-6'>
                            <div className='absolute inset-0 bg-green-500 rounded-full blur-xl opacity-30 transition-opacity 
                                duration-500'>
                            </div>
                            <div className='relative bg-gradient-to-br from-green-100 to-emerald-200 p-6 rounded-full 
                                transition-all duration-500'
                            >
                        ...
                        <div className='bg-gradient-to-r from-green-600 to-teal-600 text-white py-3 px-8 rounded-full 
                            font-semibold shadow-lg transition-all duration-500 transform'
                        >
