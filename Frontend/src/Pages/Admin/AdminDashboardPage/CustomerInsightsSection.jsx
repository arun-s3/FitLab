    ...
    return (
        ...
        >
            <h2 className='text-xl text-secondary font-bold flex items-center gap-[10px]'>
                <span className={`w-fit whitespace-nowrap ${!showBusinessAnalytics.customers && "text-muted"}`}>
                    {" "}
                    Customer Insights{" "}
                </span>
                <div
                    ...
                    onClick={() =>
                        togglerEnabled &&
                        setShowBusinessAnalytics((status) => ({ ...status, customers: !status.customers }))
                    }
                >
                ...
                {showBusinessAnalytics.customers && (
                    ...
                    >
                        ...
                        <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
                            <motion.div
                                ...
                                className={`bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border
                                    ${
                                        dashboardQuery.trim() &&
                                        !"New Customers vs Returning Customers vs VIP Customers"
                                            .toLowerCase()
                                            .trim()
                                            .includes(dashboardQuery.trim())
                                            ? "hidden"
                                            : "inline-block"
                                    }`}
                            >
                                <h3 className='text-[17px] font-semibold mb-6'>
                                    New Customers vs Returning Customers vs VIP Customers
                                </h3>
                            ...
                            <motion.div
                                ...
                                className={`bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border
                                    ${dashboardQuery.trim() 
                                        && !"Customer Growth Over Time".toLowerCase().trim().includes(dashboardQuery.trim()) 
                                            ? "hidden" 
                                            : "inline-block"
                                    }`}
                            >
                                ...
                                <div
                                    className={`${status.monthlyUserGrowthDatas !== "error" ? "h-64" : "h-40"} relative`}>
                                    {status.monthlyUserGrowthDatas !== "loading" ? (
                                        <ResponsiveContainer width='100%' height='100%'>
                                            {status.monthlyUserGrowthDatas !== "error" ? (
                                                <LineChart
                                                    data={monthlyUserGrowthDatas}
                        ...
                        <motion.div
                            ...
                            className={`bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border
                                ${dashboardQuery.trim() 
                                    && !"VIP Customers".toLowerCase().trim().includes(dashboardQuery.trim()) 
                                        ? "hidden" 
                                        : "inline-block"
                                }
                            `}
                                            ...
                                            [...Array(5)].map((_, index) => (
                                                ...
                                                >
                                                    <td className='py-3 px-4'>
                                                        <div className='flex items-center'>
                                                            <div
                                                                className='invisible w-[20px] h-[20px] rounded-full bg-purple-100 flex items-center justify-center
                                                    ...
                                                    <td className='py-3 px-4'>
                                                        <button
                                                            className='invisible text-sm text-purple-600 hover:text-purple-800 dark:text-purple-400
                                                                font-medium'
                                                        >
                                                            View Details
                                                        </button>
