...
export default function UserAccountPage() {
    ...
    const inputBlurHandler = (e, fieldName, options, detailType) => {
        if (fieldName) {
            ...
            if (statusObj.error) {
                ...
                const newDetails =
                    detailType === "personal"
                        ? displayErrorAndReturnNewFormData(e, message, userDetails, fieldName)
                        : displayErrorAndReturnNewFormData(e, message, addressDetails, fieldName)
    ...
    const handleSubmit = () => {
        ...
        const requiredAddressFieldNames = addressInfoTypes
            ...
            {!user ? (
                ...
                <div className={`pt-[2rem] px-[2rem] pb-[2rem]`}>
                    <div className='flex justify-between items-center mb-[2rem]'>
                        ...
                        {!editing ? (
                            <button
                                className='flex items-center gap-2 px-[1rem] py-2 bg-purple-600 text-[15px] text-white 
                                    font-[500] rounded-lg hover:bg-purple-700 transition-colors'
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-8' id='personal-details'>
                            ...
                            <div className='space-y-4'>
                                ...
                                <div className='grid grid-cols-2 gap-4'>
                                    ...
                                    <div className='h-[63%]'>
                                        ...
                                        <div
                                            className={`relative w-full h-full px-4 py-2 flex justify-between items-center 
                                                rounded-lg border border-gray-300 ${!editing ? "bg-gray-50" : ""} cursor-pointer`}
                                        ...
                                        >
                                            ...
                                            {openDropdowns.genderDropdown && (
                                                <ul
                                                    className='absolute top-[43px] left-0 list-none w-full h-fit bg-white border 
                                                        border-dropdownBorder rounded-[6px] py-[8px] pl-[10px] pr-[2px] text-[14px] 
                                                        cursor-pointer'
                                                >
                                                    <li
                        ...
                        <div className='space-y-6'>
                            ...
                            <div className='space-y-4'>
                                ...
                                <div className='h-[100%]'>
                                    <span className='block text-sm font-medium text-gray-700 mb-[4px]'>
                                        {" "}
                                        Address Type{" "}
                                    </span>
                                    <div
                                        className={`relative w-full h-full mb-[21px] px-4 py-[12px] flex justify-between items-center 
                                            rounded-lg border  border-gray-300 ${!editing ? "bg-gray-50" : ""} cursor-pointer`}
                                        onClick={() => editing && toggleDropdown("addressDropdown")}
                                        ref={dropdownRefs.addressDropdown}
                                    >
                                        <span className={`text-[13px]  ${editing ? "text-secondary" : "text-muted"}`}>
                                            {(addressType && camelToCapitalizedWords(addressType)) ||
                                                (addressDetails?.type && camelToCapitalizedWords(addressDetails.type))}
                                        </span>
                                        <i className=''>
                                            {" "}
                                            <RiArrowDropDownLine />{" "}
                                        ...
                                        {openDropdowns.addressDropdown && (
                                            <ul
                                                className='absolute top-[47px] left-0 list-none w-full h-fit bg-white border 
                                                    border-dropdownBorder rounded-[6px] py-[8px] pl-[10px] pr-[2px] text-[14px] 
                                                    z-[5] cursor-pointer'
                                            >
                    ...
                    <div className='mt-8 pt-8 border-t border-gray-200'>
                        <div className='flex justify-between items-center'>
                            ...
                            <button
                                className={`flex items-center gap-2 px-[1rem] py-[8px] text-[15px] border 
                                    border-secondaryLight2 rounded-lg
