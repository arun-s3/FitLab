...
export default function AdminDashboardHeatmapPage() {
    ...
    setPageBgUrl(
        `linear-gradient(to right,rgba(255,255,255,0.94),rgba(255,255,255,0.94)), url('/Images/admin-bg12.png')`,
    )
    ...
    useEffect(() => {
        ...
        apiClient
            ...
            .catch((error) => {
                if (!error.response) {
                    sonnerToast.error(
                        "Customer locations cannot be shown due network error. Please check your internet.",
                    )
                } else {
                    sonnerToast.error(
                        "Customer locations cannot be shown due to internal server error. Please try later",
                    )
                }
            })
    ...
    return (
        <section id='adminDashboard'>
            ...
            <header>
                <AdminTitleSection
                    heading='Customer Location Heatmap'
                    subHeading='Visualize customer distribution across different states with an interactive heatmap to identify regional engagement'
                />
            </header>
            ...
            <main>
                <div className='flex flex-col space-y-4 p-6 bg-gray-50 min-h-screen'>
                    ...
                    <div className='flex flex-col lg:flex-row gap-8'>
                        <div
                            className='relative w-full lg:w-3/4 h-[600px] border border-gray-300 rounded-[5px] shadow
                                ...
                                {colorRanges.map((bucket, idx) => (
                                    ...
                                    >
                                        <div
                                            ...
                                            style={{ backgroundColor: bucket.color, border: "1px solid #ccc" }}></div>
