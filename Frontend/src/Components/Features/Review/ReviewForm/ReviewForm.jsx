...
export default function ReviewForm({
    ...
    const handleSubmit = (e) => {
        ...
        if (!title.trim() || !comment.trim()) {
            !title.trim()
                ? setSelectInput({ title: true, comment: false })
                : setSelectInput({ title: false, comment: true })
    ...
    return (
        ...
        >
            ...
            <motion.button
                type='submit'
                className='w-full px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 
