...
export default function HeroSection() {
    ...
    return (
        <section
            id='HeroSection'
            className='relative h-[23rem] flex items-center justify-center pt-20 overflow-hidden bg-white'
        >
            ...
            <motion.h1
                ...
                className='absolute -bottom-[2.9rem] right-0 px-8 py-6 text-[55px] bg-white text-black font-bold
                    first-letter:text-orange-500 overline decoration-[3px] decoration-orange-500 rounded-tl-[23px]'>
                About Us
            </motion.h1>
        </section>
    )
