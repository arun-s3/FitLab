...
export default function AdminCreateOfferPage() {
    ...
    setPageBgUrl(
        `linear-gradient(to right,rgba(255,255,255,0.94),rgba(255,255,255,0.94)), url('/Images/admin-bg5.png')`,
    )
    ...
    const handleChange = (e) => {
        ...
        if (type === "checkbox") {
            setFormData((prev) => ({
                ...
                recurringOffer: prev.recurringOffer ?? false,
                applicableType: prev.applicableType ?? "allProducts",
                [name]: checked,
            }))
    ...
    const inputBlurHandler = (e, fieldName) => {
        ...
        if (
            !["name", "startDate", "endDate"].includes(fieldName) &&
            value &&
        ...
        <section id='AdminCreateOfferPage'>
            ...
            <header>
                <AdminTitleSection
                    ...
                    subHeading='Create and configure offers, user targeting, recurring options, banners 
                ...
                <div className='flex flex-col gap-[15px] basis-[65%] w-[65%]' id='offer-content'>
                    ...
                    <div className='offer-content-wrapper'>
                        <div className='offer-labels'>
                            ...
                            <p>
                                Enter a unique and descriptive offer name that clearly identifies the promotion. Keep it
                                concise yet informative. Maximum 50 characters recommended.
                            </p>
                        </div>
                    ...
                    <div className='offer-content-wrapper'>
                        <div className='self-start offer-labels'>
                            ...
                            <p>
                                Provide a clear and detailed description of the offer, including eligibility, benefits,
                                and any important terms. Keep it concise yet informative to help users understand the
                    ...
                    <div className='offer-content-wrapper'>
                        <div className='offer-labels'>
                            ...
                            <p>
                                Set the offer's start and expiry dates to define its active period. The offer will be
                                valid only within this specified timeframe. Ensure the start date is today or later to
                                avoid conflicts.
                            </p>
                        </div>
                    ...
                    <div className='offer-content-wrapper'>
                        <div className='offer-labels'>
                            ...
                            <p>
                                Enter the discount value based on the selected discount type. This value determines the
                                reduction applied during checkout. Required for offer activation.
                            </p>
                        </div>
                        <div className='relative'>
                            {(() => {
                                ...
                                return (
                                    <PlaceholderIcon
                                        icon={<CurrentIcon className='h-[13px] w-[13px]' />}
                                        fromTop={23}
                                    />
                                )
                            })()}
                    ...
                    <div className='offer-content-wrapper'>
                        <div className='offer-labels'>
                            ...
                            <p>
                                Specify the minimum order amount required for this offer to be applicable. Orders below
                                this value will not qualify for the discount. Leave blank or set to 0 for no
                                restriction.
                            </p>
                        </div>
                        <div className='relative'>
                    ...
                    <div
                        className='px-[3px] py-[15px] border-b border-dashed border-mutedDashedSeperation'
                        id='applicableType-section'
                    >
                        <div className='flex items-center justify-between gap-[10px]'>
                            <div className='offer-labels'>
                                <label for='applicableType' className='mb-[17px]'>
                                    {" "}
                                    Applicable To{" "}
                                </label>
                                <p>
                                    Choose whether this offer applies to all products, specific products, or specific
                                    categories. Selecting ‘specific products’ or ‘specific categories’ will require you
                                    to specify the applicable items before saving.
                                </p>
                            </div>
                            <div className='relative'>
                        ...
                        {formData.applicableType === "categories" && (
                            <div className='mt-[1rem]' id='applicableCategories-section'>
                                <label
                                    ...
                                    id='choices'
                                    className='block text-[13px] font-[550] text-muted tracking-[0.5px]'
                                >
                                    Select Categories
                                </label>
                                <div
                        ...
                        {formData.applicableType === "products" && (
                            <div className='mt-[1rem]' id='applicableProducts'>
                                <label
                                    ...
                                    className='block !text-[12px] !text-muted !font-medium'>
                                    Select Products
                                </label>
                                <div className='relative'>
                                    <input
                                        ...
                                        className='mt-[5px] w-full h-[2rem] text-[12px] px-[5px] pl-[35px] py-[2px]
                                            placeholder:text-[11px] border-muted border-dotted rounded-[4px] 
                                    ...
                                    {showSearchResults && (
                                        <ul
                                            className='absolute top-[110%] w-full bg-white list-none flex flex-col gap-[7px] 
                                                px-[7px] py-[10px] border border-dropdownBorder rounded-[4px] z-[10]'
                    ...
                    <div className='offer-content-wrapper'>
                        <div className='offer-labels'>
                            ...
                            <p>
                                Select the customer group eligible for this offer. Choose ‘All Users’ for everyone, ‘New
                                Users’ for first-time buyers, ‘Returning Users’ for repeat customers, or ‘VIP Users’ for
                                exclusive members. Tailor your promotions to target specific user segments. This helps
                                in optimizing marketing strategies by offering exclusive deals to the right audience,
                        ...
                        <div className='relative'>
                            <div className='flex flex-col gap-[1rem]'>
                                {userGroupValues.map((group) => (
                                    <div
                                        key={group}
                                        className={`px-[15px] py-[7px] w-[13rem] flex items-center justify-between
                                            rounded-[5px] cursor-pointer hover:border-primaryDark hover:bg-primaryLight
                                            ${
                                                formData.targetCustomers === group
                                                    ? "border-2 border-primaryDark bg-primaryLight"
                                                    : "border border-mutedDashedSeperation"
                                            }`}
                                        onClick={(e) => radioClickHandler(e, group)}
                                    >
                                        <input
                                            type='radio'
                                            className='w-[12px] h-[12px] border border-primaryDark cursor-pointer
                                                checked:bg-primaryDark focus:ring-0 focus:text-primaryDark'
                                            id='targetCustomers'
                                            onClick={(e) => radioClickHandler(e, group)}
                                            onChange={(e) => radioChangeHandler(e, group)}
                    ...
                    <div className='offer-content-wrapper'>
                        <div className='offer-labels'>
                            ...
                            <p>
                                Enable this option to make the offer repeat automatically at set intervals. Useful for
                                weekly, monthly, or seasonal promotions to maintain customer engagement and drive
                                consistent sales.
                            </p>
                        </div>
                        <div className='relative'>
                    ...
                    {formData.recurringOffer && (
                        <div className='offer-content-wrapper'>
                            <div className='offer-labels'>
                                ...
                                <p>
                                    Specify how often the recurring offer should be applied, such as daily, weekly, or
                                    monthly. Ensure the frequency aligns with your promotional strategy to maximize
