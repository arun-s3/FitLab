...
export default function AdminCouponManagementPage() {
    ...
    const sortTypes = [
        { name: "Coupons: Recent to Oldest", value: "-1", sortBy: "createdAt" },
        { name: "Coupons: Oldest to Recent", value: "1", sortBy: "createdAt" },
        { name: "Alphabetical: A to Z", value: "1", sortBy: "code" },
        { name: "Alphabetical: Z to A", value: "-1", sortBy: "code" },
    ]
        ...
        <section id='AdminCouponManagementPage'>
            ...
            <header>
                <AdminTitleSection
                    ...
                    subHeading='Manage and track Coupons with Advanced controls and Analytics'
                />
            </header>
                ...
                <div className='container mx-auto px-4'>
                    <div className='flex justify-between items-center mb-[10px] mt-[1rem]'>
                        <button
                            ...
                            className='bg-secondary text-[15px] text-white px-[17px]
                                    ...
                                    {Object.keys(queryOptions).length > 0 &&
                                        (() => {
                                            const StatusIcon = getStatusIcon(
                                                camelToCapitalizedWords(queryOptions.status),
                                            )
                                            return (
                                                <StatusIcon
                                                    className={` ${queryOptions.status === "Expired" ? " w-[17px] h-[17px]" : " w-[19px] h-[19px]"} 
                                ...
                                {openDropdowns.statusDropdown && (
                                    <ul
                                        className='list-none px-[10px] py-[1rem] absolute top-[44px] right-0 flex flex-col 
                                            gap-[10px] justify-center w-fit text-[10px] bg-white border border-borderLight2 
                                            rounded-[8px] z-[5] cursor-pointer'
                                    >
                                        {statusTypes.map((statusType) => (
                                            <li
                                                key={`${statusType.name}`}
                                                className={`px-[8px] py-[5px] flex items-center gap-[8px] rounded-[5px] 
                                            ...
                                            >
                                                ...
                                                <span className='text-[12px]'>
                                                    {" "}
                                                    {camelToCapitalizedWords(statusType.name)}{" "}
                                                </span>
                                            </li>
                                        ))}
                                    </ul>
                    ...
                    <div className='flex justify-between items-center mb-6 mt-[12px]'>
                        ...
                        <div id='coupon-menu' className='flex items-center gap-[2rem]'>
                            ...
                            <div className='flex items-center gap-[1rem]'>
                                ...
                                >
                                    <span className='relative flex items-center border-r border-dropdownBorder 
                                        py-[8px] pl-[10px] pr-[2px]'
                                    >
                                        {limit}
                                        <i>
                                            {" "}
                    ...
                    {coupons && (
                        ...
                        <CouponList
                            ...
                            onDeactivate={(id) => dispatch(toggleCouponStatus({ couponId: id }))}
                            onSort={handleSort}
                        />
                    ...
                    <CouponModal
                        ...
                        isEditing={editingCoupon ? true : false}
                    />
