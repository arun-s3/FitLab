            ...
            {config && (
                ...
                >
                    <div className='bg-purple-50 px-[8px] py-[12px] text-center'>
                        ...
                        <motion.h2
                            variants={itemVariants}
                            className='text-[18px] font-bold tracking-[0.4px] text-gray-900'
                        >
                            {config.title}
                        </motion.h2>
                    ...
                    <div className='px-6 py-4'>
                        <motion.p
                            variants={itemVariants}
                            className='text-gray-700 text-center mb-6 text-[13px] whitespace-nowrap'
                        >
                        ...
                        <div className='space-y-3'>
                            <motion.button
                                ...
                                className='w-full bg-purple-600 hover:bg-purple-700 text-white text-[15px] font-semibold 
                                    tracking-[0.4px] py-3 px-4 rounded-[7px] transition-colors duration-200 flex items-center 
                            ...
                            <motion.button
                                ...
                                className='w-full bg-gray-100 hover:bg-gray-200 text-gray-800 text-[15px] font-semibold 
                                    tracking-[0.4px] py-3 px-4 rounded-[7px] transition-colors duration-200'
                            >
