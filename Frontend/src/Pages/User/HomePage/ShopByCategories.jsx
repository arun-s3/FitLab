...
const categories = [
    {
        id: 1,
        title: "Strength",
        description: `Building muscle requires strength and power. Free weights and other weight equipment are crucial. 
    ...
    },
    {
        id: 2,
        title: "Cardio",
        description: `Cardio exercises are a great way to lose weight. 
    ...
    },
    {
        id: 3,
        title: "Supplements",
        description: `Muscle-building supplements can improve physical performance during resistance training and help stimulate muscle growth. 
    ...
    },
    {
        id: 4,
        title: "Accessories",
        description: `By having your workout gear right, you'll be set for a productive, safe and effective workout. 
        ...
        >
            <motion.div
                ...
                className={`w-full md:w-2/5
                    ${category.title === "Supplements" ? "h-48 md:h-[335px] -mt-[28px]" : "h-48 md:h-[300px]"} flex-shrink-0
                    ${!isEven && "mt-0 md:mt-[7px] mr-[8px]"} h-52 sm:h-60  overflow-hidden`}
            >
                <img
        ...
        <section className='w-full bg-gray-100 py-16 md:py-10 px-4 md:px-8'>
            ...
            >
                <motion.div variants={headerVariants} className='text-center mb-12 md:mb-8'>
                    <h2 className='text-[26px] xs-sm2:text-[28px] xs-sm:text-[30px] font-bold text-black mb-[5px]'>
                        Shop By Categories
                    </h2>
                    <p className='text-gray-600 text-sm md:text-base'>
                        Pick a category you need to explore the products
                    </p>
                </motion.div>
