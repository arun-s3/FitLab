            ...
            <div className='ranges space-y-1 !mt-8'>
                <div>
                    ...
                    <input
                        ...
                        max='100'
                        value={channelR}
                        onChange={(e) => setChannelR(Number(e.target.value))}
                    />
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        max='100'
                        value={channelG}
                        onChange={(e) => setChannelG(Number(e.target.value))}
                    />
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        max='100'
                        value={channelB}
                        onChange={(e) => setChannelB(Number(e.target.value))}
                    />
                </div>
                ...
                <div className='flex gap-2 mt-3'>
                    <button
                        className='mb-8 px-[18px] py-1 text-white text-[15px] font-medium tracking-[0.3px] 
                            bg-secondary rounded-[4px] hover:bg-purple-700 transition duration-300'
                        onClick={resetAll}
                    >
                        Reset
                    </button>
