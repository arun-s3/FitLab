                ...
                <>
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                className='h-1 bg-gradient-to-r from-purple-300 via-purple-500 to-fuchsia-500'
                                ref={modalRef}
                            />
                            ...
                            <div className='p-8'>
                                ...
                                >
                                    <div
                                        className='bg-gradient-to-br from-purple-100 to-purple-100 dark:from-purple-900/30
                                            rounded-full p-4'>
                                ...
                                <motion.p
                                    ...
                                    animate='visible'
                                >
                                    You have already applied for automatic recharge. Would you like to update your card
                                    details?
                                </motion.p>
                                ...
                                <div className='flex flex-col gap-3'>
                                    <motion.button
                                        ...
                                        className='w-full bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-700 
                                            hover:to-purple-800 text-white font-semibold py-3 px-4 rounded-lg transition-all 
                                            duration-200 flex items-center justify-center gap-2 active:shadow-none'
                                    >
                                    ...
                                    <motion.button
                                        ...
                                        whileHover={hoverScale}
                                        whileTap={tapScale}
                                        className='w-full bg-gray-100 dark:bg-slate-800 hover:bg-gray-200 text-gray-900
                                            font-semibold py-3 px-4 rounded-lg transition-all duration-200 border
