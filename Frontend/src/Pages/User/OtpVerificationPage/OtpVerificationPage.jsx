...
export default function OtpVerificationPage() {
    ...
    return (
        <>
                    ...
                    {bgLoaded && (
                        <>
                            ...
                            <main className='flex justify-center items-center'>
                                <motion.div
                                    className='animate-border mt-[2.5rem] w-[18rem] xs-sm:w-[26rem] s-sm:w-[30rem] sm:w-[33rem] 
                                ...
                                >
                                    <motion.h1
                                        className='text-secondary font-funCity text-[18px] xs-sm:text-[22px] s-sm:text-[27px] mb-[40px] 
                                            text-center my-[50px]'
                                        variants={item}
                                    >
                                    ...
                                    <div
                                        className='flex flex-col gap-[10px] xs-sm:gap-[15px] text-descReg1 items-start mb-[60px]'
                                        onSubmit={(e) => submitData(e)}
                                    >
                                        <motion.div className='w-full flex items-center justify-center gap-[10px] s-sm:gap-[5px] 
                                            check-mail'
                                        >
                                            <h2
                                                className='text-center text-[13px] xs-sm:text-[14px] s-sm:text-[17px] tracking-[0.5px] 
                                                    s-sm:tracking-[1px]'
                                            ...
                                            <motion.span
                                                className='mt-[-5px] s-sm:mt-0 p-[7px] xs-sm:p-[9px] s-sm:p-[14px]'
                                                {...pulse}
                                            >
                                                <IoMail
                                                    className='w-[17px] h-[17px] xs-sm:w-[20px] xs-sm:h-[20px] s-sm:w-[35px]
                                                        s-sm:h-[35px] text-primary'
                                                />
                                            </motion.span>
                                        </motion.div>
                                        <h4
                                            className='xs-sm:!ml-0 w-full text-center text-[11px] xs-sm:text-[13px] s-sm:text-[15px] 
                                        ...
                                        <motion.hr
                                            className='w-[10rem] xs-sm:w-[15rem] my-[20px] self-center border border-[#6f6e6e]'
                                            variants={item}>
                                        </motion.hr>
                                        <motion.div
                                            className='self-center flex items-center gap-[1rem]'
                                            variants={item}
                                        >
                                            {loading ? (
                                        ...
                                        <motion.p
                                            className='w-full h-[3px] mt-[-2px] mb-[2px] text-center text-red-500 text-[10px]
                                                tracking-[0.2px]'
                                            variants={item}
                                        >
                                            {error}
                                        ...
                                        <motion.h5
                                            className='w-full mt-[-15px] xs-sm:mt-0 text-[11px] xs-sm:text-[12.5px]
                                            text-[#a5a5a5] text-center'
                                            variants={item}
                                        >
                                            Haven't received the OTP yet?
                                            <span
                                                className='ml-0 xs-sm:ml-[5px] text-secondary cursor-pointer'
                                                onClick={resendOtp}>
                                                Resend again
                                            </span>
                                        </motion.h5>

                                        <motion.div className='w-full text-center' variants={item}>
                                            <SiteButtonSquare
                                                tailwindClasses='w-[11rem] xs-sm:w-[18rem] s-sm:w-[25rem]'
                                        ...
                                        {loading
                                            ...
                                            : !otpBoxDisabled && (
                                                  <h5
                                                      className='w-full text-[10px] xs-sm:text-[12.5px] text-[#a5a5a5]
                                        ...
                                        <p className='mt-[5px] w-full text-center text-[#d2caca] text-[9px] xs-sm:text-[11px] 
                                            tracking-[0.2px]'
                                        >
                                            <span className='mr-[5px] text-primary'> Important: </span>

                                            Please avoid using the back button during OTP verification to ensure a
            ...
            <AnimatePresence>{bgLoaded && <Footer />}</AnimatePresence>
        </>
    )
}
