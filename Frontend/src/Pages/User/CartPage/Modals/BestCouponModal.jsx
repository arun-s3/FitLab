        ...
        <AnimatePresence>
            {open ? (
                ...
                >
                    ...
                    <motion.div
                        ref={dialogRef}
                        className='relative w-full max-w-md rounded-[10px] border border-border bg-white 
                        ...
                        <div className='absolute right-2 top-2'>
                            <button
                                ...
                                className='inline-flex h-9 w-9 items-center justify-center rounded-md 
                                    hover:bg-dropdownBorder focus-visible:outline-none focus-visible:ring-2 
                        ...
                        <div className='flex flex-col gap-5 p-6 md:p-7'>
                            ...
                            <div className='space-y-2'>
                                <h2
                                    ...
                                    className='text-pretty text-secondary text-[18px] font-semibold leading-tight
                                        md:text-[22px]'
                                >
                                    Best coupon applied
                                </h2>
                            ...
                            >
                                <motion.div
                                    className='inline-flex items-center text-[12px] gap-2 rounded-[7px] 
                                        border bg-inputBgSecondary px-3 py-1.5 text-sm font-medium '
                                ...
                                >
                                    <span
                                        className='inline-flex h-4 w-4 items-center justify-center rounded-[7px] 
                                            border border-secondary text-[10px] text-secondary font-bold'
                                    >
                                        %
                                    </span>
                            ...
                            <div className='flex flex-col gap-3 sm:flex-row'>
                                {coupon.discountType === "freeShipping" ? (
                                    <div className='flex items-center gap-2 rounded-[7px] border 
                            ...
                            <div className='mt-2 flex flex-col-reverse gap-2 sm:flex-row sm:justify-end'>
                                <button
                                    onClick={() => onClose?.()}
                                    className='inline-flex items-center justify-center rounded-md bg-primary px-4 
                                        py-2 text-sm font-semibold shadow-sm transition-colors hover:bg-primaryDark 
