                        ...
                        <motion.div className='w-full max-w-md bg-white dark:bg-gray-900 rounded-[9px] shadow-2xl overflow-hidden'>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className='text-[#d8ff00] text-sm'>
                                            Keep your health data current for better insights
                                        </p>
                                    </div>
                                </motion.div>
                            ...
                            <div className='px-6 py-6 max-h-[34rem] overflow-y-auto' ref={modalRef}>
                                ...
                                >
                                        ...
                                        `}
                                    <p className='mt-[10px]'>Why you should update your health data every week:</p>
                                </motion.p>
                                    ...
                                    {benefits.map((benefit, index) => {
                                        ...
                                        return (
                                            <motion.div
                                                ...
                                                whileHover={{ x: 4 }}
                                                className='flex gap-3 bg-gradient-to-r from-yellow-50 to-orange-50 
                                                    dark:from-gray-800 dark:to-gray-750 rounded-lg p-4 border border-orange-100
                                                    dark:border-gray-700 hover:border-orange-300 dark:hover:border-orange-400 
                                ...
                                >
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.98 }}
                                        onClick={handleSkip}
                                        className='flex-1 px-4 py-[11px] text-[15px] rounded-lg border-2 border-gray-300 
                                            dark:border-gray-600 text-gray-700 dark:text-gray-300 font-semibold hover:bg-gray-100
                                    ...
                                    <motion.button
                                        ...
                                        className='flex-1 px-4 py-[11px] text-[15px] rounded-lg bg-gradient-to-r from-purple-500 
                                            to-purple-600 text-white font-semibold hover:shadow-lg hover:bg-purple-800 
                                            transition-shadow'
                                    >
                                        Update Now
                                    </motion.button>
