                ...
                {["Shopping cart", "Checkout details", "Order complete"].map((step, index) => (
                    <React.Fragment key={step}>
                        <div className='flex items-center flex-1 last:flex-none'>
                            <div
                                className={`pb-[1rem] flex items-center border-b-2 cursor-pointer
                                    ${index <= stepNumber - 1 ? "border-secondaryLight2" : "border-transparent"}`}
                            >
                                <div
                                    className={`w-[2rem] h-[2rem] text-[14px]
                                    ${index <= stepNumber - 1 
                                ...
                                <span
                                    className={`ml-[8px] xs-sm:text-[13px] sm:text-[16px] whitespace-nowrap
                                        ${index <= stepNumber - 1 ? "text-secondary" : ""} 
                                        ${index <= stepNumber - 1 ? "font-medium" : "text-gray-500"}
                                        hidden xs-sm:inline`
                                    }
                                >
                                    {step}
