...
export default function Dashboard() {
    ...
    const tempSaveForAiInsight = (dataType, datas) => {
        setDashboardDatas((dashboardDatas) => ({ ...dashboardDatas, [dataType]: datas }))
    }
        ...
        >
            ...
            >
                <MonthlyWeeklyChart
                    ...
                    dataKey='workouts'
                    timeRange={timeRange}
                    onFetchedDatas={tempSaveForAiInsight}
                />
            ...
            <div className='!mt-14'>
                ...
                <FitnessAiInsights 
                    receivedSourceDatas={dashboardDatas} 
