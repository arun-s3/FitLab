...
export default function Fallback({ variant = "default", height = "h-40" }) {
    ...
    if (variant === "default") {
        return (
            <div
                className={`${height} w-full flex items-center justify-center bg-gradient-to-r from-gray-100 via-white to-gray-100 overflow-hidden`}>
                <motion.div
                    initial='hidden'
                    animate='visible'
                    variants={variants}
    ...
    if (variant === "products") {
        return (
            <div className={`${height} w-full flex items-center justify-center bg-gray-50`}>
                <motion.div initial='hidden' animate='visible' variants={variants} className='w-full px-4'>
