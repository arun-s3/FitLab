        ...
        <div className='min-h-screen bg-gradient-to-br from-slate-50 via-red-50 to-orange-50'>
            ...
            >
                <div className='grid lg:grid-cols-2 gap-12 items-center'>
                    <div className='space-y-8'>
                        <motion.div variants={itemVariants}>
                            <div className='flex items-center space-x-3 mb-4'>
                                ...
                                <span className='text-[16px] text-red-600 dark:text-red-400 font-semibold text-lg'>
                                    {" "}
                                    Account Restricted{" "}
                                </span>
                            </div>

                            <h1 className='text-[50px] md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 
                                tracking-[0.7px] leading-tight'
                            >
                                Access
                                <span className='my-[10px] ml-[-2px] text-red-600 dark:text-red-400 block'>
                                    {" "}
                                    Temporarily{" "}
                                </span>
                            ...
                            <p className='text-[17px] text-gray-600 leading-relaxed'>
                                Your account has been temporarily suspended due to suspicious activity or violation of
                                our terms of service.
                            </p>
                        </motion.div>

                        <motion.div
                            className='bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm rounded-2xl p-6 border border-red-100'
                        ...
                        <motion.div
                            className='bg-purple-50 dark:bg-purple-950/30 rounded-2xl p-6 border border-purple-200'
                            variants={itemVariants}>
                            <h2 className='text-2xl font-bold text-gray-900 dark:text-white mb-4'>
                                {" "}
                                What happens next?{" "}
                    ...
                    <div className='space-y-8'>
                        ...
                        <motion.div
                            className='bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl p-8 border 
                                border-gray-200'
                            variants={itemVariants}>
                            ...
                            <div className='space-y-6'>
                                ...
                                >
                                    <div className='w-12 h-12 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center 
                                        justify-center'
                                    >
                                ...
                                <motion.div
                                    ...
                                    transition={{ ease: "easeInOut", duration: 0.1 }}
                                >
                                    <div className='w-12 h-12 bg-green-100 dark:bg-green-900/30 rounded-full flex items-center 
                                        justify-center'
                                    >
                                ...
                                <motion.div
                                    ...
                                    transition={{ ease: "easeInOut", duration: 0.1 }}
                                >
                                    <div className='w-12 h-12 bg-purple-100 dark:bg-purple-900/30 rounded-full flex 
                            ...
                            <div className='mt-6 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-xl border 
                                border-yellow-200 dark:border-yellow-800/30'
                            >
                                <p className='text-sm text-yellow-800 dark:text-yellow-200 text-center'>
                                    <strong>Response Time:</strong> Our team typically responds within 24-48 hours.
                                    Please include your account details when contacting us.
                                </p>
                            </div>
            ...
            <motion.footer
                ...
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
                    <p className='text-center text-white '>
                        This restriction is temporary and subject to review. Thank you for your understanding and
                        cooperation.
                    </p>
                </div>
            </motion.footer>
            ...
            {openChatBox && (
                <div className='fixed bottom-[2rem] right-[2rem] z-50'>
                    <TextChatBox openChats={true} closeable={true} onCloseChat={() => setOpenChatBox(false)} />
                </div>
            )}
