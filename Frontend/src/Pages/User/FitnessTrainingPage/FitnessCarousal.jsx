    ...
    const CAROUSEL_SLIDES = [
        {
            ...
            description:
                "Targeting specific muscle groups helps you build strength efficiently, improve posture, and achieve your fitness goals with precision. Professional training videos show you the correct form to maximize results.",
        ...
        },
        {
            ...
            description:
                "Learn from certified trainers who break down every movement. Understand muscle activation, proper breathing, and common mistakes to avoid. Get results faster with expert guidance.",
        ...
        },
        {
            ...
            description:
                "Access unlimited videos anytime, anywhere. Learn multiple variations and techniques. Practice at your own pace without time constraints. Build a personalized workout routine with proven methods.",
        ...
        },
        {
            ...
            description:
                "Follow a progressive training system. Start with basics, advance to complex movements. Track your progress and adapt your routine. Every muscle group has dedicated training content.",
