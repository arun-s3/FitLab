...
const MiniTestimonialCarousal = lazy(
    () => import("../../../Components/Features/Testimony/MiniTestimonialCarousal/MiniTestimonialCarousal"),
)
        ...
        <>
            <section className='h-screen' id='CustomerSupportPage'>
                ...
                <header className='relative h-[17rem] pt-4' style={bgImg}>
                    ...
                    <div
                        className='absolute top-[7.5rem] w-full text-[3rem] font-bold text-center
                     text-inputBorderLow'>
                        <motion.h1
                ...
                <div className='relative mt-[-13px]'>
                    <svg
                        ...
                        className='w-full h-8 md:h-12 lg:h-16 fill-gray-50 block'>
                        <path
                            d='M0,0 L48,8 L96,3 L144,12 L192,5 L240,15 L288,2 L336,18 L384,7 L432,22 L480,4 L528,16 L576,9 
