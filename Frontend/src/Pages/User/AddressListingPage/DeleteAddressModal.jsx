                ...
                >
                    <div className='fixed inset-0 flex items-end md:items-center justify-center p-4'>
                        <motion.div
                            ...
                            className='w-full max-w-md bg-whitesmoke rounded-t-2xl md:rounded-lg bg-card 
                                text-card-foreground shadow-xl border border-border focus:outline-none'
                        ...
                        >
                            <div className='flex items-center justify-between px-5 py-4 border-b border-border'>
                                <div className='flex items-center gap-2.5'>
                                    ...
                                    <h2
                                        ...
                                        className='text-base text-red-500 font-semibold text-pretty'>
                                        Delete address?
                                    </h2>
                                </div>
                                <button
                                    type='button'
                                    onClick={onClose}
                                    className='rounded-md p-1.5 hover:bg-grayMuted focus-visible:outline-none 
                            ...
                            <div className='px-5 py-4' ref={modalRef}>
                                <p id='delete-address-description' className='text-sm text-muted-foreground'>
                                    {" "}
                            ...
                            <div className='px-5 py-4 flex items-center justify-end gap-2.5'>
                                <motion.button
                                    ...
                                    className='inline-flex h-9 items-center justify-center rounded-md px-3 text-sm 
                                        font-medium hover:opacity-90 disabled:opacity-50 focus-visible:outline-none 
                                        focus-visible:ring-2 focus-visible:ring-dropdownBorder'
                                >
                                    Cancel
                                </motion.button>
                                <motion.button
                                    ...
                                    whileHover={{ y: -1 }}
                                    className='inline-flex h-9 items-center justify-center rounded-md px-3 text-sm 
                                        font-medium bg-red-500 hover:opacity-90 disabled:opacity-50 
