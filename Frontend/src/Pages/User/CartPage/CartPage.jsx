...
import SimilarProductsCarousal from "../../../Components/Features/Product/ProductsCarousal/SimilarProductsCarousal"
import TextChatBox from "../TextChatBox/TextChatBox"
import ProductRemovalModal from "../../../Components/Features/Product/ProductRemovalModal/ProductRemovalModal"
        ...
        <section id='ShoppingCartPage'>
            ...
            <main>
                <div className='max-w-[87.5rem] mx-auto px-[1rem] py-[3rem]'>
                    {cart?.products && cart.products.length > 0 ? <OrderStepper stepNumber={1} /> : null}

                    {cart?.products && cart.products.length > 0 ? (
                        <motion.div
                            className='grid grid-cols-1 lg:grid-cols-3 gap-[1rem] x-sm:gap-[2rem]'
                            id='cart-main'
                        ...
                        <motion.div
                            className='flex items-center justify-center h-[15vh] xs-sm:h-[25vh]'
                            id='cart-main'
                            variants={containerVariants}
                            initial='hidden'
                            animate='show'
                        >
                            <p className='text-[13px] xs-sm2:text-[16px] xs-sm:text-[17px] text-muted capitalize
                                 tracking-[0.5px]'>
