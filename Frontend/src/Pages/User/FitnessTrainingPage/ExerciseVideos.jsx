        ...
        <>
            <h2 className='px-8 flex items-center gap-4 w-full mt-20 mb-6'>
                ...
                <span className='text-[25px] text-black font-bold'>
                    {" "}
                    Videos related to this exercise or its variations{" "}
                </span>
            </h2>
            {videos && videos.length > 0 && !fetchError && (
                ...
                >
                    ...
                    <p className='absolute -bottom-4 text-[18px] text-muted font-medium'>
                        {videos[selectedVideoIndex].title}
                    </p>

                    <motion.div variants={itemVariants} className='basis-[40%] h-[36rem] max-x-lg:self-start'>
                        <div
                            className='bg-gradient-to-br from-purple-50 to-purple-100 backdrop-blur-sm border border-dropdownBorder
                            ...
                            <div className='space-y-8 max-h-96'>
                                {videos.length > 0 &&
                                    videos
                                        .filter((video, index) => index !== selectedVideoIndex)
                                        .map((video, idx) => (
                                            <motion.div
                                                key={video.videoId}
                                            ...
                                            >
                                                <div className='group block'>
                                                    <div className='relative h-[14rem] x-lg:h-44 rounded-lg mb-2 
