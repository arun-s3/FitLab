...
export default function AddressManagementPage({ editAddresses = false }) {
    ...
    const { setBreadcrumbHeading, setContentTileClasses, setSidebarTileClasses, setPageLocation } =
        useContext(UserPageLayoutContext)

    editAddresses ? setBreadcrumbHeading("Edit Address") : setBreadcrumbHeading("Add Address")
