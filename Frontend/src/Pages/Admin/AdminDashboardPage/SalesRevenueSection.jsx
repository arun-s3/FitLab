...
export default function SalesRevenueSection() {
    ...
    const fetchAllStats = async () => {
        ...
        const [revenueResponse, avgOrdersResponse, totalOrdersResponse, categoryDatasResponse] =
    ...
    useEffect(() => {
        ...
        const orderedStats = stats.sort((a, b) => priorityOrder.indexOf(a.name) - priorityOrder.indexOf(b.name))
                    ...
                    >
                                ...
                                orderedStats.map((stat, index) => (
                                    <motion.div
                                        ...
                                        className={`flex items-center bg-white dark:bg-gray-800 p-4 rounded-lg 
                                            shadow-sm border ${index === 0 && "border-primary"}`}
                                    >
                        ...
                        <motion.div
                            ...
                            className={`bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border
                                ${dashboardQuery.trim() 
                                    && !"Revenue Trends".toLowerCase().trim().includes(dashboardQuery.trim()) 
                                    ? "hidden" 
                                    : "inline-block"
                                }`}
                        >
                                    ...
                                    <ResponsiveContainer width='100%' height='100%'>
                                        ...
                                        {revenueDatas &&
                                            ...
                                            (revenueDatas.length === 0 ||
                                                ...
                                                <p
                                                    className='absolute top-[10.5rem] x-sm:top-0 w-full h-full flex items-center 
                                                        justify-center text-muted text-[13px] x-sm:text-[16px] font-medium 
                                                        tracking-[0.3px]'
                                                >
                        ...
                        <div className={`grid grid-cols-1 lg:grid-cols-2 gap-6`}>
                            ...
                            <motion.div
                                ...
                                ${
                                    dashboardQuery.trim() &&
                                    !"Hourly Sales Data".toLowerCase().trim().includes(dashboardQuery.trim())
                                        ? "hidden"
                                        : "inline-block"
                                }`}
                            >
