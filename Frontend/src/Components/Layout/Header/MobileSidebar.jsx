            ...
            <AnimatePresence>
                {open && (
                    <>
                        ...
                        <motion.aside
                            ref={scrollRef}
                            className='fixed right-0 top-0 z-50 h-dvh max-xxs-sm:w-[85%] max-xs-sm2:w-[75%] max-xs-sm:w-[80%] 
                                w-[88%] max-w-sm overflow-hidden rounded-l-[12px] bg-neutral-900 text-white shadow-2xl 
                                bg-gradient-to-br from-neutral-900 via-neutral-950 to-[#2c0f4a]'
                            role='dialog'
                            initial={{ x: "100%" }}
                            animate={{ x: 0 }}
                            exit={{ x: "100%" }}
                                                        ...
                                                        <motion.li
                                                            ...
                                                            <button
                                                                className='group flex w-full items-center justify-between 
                                                                    rounded-lg px-2.5 py-2 text-left text-sm hover:bg-white/5'
                                                                onClick={() => {
                                                                    navigate(path)
                                                                    setOpen(false)
                                                                }}>
                                            ...
                                            {showOptions.support &&
                                                [
                                                    { label: "Video and Text Chat", Icon: Video },
                                                    {
                                                        label: "Text Chat",
                                                        Icon: MessageSquare,
                                                        styleClasses: "inline-block sm:hidden",
                                                    },
