    ...
    return (
        ...
        >
            ...
            <div className='flex items-center gap-3'>
                        ...
                        {limit && openDropdowns.limitDropdown && (
                            <motion.ul
                                ...
                                className='absolute top-[44px] left-[3px] right-0 py-[10px] w-[101%] rounded-b-[4px] flex flex-col 
                                    items-center gap-[10px] text-[13px] bg-white border border-dropdownBorder rounded-[6px]
                                    cursor-pointer z-10'
                            >
                ...
                <motion.div
                    whileTap={{ scale: 0.97 }}
                    className='relative h-[35px] px-[12px] mob:px-[16px] py-[8px] text-[14px] text-muted bg-white flex items-center 
                          gap-[10px] justify-between border border-dropdownBorder rounded-[8px] shadow-sm cursor-pointer 
                          hover:bg-gray-50 transition-colors w-[9rem] mob:w-auto'
