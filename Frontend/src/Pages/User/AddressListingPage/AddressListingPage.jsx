...
export default function AddressListingPage() {
    ...
    const { setBreadcrumbHeading, setSidebarTileClasses, setPageWrapperClasses, setPageLocation, setPageBgUrl } =
    ...
    setPageBgUrl(
        `linear-gradient(to right,rgba(255,255,255,0.96),rgba(255,255,255,0.96)), url('/Images/patternBg2.png')`,
    )
            ...
            {!user ? (
                ...
                <>
                    ...
                    >
                        ...
                        <h2 className='text-[11px] w-[80%] xxs-sm:w-auto ml-12 xxs-sm:ml-auto xxs-sm:text-[12px] 
                            xs-sm:text-[13px] x-md:text-[14px] font-[450] tracking-[0.2px] text-secondary mt-1'
                        >
