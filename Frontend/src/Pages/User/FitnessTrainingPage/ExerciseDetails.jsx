    ...
    return (
        <div className='min-h-screen text-white overflow-hidden' ref={exerciseDetailsRef}>
            ...
            <div className='max-x-lg:mt-8'>
                <div className='mx-auto w-[80%] sm:w-[35rem] h-[20rem] rounded-[6px] outline outline-2 outline-primary 
                    outline-offset-4'
                >
                    <img src={exercise.thumbnail} className='h-full w-full object-cover rounded-[7px]' />
                </div>
            </div>
                ...
                <div className='grid md:grid-cols-3 gap-8 mb-16'>
                    <motion.div variants={itemVariants} className='md:col-span-2'>
                            ...
                            <article className='text-[14px] text-[#757584] leading-relaxed mb-6'>
                                <ul className='flex flex-col gap-[10px]'>
                                    {exercise.instructions.map((step, index) => (
                                        <li
                                            key={index}
                                            className="before:content-['▶'] before:text-primaryDark before:mr-2">
                                            {step}
                                        </li>
                                    ))}
                                </ul>
                        ...
                        <div className='mt-[10px] flex flex-col gap-8 lg:flex-row justify-between'>
                            ...
                            >
                                <div
                                    className={`w-[15rem] h-[10rem] border border-dashed border-secondaryLight2 rounded-[8px]`}>
                                    <img
                                ...
                                <div className='mt-[10px] w-[15rem] h-[10rem] border border-dashed border-secondaryLight2 rounded-[8px]'>
                                    <img
                                        ...
                                        onError={(e) => {
                                            e.target.onerror = null
                                            const fallbackImg =
                                                exercise.targetMuscles?.[1] || exercise.secondaryMuscles?.[0]
                    ...
                    <motion.div variants={itemVariants} className=''>
                        <div className='bg-white backdrop-blur-sm border border-secondaryLight2 rounded-xl p-6 md:p-8 sticky top-32'>
                            ...
                            <div className='space-y-6'>
                                <div>
                                    <p className='text-muted text-sm uppercase font-semibold mb-2'>Primary</p>
                                    <div className='bg-inputBgSecondary text-secondary border border-dropdownBorder 
                                        rounded-[5px] px-4 py-[7px] font-bold text-[14px]'
                                    >
                                ...
                                <div>
                                    <p className='text-muted text-sm uppercase font-semibold mb-2'>Secondary</p>
                                    <div className='flex flex-wrap gap-2'>
                                        {exercise.secondaryMuscles.map((muscle) => (
                                            <span
                                                key={muscle}
                                                className='bg-whitesmoke text-[#272424] border border-dropdownBorder 
                                                    rounded-[5px] px-3 py-2 text-sm font-medium'
                                            >
                                ...
                                <div>
                                    <p className='text-muted text-sm uppercase font-semibold mb-2'>Difficulty</p>
                                ...
                                <div>
                                    <p className='text-muted text-sm uppercase font-semibold mb-2'>Equipment</p>
                                    <div className='flex flex-wrap gap-2'>
                                        {exercise.equipments.map((item) => (
                                            <span
                                                key={item}
                                                className='bg-inputBgSecondary text-[14px] text-secondary border 
                                                    border-dropdownBorder rounded-[5px] px-4 py-[7px] font-bold'
                                            >
            ...
            <motion.div variants={itemVariants} className='mt-16 pb-8 flex justify-center'>
                <span
