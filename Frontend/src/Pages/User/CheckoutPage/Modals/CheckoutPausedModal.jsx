                ...
                <>
                    ...
                    <div className='fixed inset-0 z-50 flex items-center justify-center p-4'>
                        <motion.div
                            ...
                            className='bg-white dark:bg-gray-900 rounded-[8px] shadow-2xl max-w-md w-full max-h-[90vh] 
                                overflow-hidden'
                        ...
                        >
                            <div className='flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700'>
                                <div className='flex items-center gap-3'>
                                    ...
                                    <div>
                                        <h2 className='text-lg font-semibold text-red-500 dark:text-white'>
                                            {" "}
                                            Checkout Paused
                                        </h2>
                            ...
                            <div className='p-6' ref={modalRef}>
                                <p className='text-gray-600 dark:text-gray-300 mb-4 text-[13px] xxs-sm:text-sm leading-relaxed'>
                                    The following items in your cart are currently unavailable or blocked or out of
                                    stock. Please remove them/decrease the quanity to continue with your checkout.
                                </p>
                                            ...
                                            >
                                                ...
                                                <div className='flex-1 min-w-0'>
                                                    ...
                                                    <div className='flex items-center gap-2 mt-1'>
                                                        <span
                                                            className={`px-2 py-1 rounded-full text-[10px] tracking-[0.3px] 
                                                                font-medium border ${getStatusColor(product)}`}
                                                        >
