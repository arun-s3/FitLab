                ...
                <form onSubmit={handleSubmit} className='p-6 space-y-4 max-h-[80vh] overflow-y-auto' ref={modalRef}>
                                ...
                                <div className='mt-[10px] flex gap-[10px] flex-wrap'>
                                    {formData.applicableCategories.map((category) => (
                                        ...
                                        >
                                            ...
                                            <span className='flex items-center gap-[1px] text-[11px] text-secondary capitalize whitespace-nowrap'>
                                                {" "}
                    ...
                    <div className='w-full mt-[15px]'>
                        ...
                        <FileUpload
                            ...
                            imageCropperContainerHt='620px'
                            imageCropperControllerStyle={{ marginTop: "2rem", gap: "1.5rem", left: "0px" }}
                    ...
                    <div className='flex justify-end space-x-3 mt-6'>
                        ...
                        <button
                            type='submit'
                            className='min-w-28 px-4 py-2 border border-transparent rounded-md shadow-sm text-sm 
                                font-medium text-white bg-secondary hover:bg-purple-700 focus:outline-none 
                                focus:ring-2 focus:ring-offset-2 focus:ring-secondary'
                        >
