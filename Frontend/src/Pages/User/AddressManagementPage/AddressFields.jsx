...
export default function AddressFields({
    ...
    return (
        <div id='address-content' className='relative'>
            ...
            <motion.div className='address-fields' variants={containerVariants} initial='hidden' animate='visible'>
            ...
            >
                ...
                <motion.div variants={itemVariants} className='w-full'>
                    <div className='w-full xs-sm2:w-auto  max-s-sm:basis-full'>
                        ...
                        <div
                            className='mt-[10px] flex flex-col mob:flex-row items-start mob:items-center
            ...
            <motion.div className='address-fields' variants={containerVariants} initial='hidden' animate='visible'>
                <motion.div variants={itemVariants} className='w-full'>
                    <InputLabelGenerator
                        ...
                        primaryColor={primaryColor}
                        optionalField={true}
                        optionalMsg="Example- 'Leave at the front door. @123 (Optional)'"
                        rows={4}
                    />
                </motion.div>
            </motion.div>
            ...
            <div
                className='w-full xs-sm2:w-auto static xs-sm2:absolute right-0 max-s-sm:top-[-3rem] 
                    s-sm:bottom-16 md:bottom-[5.5rem] text-end'>
                <button
                    className='ml-auto py-[7px] xs-sm2:py-[6px] s-sm:py-2 w-full xs-sm2:w-auto flex items-center
                        justify-center  xs-sm2:justify-normal gap-2 px-[10px] s-sm:px-[1rem] xs-sm2:text-[12px] 
                        s-sm:text-[15px] bg-purple-600 text-white font-[500] rounded-[7px] 
            ...
            <div
                className='w-full xs-sm2:w-auto max-xs-sm2:-mt-4 s-sm:mt-8 md:mt-auto flex justify-between 
            ...
            >
                ...
                <motion.div className='w-full xxs-sm:w-auto' whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.96 }}>
                    <SiteButtonSquare
