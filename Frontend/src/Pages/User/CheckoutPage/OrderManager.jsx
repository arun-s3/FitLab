...
export default function OrderManager({ products, orderReviewError, onIncQuantity, onDecQuantity }) {
    ...
    return (
        <motion.div
            className={`mt-[30px] grid grid-cols-1 x-sm:grid-cols-2 lg:grid-cols-1 xx-xl:grid-cols-2 gap-x-6 xx-xl:gap-x-[3rem] 
            ...
            {products &&
                products.map((product) => (
                    ...
                    >
                        ...
                        >
                            ...
                            <div className='flex-1 flex flex-col justify-between ml-4'>
                                <div className='flex justify-between'>
                                    <div>
                                        <h3
                                            className='text-[15px] font-[450] uppercase'
                                            onClick={() => goToProductDetailPage(product.productId)}>
                                ...
                                <div className='flex justify-between items-center gap-[30px] mt-2'>
                                    <div className='flex items-center space-x-2'>
                                        ...
                                        <motion.button
                                            className='w-[20px] h-[20px] flex items-center justify-center border-primaryDark 
                                                border rounded hover:border-primaryDark hover:bg-[#f1f7cf] transition duration-300'
                        ...
                        <p className='mt-[5px] h-[5px] text-[10px] text-red-500 tracking-[0.3px]'>
                            {" "}
                            {orderReviewError}{" "}
                        </p>
