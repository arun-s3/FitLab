...
export default function AdminAiInsightsPage() {
    ...
    setPageBgUrl(
        `linear-gradient(to right,rgba(255,255,255,0.94),rgba(255,255,255,0.94)), url('/Images/admin-aiInsights.png')`,
    )
    ...
    useEffect(() => {
        if (dashboardDatas) {
            const insightDatatypes = [
                ...
                "couponDiscountImpacts",
                "refundRequestDatas",
            ]
            const everyInsightDatatypesExists = insightDatatypes.every((datatype) =>
                Object.keys(dashboardDatas).includes(datatype),
            )
        ...
        <section id='AdminAiInsightsPage'>
            ...
            <main className='w-full'>
                ...
                <AiInsightCards
                    ...
                    excludeAndReturnItemTitles={[
                        "Probable Monthly Revenue Trends",
                        "Suggestions and Tips",
                        "Business Growth Probability",
                    ]}
                ...
                <div className='mt-8'>
                    ...
                    <FutureRevenueChart monthlyRevenueTrends={futureMonthlyRevenueTrends} parentFetchError={error} />

                </div>

                <AiInsightCards
                    insightsTemplates={insightsTemplates.filter((template) =>
                        reccomendationTemplateTitles.some((title) => title === template.title),
                    )}
                    existingAiInsights={dashboardInsights}
