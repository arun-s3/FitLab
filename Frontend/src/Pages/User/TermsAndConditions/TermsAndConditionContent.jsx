                    ...
                    >
                        ...
                        <motion.ul className='space-y-4'>
                            {termsAndConditions[activeSection].content.map((line, idx) => (
                                ...
                                >
                                    <div className='flex-shrink-0 w-2 h-2 bg-secondary rounded-full group-hover:scale-125 
                                        transition-transform duration-300' />
                                    <span className='text-gray-700 leading-relaxed text-base group-hover:text-gray-900 
