                    ...
                    <div className='fixed inset-0 z-50 flex items-center justify-center p-4'>
                        <motion.div
                            ...
                            className='bg-white dark:bg-gray-900 rounded-xl shadow-2xl border 
                                border-gray-200 dark:border-gray-700 w-full max-w-md mx-auto'
                            ...
                            <div className='flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700'>
                                <div>
                                    ...
                                    <p className='text-sm text-gray-500 dark:text-gray-400 mt-1'>
                                        {productCount > 0 ? `${productCount} products` : "All products"} will be
                                        exported. Are you Sure?
                                    </p>
                                </div>
                                <button
                                    onClick={onClose}
                            ...
                            <div className='p-6' ref={modalRef}>
                                                ...
                                                <motion.label
                                                    ...
                                                    {selectedFormat === format.id && (
                                                        <motion.div
                                                            initial={{ scale: 0 }}
                                                            animate={{ scale: 1 }}
                                                            className='w-5 h-5 bg-purple-500 rounded-full flex items-center 
                                                                justify-center ml-2'
                                                        >
                                ...
                                <div className='flex gap-3 pt-4'>
                                    ...
                                    <motion.button
                                        ...
                                        className='flex-1 px-4 py-2.5 text-[15px] bg-purple-600 hover:bg-purple-700 text-white 
