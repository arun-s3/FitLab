            ...
            >
                        ...
                        <div className='space-y-4'>
                            {bulletPoints.map((point, index) => (
                                <motion.div key={index} className='flex gap-3 items-start' variants={itemVariants}>
                                    <span className='mt-[9px] w-[10px] h-[6px] bg-primary rounded-[20px] shadow-[0_0_8px_3px_var(--PRIMARY)]'>
                                        {" "}
                                    </span>
                ...
                >
                    {stats.map((stat, index) => (
                        <StatCounter key={index} value={stat.number} label={stat.label} index={index} />
                    ))}
                </motion.div>
            </div>
