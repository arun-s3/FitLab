                    ...
                    <tr className='secondaryLight-box border border-[rgb(220, 230, 166)] font-[500] text-secondary table-header'>
                        ...
                        <td>
                            <div className='flex items-center'>
                                ...
                                <i className='flex flex-col gap-[2px] h-[5px]'>
                                    <FaSortUp
                                        onClick={(e) => {
                                            sortHandler(e, "title", 1)
                                        }}
                                        style={{
                                            height:
                                                activeSorter.field === "title" && activeSorter.order === 1
                                                    ? "15px"
                                                    : "10px",
                                            color:
                                                activeSorter.field === "title" && activeSorter.order === 1
                                    ...
                                    />
                                    <FaSortDown
                                        onClick={(e) => sortHandler(e, "title", -1)}
                                        style={{
                                            height:
                                                activeSorter.field === "title" && activeSorter.order === -1
                                                    ? "15px"
                        ...
                        <td>
                            <div className='flex items-center'>
                                ...
                                <i className='flex flex-col h-[5px]'>
                                    <FaSortUp
                                        onClick={(e) => sortHandler(e, "price", 1)}
                                        style={{
                                            height:
                                                activeSorter.field === "price" && activeSorter.order === 1
                                                    ? "15px"
                                                    : "10px",
                                            color:
                                                activeSorter.field === "price" && activeSorter.order === 1
                        ...
                        <td>
                            <div className='flex items-center'>
                                ...
                                <i className='flex flex-col h-[5px]'>
                                    <FaSortUp
                                        onClick={(e) => sortHandler(e, "brand", 1)}
                                        style={{
                                            height:
                                                activeSorter.field === "brand" && activeSorter.order === 1
                                                    ? "15px"
                                                    : "10px",
                                            color:
                                                activeSorter.field === "brand" && activeSorter.order === 1
                        ...
                        <td>
                            <div className='flex items-center'>
                                ...
                                <i className='flex flex-col h-[5px]'>
                                    <FaSortUp
                                        onClick={(e) => sortHandler(e, "stock", 1)}
                                        style={{
                                            height:
                                                activeSorter.field === "stock" && activeSorter.order === 1
                                                    ? "15px"
                                                    : "10px",
                                            color:
                                                activeSorter.field === "stock" && activeSorter.order === 1
                                    ...
                                    {(() => {
                                        ...
                                        if (totalLength > 20) {
                                            if (product.category.length === 2) {
                                                return (
                                                    product.category[0].slice(0, 15) +
                                                    " .., " +
                                                    product.category[1].slice(0, 10) +
                                                    ".."
                                                )
                                            }
