...
export default function AddressLists({ addresses, setOpenDeleteModal, setDeleteAddressId }) {
    ...
    return (
        <motion.div
            className='h-[28rem] xs-sm:h-[30rem] ml-12 xxs-sm:ml-8 xs-sm2:ml-auto w-[70%] xxs-sm:w-[80%] 
                xs-sm2:w-full overflow-y-scroll px-1 xs-sm:px-6'
            initial='hidden'
            animate='visible'
            variants={{
                hidden: {},
            ...
            <div className='pt-4 flex flex-col justify-center gap-[1.5rem] xs-sm:gap-[2rem] address-content'>
                {addresses &&
                    addresses.map((address) => (
                        ...
                        >
                            <address className='w-full not-italic flex flex-col justify-center text-[12px] 
                                mob:text-[13px] text-[#3C3D37] break-words'
                            >
                                <span className='mb-[5px] flex flex-wrap items-center justify-between'>
                                    <span className='px-[5px] mob:px-[6px] w-fit text-[10px] mob:text-[11px] 
                                        text-white capitalize bg-secondary rounded-[5px]'>
                                        {address.type}
                                    </span>
                                    {address.defaultAddress && (
                                        <motion.span
                                            ...
                                            <Check className='px-[3px] mob:px-[4px] h-[20px] mob:h-[23px] w-[20px] 
                                                mob:w-[23px] text-white bg-primary rounded-[10px]' />
                                            <span
                                                className='ml-[-6px] pl-[10px] pr-[12px] mob:pl-[12px] mob:pr-[15px] 
                                                    text-[10px] mob:text-[11px] text-[rgb(239,68,68)] tracking-[0.2px]
                                                    bg-primary rounded-[6px]'>
                                                Default
                                            </span>
                                        </motion.span>
                                    )}
                            ...
                            <motion.div
                                className={`mr-[7px] flex flex-row x-sm:flex-col gap-3 x-sm:gap-[2rem] 
                                    items-end min-w-[90px] x-sm:min-w-[35px] 
                                ...
                                {!address.defaultAddress && (
                                    <SitePrimaryButtonWithShadow
                                        tailwindClasses='!hover:bg-green-500 !w-[7rem] !text-[12px] !px-2 py-[2px] 
                                            !rounded-[5px]'
                                ...
                                <div className='flex x-sm:flex-col gap-3 x-sm:gap-[2rem] text-secondary address-options'>
                                    <span
                                        data-label='Edit'
                                        className='w-[28px] mob:w-[30px] p-[4px] border rounded-[20px] flex 
                                            items-center justify-center relative cursor-pointer address-control
                                            hover:border-0'
                                    ...
                                    <span
                                        ...
                                        <i>
                                            <Trash className='w-[14px] h-[14px] mob:w-[15px] mob:h-[15px]' />
                                        </i>
                                    </span>
                                </div>
                            </motion.div>
