            ...
            <div className='max-w-6xl mx-auto'>
                <motion.div className='text-center mb-8' variants={itemVariants} initial='hidden' animate='visible'>
                    ...
                    <p className='text-gray-600 text-lg'>
                        Calculate your BMI and comprehensive health indicators. Helps us track your health!
                    </p>
                </motion.div>
                        ...
                        <form onSubmit={calculateBMI} className='space-y-6'>
                            ...
                            <motion.div variants={itemVariants}>
                                ...
                                <input
                                    ...
                                    className='w-full px-4 py-3 border-2 border-gray-200 rounded-lg placeholder:text-gray-400 
                            ...
                            <motion.div className='flex gap-4 pt-6' variants={itemVariants}>
                                ...
                                <motion.button
                                    type='button'
                                    onClick={resetForm}
                                    className='flex-1 bg-gray-200 text-gray-700 font-bold py-3 px-6 rounded-lg 
                            ...
                            >
                                ...
                                <div className='flex items-end gap-4'>
                                    <div>
                                        ...
                                        <p className={`text-lg font-semibold ${results.bmiColor} mt-2`}>
                                            {results.bmiCategory}
                                        </p>
                                    </div>
                                    <div className='flex-1 h-20 bg-gradient-to-r from-purple-200 via-green-200 
                                        to-red-200 rounded-lg opacity-50'></div>
                                </div>
                            </motion.div>
                                ...
                                <div className='flex items-center justify-between'>
                                    <div>
                                        ...
                                        <p className='text-lg font-semibold text-green-600 mt-2'>
                                            {results.wherCategory}
                                        </p>
                                    </div>
                                    <div className='text-right text-sm text-gray-600'>
                                        <p>Ideal Range:</p>
                                        <p className='font-semibold'>
                                            {formData.gender === "male" ? "< 0.9" : "< 0.85"}
                                        </p>
                                    </div>
                                </div>
                            </motion.div>
                            ...
                            >
                                ...
                                <div className='flex items-center justify-between'>
                                    <div>
                                        ...
                                        <p className={`text-lg font-semibold ${results.bpColor} mt-2`}>
                                            {results.bpCategory}
                                        </p>
                                    </div>
                                </div>
                            ...
                            >
                                ...
                                <div className='flex items-center justify-between'>
                                    <div>
                                        ...
                                        <p className={`text-lg font-semibold ${results.bodyFatColor} mt-2`}>
                            ...
                            >
                                ...
                                <div className='flex items-center justify-between'>
                                    <div>
                                        ...
                                        <p className={`text-lg font-semibold ${results.glucoseColor} mt-2`}>
                                            {results.glucoseCategory}
                                        </p>
                                    </div>
                                </div>
                            </motion.div>
