        ...
        >
            ...
            >
                ...
                <div className='relative mb-6 flex flex-col items-start gap-[5px]'>
                    ...
                    />
                    <button
                        className='absolute right-[13.5rem] top-[2.8rem] transform -translate-y-1/2 w-fit bg-purple-600 
                            hover:bg-purple-700 text-white text-[12px] font-semibold py-[5px] px-[7px] rounded-[5px] 
