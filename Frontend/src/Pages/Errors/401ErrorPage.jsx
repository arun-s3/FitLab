...
export default function ErrorPage401() {
    ...
    return (
        <div
            className='min-h-screen bg-gradient-to-br from-purple-50 via-white to-purple-100 flex items-center justify-center
                ...
                <div className='grid lg:grid-cols-2 gap-12 items-center'>
                    ...
                    <motion.div className='space-y-8 text-center lg:text-left order-1 lg:order-2'>
                        <motion.div
                            ...
                            <h1
                                className='text-8xl sm:text-9xl font-black text-transparent bg-gradient-to-r 
                                    from-purple-500 to-purple-600 bg-clip-text tracking-tight'
                            >
                                401
                            </h1>
                            <motion.img
                        ...
                        <motion.div variants={itemVariants}>
                            <p className='text-gray-600 text-[16px] leading-relaxed text-pretty max-w-md mx-auto lg:mx-0'>
                                You don't have the right permissions to view this page. Please check your credentials or
                        ...
                        >
                            <motion.button
                                className='inline-flex items-center gap-2 px-8 py-4 rounded-xl font-semibold focus:outline-none 
                                    text-white bg-purple-600 hover:bg-purple-700 focus:ring-2 focus:ring-purple-500 
                                    focus:ring-offset-2 transition-all duration-200 shadow-lg hover:shadow-xl 
                                    w-full sm:w-auto border-nonw'
                            ...
                            <motion.button
                                className='inline-flex items-center gap-2 bg-white text-gray-700 border-2 border-gray-200 
                                    px-8 py-4 rounded-xl font-semibold hover:bg-gray-50 hover:border-gray-300 
                        ...
                        <motion.div variants={itemVariants} className=''>
                            <motion.button
                                className='inline-flex items-center gap-2 text-gray-500 hover:text-purple-600 
