                    ...
                    >
                        ...
                        <div className='px-6 pt-6 pb-4 text-center' ref={modalRef}>
                            <motion.div
                                ...
                                initial='hidden'
                                animate='visible'
                                className='inline-flex items-center justify-center w-12 h-12 mx-auto mb-3 bg-red-100
                                    dark:bg-red-900/30 rounded-full'
                            >
                        ...
                        <motion.div
                            ...
                            initial='hidden'
                            animate='visible'
                            className='mx-6 mb-4 p-3 bg-gray-50 dark:bg-gray-800/50 border border-gray-200 
                        ...
                        <div className='px-6 pb-5 space-y-2.5'>
                            <motion.button
                                ...
                                className='w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-secondary dark:bg-gray-100 
                                    text-white dark:text-gray-900 rounded-[7px] font-medium hover:bg-purple-700 
                                    dark:hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 
                            ...
                            >
                                <motion.div
                                    ...
                                    transition={{
                                        duration: 1,
                                        repeat: isRetrying ? Number.POSITIVE_INFINITY : 0,
                                        ease: "linear",
                                    }}
                                >
                                    <RefreshCw size={16} />
                            ...
                            <motion.button
                                ...
                                className='w-full flex items-center justify-center gap-2 px-4 py-[8px] border border-secondary 
                                    dark:bg-gray-100 text-secondary hover:text-white dark:text-gray-900 rounded-[7px] 
                                    font-medium hover:border-purple-700 hover:bg-secondary dark:hover:bg-gray-200 
