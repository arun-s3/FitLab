...
const CalenderIcon = ({iconClassName, strokeColor})=>{
    return(
...
export function DateSelector({dateGetter, dateSetter, labelNeeded, strokeColor, iconClassName, className, calendarClassName}){
           ...
           <div id="calender" className='flex gap-[5px] items-center'>
                <div className="date-picker">
                    <DatePicker selected={startDate} 
                      ...
                      icon={<CalenderIcon strokeColor={strokeColor} iconClassName={iconClassName}/>} />
                </div>
