                    ...
                    >
                        ...
                        <div className='p-6' ref={modalRef}>
                            <div className='flex items-center space-x-4 mb-4'>
                                ...
                                <div>
                                    ...
                                    <p className='text-sm text-gray-500'>
                                        {" "}
                                        This action will remove the applied coupon.{" "}
                                    </p>
                                </div>
                            </div>
                            ...
                            <p className='text-[13px] text-gray-500 mb-[1rem]'>
                                Removing this coupon will cancel any discounts it provides. You can apply it again later
                                if it hasn’t expired or been fully used.
                            </p>

                            <div className='flex xxs-sm:flex-row flex-col justify-center xxs-sm:justify-end 
                                items-center gap-4 space-x-3'
                            >
                                <motion.button
                                ...
                                <motion.button
                                    ...
                                    className='w-full xxs-sm:w-auto !ml-0 xxs-sm:ml-auto px-4 py-2 border border-transparent 
