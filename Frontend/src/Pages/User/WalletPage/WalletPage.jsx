...
export default function WalletPage() {
    ...
    const { openSemiAutoRechargeModal, setOpenSemiAutoRechargeModal, openNotificationModal, setOpenNotificationModal } =
                ...
                <div className='flex flex-col space-y-6'>
                    ...
                    <Elements stripe={stripePromise}>
                        ...
                        <AutoRechargeModal
                            ...
                            currentSettings={
                                (safeWallet && decryptData(safeWallet)?.autoRecharge) || autoRechargeSettings
                            }
                        />
