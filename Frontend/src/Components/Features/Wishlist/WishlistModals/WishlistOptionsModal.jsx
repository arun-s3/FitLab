...
import { SiteSecondaryFillButton } from "../../../UI/SiteButtons/SiteButtons"
                ...
                <div className='p-6 pb-[1rem]' ref={modalRef}>
                    ...
                    <form onSubmit={handleSubmit} className='space-y-4'>
                        ...
                        <div className='relative'>
                            ...
                            <select
                                ...
                                onChange={(e) => setProductPriority(Number.parseInt(e.target.value))}
                                className='w-full pr-3 pl-[45px] py-[4px] text-[13px] text-muted border border-gray-300 rounded-md 
                                    shadow-sm focus:outline-none focus:ring-secondary focus:border-secondary 
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className='w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-secondary
                                    focus:border-secondary placeholder:text-[11px] resize-none'></textarea>
                        </div>
                    ...
                    <div className='mt-6 pt-4 border-t'>
                        <button className='flex items-center'>
                            <Plus
                                className={`h-5 w-5 mr-2 ${isHovered ? "text-orange-400" : "text-primaryDark"}
                                    transition duration-150 ease-in-out`}
                                onMouseEnter={() => setIsHovered(true)}
                                onMouseLeave={() => setIsHovered(false)}
                            />
                            <span
                                className={`text-[15px] ${isHovered ? "text-purple-700" : "text-secondary"} t
