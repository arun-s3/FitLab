                ...
                <>
                    ...
                    <div className='fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none'>
                        <motion.div
                            ...
                            className='bg-white rounded-[9px] shadow-2xl w-full max-w-5xl max-h-[90vh] overflow-hidden 
                                pointer-events-auto'
                        >
                            <div className='bg-gradient-to-r from-purple-500 to-purple-600 px-6 py-5 flex items-center 
                                justify-between'
                            >
                                <motion.h2
                            ...
                            <div className='overflow-y-auto max-h-[calc(90vh-80px)] p-6' ref={modalRef}>
                                <motion.div
                                    ...
                                    className='bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6 mb-6 
                                ...
                                >
                                    ...
                                    {lastOrder && (
                                        <motion.div
                                            ...
                                            className='bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-5 
