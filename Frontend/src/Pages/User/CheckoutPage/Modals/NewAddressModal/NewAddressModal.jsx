...
import { X, MapPin, User, Phone, Mail, Home, Briefcase, Clock, Gift } from "lucide-react"
                        ...
                        >
                            <div className='bg-gradient-to-r from-purple-50 to-blue-50 px-6 py-6 border-b border-gray-100'>
                                <div className='flex items-center justify-between'>
                                    <div>
                                        <h2 className='text-[20px] max-xs-sm2:text-[18px] font-bold tracking-[0.5px] 
                                            text-gray-900 flex items-center gap-2'
                                        >
                                            <MapPin className='w-[22px] h-[22px] text-purple-600' />
                                            <span className='first-letter:text-[21px] max-xs-sm2:first-letter:text-[19px]'>
                                                {" "}
                                                Add New Address{" "}
                                            </span>
                                        </h2>
                                        <p className='text-purple-600 text-sm max-xs-sm2:text-[12px] mt-1'>
                                            {" "}
                                            Fill in the below fields to add a new address{" "}
                                        </p>
                                    </div>
                                    <motion.button
                            ...
                            <div className='overflow-y-auto max-h-[calc(90vh-140px)]' ref={modalRef}>
                                <form onSubmit={handleSubmit} className='p-6 space-y-6'>
                                    ...
                                    >
                                        ...
                                        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 gap-y-[1.7rem] max-xs-sm2:flex
                                            max-xs-sm2:flex-col'
                                        >
                                            {
                                                <AddressField
                                    ...
                                    >
                                        <motion.button
                                            ...
                                            whileTap={{ scale: 0.98 }}
                                            className='w-full bg-secondary text-[17px] max-xs-sm2:text-[15px] text-white 
                                                tracking-[0.7px] font-semibold py-4 px-6 rounded-[7px] shadow-lg hover:shadow-xl 
                                                transition-all duration-300 focus:ring-4 focus:ring-purple-200'
                                        >
