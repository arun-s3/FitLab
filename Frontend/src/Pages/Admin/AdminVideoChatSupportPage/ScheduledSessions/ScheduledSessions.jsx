        ...
        async function fetchSessions() {
            try {
                ...
                if (!error.response) {
                    ...
                    sonnerToast.error(
                        "Cannot load sessions due to server issues. Please refresh again or come again later!",
                    )
                }
            }
        }
            ...
            <motion.div variants={item} className='flex flex-col sm:flex-row gap-4 mb-[2.5rem]'>
                <div className='flex items-center space-x-2'>
                    ...
                    <select
                        ...
                        className='bg-gray-50 w-[8rem] border border-gray-200 rounded-lg px-3 py-2 text-sm 
