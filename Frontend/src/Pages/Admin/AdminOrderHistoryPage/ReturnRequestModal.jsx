...
import { X, ChevronLeft, ChevronRight, Package, Calendar, User, Mail, MessageSquare } from "lucide-react"
...
import { handleReturnDecision } from "../../../Slices/orderSlice"
import { camelToCapitalizedWords } from "../../../Utils/helperFunctions"


export default function ReturnRequestModal({
    returnRequestOrder = null,
    returnRequestProduct = null,
    ...
    const handleDecision = (didAccept) => {
        ...
        const returnDetails = {
            orderId: returnRequestOrder._id,
            productId: returnOrderOrProduct._id,
            returnType: returnOrderOrProduct,
            didAccept,
        }
                        ...
                        <div className='flex items-center gap-3'>
                            ...
                            <div>
                                ...
                                <p className='text-secondary text-sm font-medium'>
                                    {" "}
                                    {returnRequestOrder.fitlabOrderId}{" "}
                                </p>
                            </div>
                        </div>
                        <div className='flex items-center gap-3'>
                        ...
                        >
                            <motion.div className='lg:col-span-2 space-y-6' variants={itemVariants}>
                                ...
                                <motion.div className='grid grid-cols-2 sm:grid-cols-4 gap-4' variants={itemVariants}>
                                    <div className='bg-slate-50 rounded-lg p-4 border border-slate-200'>
                                        <p className='text-xs text-slate-600 uppercase tracking-wide mb-1'>
                                            {returnOrderOrProduct === "order" ? "Total Price" : "Price"}
                                        </p>
                                    ...
                                    <div className='bg-slate-50 rounded-lg p-4 border border-slate-200'>
                                        ...
                                        <p className='text-[16px] !text-primaryDark font-[550]'>
                                            {format(new Date(returnRequestOrder.deliveryDate), "MMMM dd, yyyy")}
                                        </p>
                                    </div>
                                    ...
                                    {returnOrderOrProduct === "order" && (
                                        <div className='bg-slate-50 rounded-lg p-4 border border-slate-200'>
                                            ...
                                            <p className='text-[16px] !text-primaryDark font-[550]'>
                                                {returnRequestOrder.products.length}
                                            </p>
                                        </div>
                                    )}
                                    ...
                                    return (
                                        <motion.div className='space-y-4' variants={itemVariants}>
                                            ...
                                            >
                                                ...
                                                <div className='absolute bottom-3 right-3 bg-black bg-opacity-60 
                                ...
                                <motion.div
                                    className='bg-gradient-to-br from-orange-50 to-orange-100 border-2 
                                        border-primaryDark rounded-xl p-6'
                                    variants={itemVariants}
                                >
                                    ...
                                    <p className='text-[13px] text-slate-700 leading-relaxed'>
                                        {returnOrderOrProduct === "order"
                                            ? returnRequestOrder.orderReturnReason
                                            : returnRequestProduct.productReturnReason}
                                    </p>
                                </motion.div>
                            </motion.div>
                            ...
                            <motion.div className='lg:col-span-2' variants={itemVariants}>
                                    ...
                                    >
                                        ...
                                        <div className='flex items-start gap-3'>
                                            ...
                                            <div className='min-w-0'>
                                                ...
                                                <p className='text-[13px] !text-secondary font-medium truncate'>
                                                    {returnRequestOrder.userId.username}
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div className='flex items-start gap-3'>
                                            ...
                                            <div className='min-w-0'>
                                                ...
                                                <p className='text-[13px] !text-secondary font-medium text-sm truncate'>
                                                    {returnRequestOrder.userId.email}
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <motion.div className='flex items-center gap-12 mt-6' variants={itemVariants}>
                                    ...
                                    <motion.button
                                        className='w-full bg-gray-200 hover:bg-slate-300 text-slate-900 font-semibold 
                                            py-3 px-4 rounded-lg flex items-center justify-center gap-2 transition-colors'
                                        whileHover={{ scale: 1.02 }}
                                        whileTap={{ scale: 0.98 }}
                                        onClick={onClose}
