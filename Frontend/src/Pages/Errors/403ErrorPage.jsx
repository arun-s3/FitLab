    ...
    return (
        <section
            ...
            className="h-screen bg-[url('/Images/Error403Img.jpg')] bg-cover md:bg-none bg-[position:-10rem_0] 
              xs-sm:bg-[position:-7rem_0] md:bg-[position:0_0] md:bg-[#FAD42B] relative before:content-[''] 
              before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-gradient-to-b 
              before:from-white/50 before:backdrop-blur-[2px] md:before:content-none md:static"
        >
            <main className='h-full w-full flex justify-center md:justify-normal items-center gap-[2rem] overflow-y-hidden'>
                <div
                    className='hidden md:inline-block h-full md:ml-[-80px] xx-md:ml-[-30px] lg:ml-0 md:mt-[3.5rem] 
                ...
                <div
                    className='w-[85%] p-4 md:p-0 rounded-[9px] md:rounded-none xs-sm:w-auto mr-4 static md:absolute 
                ...
                >
                    <h1
                        className='w-full pl-[10px] text-[45px] xs-sm:text-[60px] xx-md:text-[80px] font-600 bg-red-500
                    ...
                    <h3 className='w-dull xs-sm:w-[30rem] text-[13px] xs-sm:text-[14px] xx-md:text-[18px] text-white md:text-black'>
                        {message
                            ? message
                            : "Oops! You’re not allowed to view this page. Please check your account or head back to the home page to continue shopping!"}
                    </h3>

                    <div className='w-full mt-[2rem] flex items-center justify-between'>
                        <motion.button
                            className='px-[2rem] py-[5px] rounded-[10px] tracking-[0.3px] text-[14px] xx-md:text-[16px] 
                                bg-primaryDark border-[2px] border-secondary flex items-center gap-[10px] 
                                hover:bg-green-500 hover:border-primary'
