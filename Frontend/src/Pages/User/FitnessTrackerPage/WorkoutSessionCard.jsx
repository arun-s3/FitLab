    ...
    const getExercises = async () => {
        try {
            const response = await apiClient.get(
                `/fitness/tracker/exercise-library/list?page=${currentPage}&limit=${limit}`,
            )
                        ...
                        >
                            ...
                            <div className='space-y-2 max-h-96 overflow-y-auto'>
                                ...
                                {!loading && !fetchError && exercises?.length === 0 ? (
                                    ...
                                    <p className='my-12 text-center text-red-500 text-[13px] traxking-[0.3px]'>
                                        {" "}
                                        {fetchError}{" "}
                                    </p>
                                ) : (
                                        ...
                                        >
                                            <div className='flex items-start justify-between'>
                                                <div className='flex-1'>
                                                    <p className='flex items-center gap-[5px]'>
                                                        ...
                                                        <span className='text-secondary text-[14px] font-medium capitalize'>
                                                            {" "}
                                                            {exercise.name}{" "}
                                                        </span>
                                                    </p>
                                                    <ul className='list-disc ml-8'>
                                                        {exercise.sets.map((set, index) => (
                                                            <li
                                                                key={index}
                                                                className='text-gray-600 text-[13px] mt-[5px]'>
                                                                {`Set-${index + 1}: ${set.reps} reps  with ${set.weight}kg (${set.rpe}/10 RPE)`}
                                                            </li>
                                                        ))}
                                                    </ul>
                                                    {exercise.notes && (
                                                        <p className='ml-4 text-gray-500 capitalize text-xs tracking-[0.3px] mt-1'>
                                                            {exercise.notes}
                                                        </p>
                                                    )}
                                                    <div className='ml-8 mt-1 flex items-center gap-8'>
                                                        {exercise.equipment && (
                                                            <p className='flex items-center gap-[5px]'>
                                                                ...
                                                                <span className='text-muted text-[13px] capitalize'>
                                                                    {" "}
                                                                    {exercise.equipment}{" "}
                                                                </span>
                                                            </p>
                                            ...
                                            <div className='w-full flex items-center justify-between'>
                                                <motion.div whileTap={{ scale: 0.98 }} className='mt-[10px] ml-[3px]'>
                                                    <button
                                                        className={`flex items-center gap-[5px] hover:bg-green-400 transition 
                                                            duration-300 hover:text-white text-[11px] font-medium tracking-[0.2px] 
                                                            px-[9px] py-[7px] rounded-[6px] !disabled:cursor-not-allowed 
                                                            ${
                                                                selectedExerciseId === exercise._id
                        ...
                        <AnimatePresence>
                            {selectedExercise && (
                                ...
                                >
                                    ...
                                    <p className='text-gray-900 font-bold text-lg mb-4 capitalize'>
