        ...
        <footer className='padding-main py-[2.3rem] text-white max-xs-sm2:overflow-x-hidden'>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-14 items-start'>
                ...
                <div className='space-y-4 w-[380px]'>
                    ...
                    <nav className='ml-[28px] flex flex-wrap gap-4 items-center text-white' id='footer-socials'>
                ...
                >
                    <ul className='list-none text-descReg1 lg:text-[13px] xl:text-descReg1'>
                        <li>
                            {" "}
                            <h6 className='text-secondary text-descReg1 lg:text-[13px] xl:text-descReg1 whitespace-nowrap'>
                                {" "}
                                CATEGORY{" "}
                            </h6>
                        </li>
                    ...
                    <ul className='list-none text-descReg1 lg:text-[13px] xl:text-descReg1 whitespace-nowrap'>
                        <li>
                            <h6 className='text-secondary text-descReg1 lg:text-[13px] xl:text-descReg1'> SUPPORT </h6>
                        </li>
                ...
                <div className='sm:ml-[28px] md:ml-0'>
                    <h4 className='text-white mt-[2rem] mb-[3px] tracking-[0.2px] lg:text-[15px] xl:text-[17px]'>
                        {" "}
                        Newsletter{" "}
                    </h4>
                    <form
                        className='flex flex-col sm:flex-row sm:justify-between items-stretch gap-3'
                    ...
                    >
                        <input
                            ...
                            name='email'
                            autoComplete='email'
                            className='placeholder:text-[12px] py-[6px] pl-[14px] rounded-[7px] w-full 
                                md:w-auto lg:min-w-[12rem] xl:min-w-[17rem]
