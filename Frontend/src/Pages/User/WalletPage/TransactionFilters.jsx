    ...
    return (
        ...
        >
            <motion.h4
                ...
                className=' text-[16px] mob:text-[15px] s-sm:text-[16px] font-[600] text-secondary tracking-[1.1px] 
                                        ...
                                        <motion.li
                                            ...
                                            <span
                                                className={`w-full h-[26px] pl-[8px] flex items-center gap-[7px] rounded-[5px] 
                                                    ...
                                                    ${statusValue.value === type ? "text-primaryDark" : "text-muted"} `}
                                            >
                                                {(() => {
                ...
                <motion.div
                    ...
                    <ul className='list-none flex flex-wrap items-center gap-[0.8rem] mob:gap-[0.6rem]'>
                        {transactionType.map((type) => (
                            <motion.li key={type} className='flex items-center gap-[5px]' variants={childVariants}>
                                <input
                                    type='radio'
                                    value={type}
                    ...
                    >
                        ...
                        {paymentMethod.show && (
                            <motion.ul
                                ...
                                animate='visible'
                                exit='exit'
                                className='list-none w-full px-[10px] py-[1rem] absolute top-[40px] right-0 flex flex-col 
                                    gap-[10px] justify-center text-[11px] bg-white border border-borderLight2 
                                    ...
                                    paymentMethods.map((type) => (
                                        <motion.li
                                            ...
                                            <span
                                                className={`w-full h-[26px] pl-[8px] flex items-center gap-[7px] rounded-[5px]
                                                    hover:text-primaryDark hover:bg-[#F5FBD2] 
                                                    ${paymentMethod.value === type ? "text-primaryDark" : "text-muted"} `}
                                            >
                                                {(() => {
