                            ...
                            >
                                <div className='flex items-center space-x-[0.5rem] s-sm:space-x-[1rem]'>
                                    <img
                                        ...
                                        alt={product.title}
                                        className='w-[4rem] h-[4rem] mob:w-[5rem] mob:h-[5rem] s-sm:w-[6rem] s-sm:h-[6rem]
                                            object-cover rounded transition hover:scale-105 duration-150 cursor-pointer'
                                    />
                                        ...
                                        !product?.maxOfferDiscountApplied ? (
                                            ...
                                            product?.maxOfferDiscountApplied && (
                                                <span className='text-[12px] text-green-500'>
                                                    {" "}
                                                    You save ₹{product.offerDiscount.toFixed(2)}{" "}
                                                </span>
                                            )
                                        )}
                                    </p>
                                ...
                                <div className='flex items-center justify-center space-x-[5px] s-sm:space-x-[8px]'>
                                    <button
                                        className='p-[3px] s-sm:p-[4px] bg-primary hover:bg-primaryDark rounded-[4px]'
                                    ...
                                    <span className='w-[1.5rem] s-sm:w-[2rem] text-center text-[13px] s-sm:text-[15px]'>
                                        {" "}
                                        {product.quantity}{" "}
                                    </span>
                                    <button
