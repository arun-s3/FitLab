            ...
            <div className='max-w-7xl mx-auto'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center'>
                    ...
                    <motion.div className='flex flex-col justify-center space-y-6' variants={containerVariants}>
                        <motion.p
                            className='text-sm md:text-base text-secondary font-medium tracking-wide'
                        ...
                        <motion.p className='text-sm md:text-base leading-relaxed' variants={itemVariants}>
                            With the industrial experience of more than 15 years, we are able to maintain top position
                            in the field of manufacturing, supplying and exporting a comprehensive range of Fitness, Gym
                            Equipment, Cardio Equipment and Sports Goods. We have state-of-the-art infrastructure where
                            all the manufacturing processes are carried out in a systematic manner.
                        </motion.p>
