            ...
            >
                ...
                {!requestType && !inCall && !scheduledCallReceived && (
                    <RequestForm
                        ...
                        onScheduleRequest={() => setIsScheduleModalOpen(true)}
                    />
                )}

                {requestType === "immediate" && isWaiting && !scheduledCallReceived && (
                    <WaitingRoom
                        socketContextItems={socketContextItems}
                ...
                {(inCall || scheduledCallReceived) && (
                    <VideoChat
                        socketContextItems={socketContextItems}
                        ImmediateVideoCallsessionId={callData?.sessionId}
                        scheduledCallReceived={scheduledCallReceived}
                        scheduledVideoCallSessionId={scheduledVideoCallSessionId}
                        onEndCall={handleEndCall}
                    />
                )}
                ...
                <CallDeclinedModal 
                    isOpen={isCallDeclinedModalOpen} 
