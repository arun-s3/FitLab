    ...
    return (
        <>
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        className='fixed left-0 top-0 h-full w-80 bg-gradient-to-b from-neutral-900 via-neutral-900 
                            to-neutral-800 z-50 xx-md:hidden flex flex-col shadow-2xl border-r border-neutral-700/50'
                        variants={sidebarVariants}
                        initial='closed'
                        animate='open'
                        exit='closed'
                    >
                        <div className='mt-[10px] flex items-center justify-between px-[10px] py-[5px] border-b 
                            border-dashed border-neutral-700/50 bg-gradient-to-r from-neutral-800/50 
                            to-neutral-900/50 backdrop-blur-sm'
                        >
                            ...
                            <motion.button
                                onClick={onClose}
                                className='text-neutral-400 hover:text-white transition-colors p-2 rounded-lg 
                        ...
                        <div className='p-6 border-neutral-700/50'>
                            <div className='relative'>
                                ...
                                <input
                                    ...
                                    className='w-full bg-neutral-800/80 text-white text-[14px] 
                                        placeholder:text-[13px] placeholder-neutral-400 pl-[15px] pr-4 py-[7px] 
                                        rounded-[6px] border border-neutral-700/50 focus:border-orange-500/50 
                                        focus:ring-2 focus:ring-orange-500/20 focus:outline-none transition-all 
                                        duration-300 backdrop-blur-sm'
                                />
                            </div>
                        </div>

                        <div className='flex-1 overflow-y-auto pt-[10px] pb-6 bg-gradient-to-br 
                            from-neutral-900 via-neutral-950 to-[#200a38]'
                        >
                            <motion.nav
                                className='px-4 flex flex-col gap-[10px]'
                                ...
                                {filteredMenuItems.map((item, index) => (
                                    <motion.div key={item.id} variants={itemVariants}>
                                        <motion.button
                                            ...
                                            className='w-full flex items-center justify-between px-5 py-[5px] 
                                                text-neutral-300 hover:text-white hover:bg-gradient-to-r 
                                                hover:from-neutral-800/80 hover:to-neutral-700/50 rounded-xl 
                                                transition-all duration-300 group backdrop-blur-sm border 
                                        ...
                                        >
                                            ...
                                            >
                                                <motion.div
                                                    className='p-2 rounded-lg bg-neutral-800/50 group-hover:bg-orange-400/20 
                                                        transition-all duration-300'
                                                    whileHover={{ rotate: 5 }}
                                                >
                                                    <item.icon
                                                        size={17}
                                                        className='text-primary group-hover:text-orange-300 transition-colors 
                                                            duration-300'
                                                    />
                                                </motion.div>
                                            ...
                                            {item.hasSubmenu && (
                                                <motion.div
                                                    ...
                                                    className='p-1 rounded-full group-hover:bg-neutral-700/50 
                                                            ...
                                                            {item.submenu.map((subItem, subIndex) => (
                                                                <motion.button
                                                                    ...
                                                                    className='w-full flex items-center space-x-3 px-4 py-3
                                                                        text-neutral-400 hover:text-white hover:bg-gradient-to-r
                                                                        hover:from-neutral-800/60 hover:to-neutral-700/30 
                                                                        rounded-lg transition-all duration-300 text-left 
                                                                        group border border-transparent hover:border-neutral-700/20'
                                                                ...
                                                                >
                                                                    <motion.div
                                                                        className='p-1 rounded-md bg-neutral-800/30 
                                                                            group-hover:bg-orange-500/10 transition-colors duration-300'
                        ...
                        <div className='border-t border-[#420d67] px-4 py-[10px] bg-gradient-to-r 
                            from-neutral-800/30 to-neutral-900/30 backdrop-blur-sm'
                        >
                            <motion.nav
                                className='space-y-1'
                                variants={containerVariants}
                            ...
                            >
                                {filteredBottomItems.map((item, index) => (
                                    <motion.button
                                        ...
                                        className='w-full flex items-center space-x-4 px-5 text-neutral-300 
                                            hover:text-white hover:bg-gradient-to-r hover:from-neutral-800/80 
                                            hover:to-neutral-700/50 rounded-xl transition-all duration-300 group 
