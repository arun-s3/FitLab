...
export const requestMoneyFromUser = createAsyncThunk(
    "wallet/requestMoneyFromUser",
...
export const confirmMoneyRequest = createAsyncThunk(
    "wallet/confirmMoneyRequest",
...
export const declineMoneyRequest = createAsyncThunk(
    "wallet/declineMoneyRequest",
    async ({ transaction_id }, thunkAPI) => {
        try {
...
export const updateAutoRechargeSettings = createAsyncThunk(
    "wallet/updateAutoRechargeSettings",
