                            ...
                            <div className='mt-[64px]'>
                                ...
                                <div className='mt-[32px]'>
                                    <AnimatePresence mode='wait'>
                                        {activeTab === "description" && (
                                            ...
                                            >
                                                {productDetails.description && (
                                                    <>
                                                        <h2 className='text-[24px] font-bold mb-[16px]'>
                                                            {" "}
                                                            Product Description{" "}
                                                        </h2>
                                                        <p
                                                            className='text-gray-600 text-[14px] xs-sm:text-base 
                                                                leading-relaxed break-words whitespace-normal max-w-full 
                                                                overflow-hidden'
                                                        >
                                        ...
                                        {activeTab === "additional info" && productDetails.additionalInformation && (
                                            <>
                                                <motion.div
                                                    key='additional-info'
                                                    initial={{ opacity: 0, y: 10 }}
                                                ...
                                                >
                                                    ...
                                                    <ul className='list-disc list-inside space-y-[8px]'>
                                                        {productDetails.additionalInformation.map((info) => (
                                                            <li key={info}>{capitalizeFirstLetter(info)}</li>
                                                        ))}
                                                    </ul>
                                                </motion.div>
                                            </>
                                        ...
                                        {activeTab === "reviews" && (
                                            ...
                                            >
                                                ...
                                                <ReviewPanel
                                                    ...
                                                    productRating={
                                                        productDetails?.averageRating ? productDetails.averageRating : 0
                                                    }
                            ...
                            <div className='mt-[4rem]'>
                                {productDetails && (
                                    ...
                                    <SimilarProductsCarousal
                                        titleColor='black'
                                        referenceProductIds={[currentProductId]}
                                    />
