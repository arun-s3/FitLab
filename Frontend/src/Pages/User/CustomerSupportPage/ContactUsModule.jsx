            ...
            <div className='max-w-4xl mx-auto'>
                ...
                >
                    ...
                    <motion.p
                        ...
                        className='text-[13px] text-gray-300 max-w-2xl mx-auto leading-relaxed'>
                ...
                <div className='grid lg:grid-cols-2 gap-12 items-start'>
                    ...
                    >
                        <div className='space-y-6'>
                            <motion.div
                                variants={itemVariants}
                                className='flex items-center space-x-4 p-4 bg-whitesmoke rounded-lg shadow-sm 
                                    hover:shadow-md transition-shadow duration-300'
                            >
                                <motion.div
                                    variants={iconVariants}
                                    className='flex-shrink-0 w-[30px] h-[30px] bg-blue-100 rounded-full flex items-center 
                                        justify-center'
                                >
                            ...
                            <motion.div
                                variants={itemVariants}
                                className='flex items-center space-x-4 p-4 bg-whitesmoke rounded-lg shadow-sm hover:shadow-md 
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className='text-[15px] text-gray-900 font-semibold'>
                                        Fitlab Hq, Viyyur Jn, Thrissur, Kerala, India (680010)
                                    </p>
                                </div>
                            </motion.div>
                        </div>
                            ...
                            <div className='flex space-x-4'>
                                {[
                                    ...
                                    <motion.button
                                        ...
                                        whileHover='hover'
                                        className={`w-12 h-12 border-2 ${social.border} ${social.text} ${social.hover} 
                                            bg-transparent rounded-full flex items-center justify-center font-bold text-lg 
                    ...
                    >
                        <motion.div
                            variants={itemVariants}
                            className='bg-gradient-to-br from-blue-600 to-blue-700 p-8 rounded-2xl text-white shadow-lg 
                        ...
                        >
                            ...
                            <p className='text-[12px] text-blue-100 leading-relaxed'>
                                Empowering fitness enthusiasts with premium equipment, supplements, and expert guidance
                        ...
                        <motion.div
                            variants={itemVariants}
                            className='bg-gradient-to-br from-purple-600 to-purple-700 p-8 rounded-2xl text-white shadow-lg 
                                hover:shadow-xl transition-shadow duration-300'
                        >
                            <motion.div
                                variants={iconVariants}
                            ...
                            <p className='text-[12px] text-purple-100 leading-relaxed'>
                                To be the India's most trusted fitness destination, inspiring healthier and stronger
                                lives globally.
                            </p>
                        </motion.div>
                    </motion.div>
