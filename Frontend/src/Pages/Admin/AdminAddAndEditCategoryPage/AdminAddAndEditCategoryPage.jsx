...
export default function AdminAddAndEditCategoryPage({ editCategory }) {
    ...
    const { loading, error, tempDatas, categories, categoryCreated, categoryUpdated } = useSelector(
    ...
    setPageBgUrl(
        `linear-gradient(to right,rgba(255,255,255,0.95),rgba(255,255,255,0.95)), url('/Images/admin-bg1.png')`,
    )
    ...
    const selectListHandler = (name, categoryType, e) => {
        ...
        function closeList() {
            const listNode =
                categoryType == "parentCategory" || "categoryBadge"
        ...
        if (
            ...
            for (let field in rest) {
                ...
                if (Array.isArray(value)) {
                    value.forEach((item) => {
                        if (item !== null && item !== undefined) formData.append(`${field}[]`, item)
                    })
                } else {
            ...
            editCategory
                ? dispatch(updateCategory({ formData, id: editCategoryItem.current._id }))
        ...
        <section id='AdminAddAndEditCategoryPage'>
            <header>
                ...
                <AdminTitleSection
                    ...
                    subHeading={
                        editCategory ? "Update the Category information" : "Create and organize categories here"
                    }
                />
                ...
                <div className='flex flex-col gap-[15px] basis-[65%] w-[65%]' id='category-content'>
                    ...
                    <div className='category-content-wrapper'>
                        <div className='category-labels'>
                            ...
                            <p>
                                Enter a unique and descriptive name for the category. This will help customers easily
                                identify and navigate to the products. Keep it concise, under 50 characters.
                            </p>
                        </div>
                        <div className='relative'>
                            ...
                            <input
                                ...
                                onBlur={(e) => inputBlurHandler(e, "categoryName")}
                                onChange={(e) => changeHandler(e, "categoryName")}
                    ...
                    <div className='category-content-wrapper'>
                        <div className='category-labels'>
                            ...
                            <p>
                                Choose a parent category from the list to organize it under a broader group. This helps
                                organize products, improving navigation and customer experience. If this is a standalone
                        ...
                        <div className='relative' ref={dropdownRefs.parentCatDropdown}>
                            ...
                            <div
                                className={`w-[20rem] h-[2.4rem] border border-primary rounded-[5px] pr-0 text-[12px]
                            ...
                            >
                                <span className='absolute top-[10px] left-[25px]'>
                                    {" "}
                                    {categoryData.parentCategory && categoryData.parentCategory}{" "}
                                </span>
                                <i className='w-full h-full flex items-center justify-end pr-[5px] cursor-pointer'>
                                    {" "}
                                    <MdArrowDropDown />{" "}
                                </i>
                            </div>
                            {openDropdowns.parentCatDropdown && (
                                <div
                                    className='absolute top-[38px] flex flex-col justify-center items-center gap-[3px] w-full h-fit 
                                        py-[10px] px-[10%] rounded-[5px] bg-white border border-primary rounded-tl-none 
                                        rounded-tr-none z-[5]'>

                                    <CategoryDisplay
                                        type='radioType'
                                        radioCheckedCategory={radioCheckedCategory}
                                        setRadioCheckedCategory={setRadioCheckedCategory}
                    ...
                    <div className='category-content-wrapper'>
                        <div className='self-start category-labels'>
                            ...
                            <p>
                                Provide a concise description of the category. This will help customers understand the
                                types of products offered within this category. Keep it informative and under 160
                                characters.
                            </p>
                        </div>
                        <div className='relative'>
                            ...
                            <textarea
                                ...
                                required
                                className='pl-[21px] w-[20rem] h-[7rem] resize-none border border-primary rounded-[5px] 
                                        text-[12px] overflow-hidden placeholder:text-[9px] placeholder:text-[#6b7280] '
                                onFocus={(e) => inputFocusHandler(e)}
                                onBlur={(e) => inputBlurHandler(e, "categoryDescription")}
                                onChange={(e) => changeHandler(e, "categoryDescription")}
                    ...
                    <div className='category-content-wrapper'>
                        <div className='category-labels'>
                            ...
                            <p>
                                Set the start and end dates for seasonal activation of this category. This allows you to
                                automatically display or hide the category for time-limited promotions or seasonal
                                products.
                            </p>
                        </div>
                    ...
                    <div className='category-content-wrapper'>
                        <div className='category-labels' id='relative-category'>
                            ...
                            <p>
                                Select related categories to link this category with others. This will help improve
                                product discovery by showing customers similar categories.
                            </p>
                        </div>
                        <div className='relative' ref={dropdownRefs.relatedCatDropdown}>
                            ...
                            <div
                                className={`w-[20rem] h-[3rem] border border-primary rounded-[5px] flex justify-center 
                                    items-center pr-0 text-[12px] bg-white cursor-pointer 
                                ...
                                {relatedCategory && (
                                    <div className='flex items-center gap-[5px] ml-[10%]'>
                                        {relatedCategory.map((cat, index) => (
                                            <span
                                                key={index}
                                                className=' flex items-center gap-[2px] border border-secondary rounded-[10px] 
                                                    px-[9px] py-[1px] text-[10px] text-secondary'>
                                                <span> {cat} </span>
                                                <IoIosClose
                                                    className='w-[15px] h-[15px]'
                                                    onClick={(e) => {
                                                        setRelatedCategory((relatedCat) =>
                                                            relatedCat.filter((rcat) => rcat !== cat),
                                                        )
                            ...
                            {openDropdowns.relatedCatDropdown && (
                                <div
                                    className='absolute top-[47px] flex flex-col justify-center items-center gap-[3px] 
                                        w-full h-fit py-[10px] px-[10%] rounded-[5px] bg-white border border-primary 
                                        rounded-tl-none rounded-tr-none z-[5]'
                                >

                                    <CategoryDisplay
                                        type='manualCheckboxType'
                                        manualCheckCategory={manualCheckCategory}
                                        setManualCheckCategory={setManualCheckCategory}
                                        setRelatedCategoryError={setRelatedCategoryError}
                                        styler={{ borderBottomNone: true }}
                                    />

                                    {relatedCategoryError && (
                                        <p className='error mb-[1rem]'> {relatedCategoryError} </p>
                                    )}
                    ...
                    <div className='category-content-wrapper'>
                        <div className='category-labels'>
                            ...
                            <p>
                                Enter a discount percentage to apply across all products in this category. This can be
                                used to run special promotions or sales.
                            </p>
                        </div>
                        <div className='relative'>
                            ...
                            <input
                                ...
                                className='pl-[21px]'
                                onFocus={(e) => inputFocusHandler(e)}
                                onBlur={(e) => inputBlurHandler(e, "categoryDiscount", { optionalField: true })}
                                onChange={(e) => changeHandler(e, "categoryDiscount")}
                                value={categoryData.categoryDiscount}
                            />
                            <p
                                className='error'
                                onClick={(e) => cancelErrorState(e, primaryColor.current, { optionalField: true })}></p>
                        </div>
                    </div>
                    ...
                    <div className='category-content-wrapper'>
                        <div className='category-labels'>
                            ...
                            <p>
                                Enter or choose one from the dropdown list, a short badge for this category. This badge
                                will be displayed prominently on the website. Keep it concise and under 15 characters.
                            </p>
                        </div>
                        <div className='relative' ref={dropdownRefs.badgeDropdown}>
                            <PlaceholderIcon icon={<SlBadge />} />
                            <div
                                className={`w-[20rem] h-[2.4rem] border border-primary rounded-[5px] pr-0 flex items-center justify-between
                                ...
                                <input
                                    ...
                                    required
                                    className='pl-[23px]'
                                    style={{ width: "17rem", height: "100%", border: "none", borderRadius: "none" }}
                                    onFocus={(e) => badgeFocusHandler(e)}
                                    onBlur={() => hiddenInputRef.current.click()}
                                    onClick={(e) => toggleDropdown("badgeDropdown")}
                                    onChange={(e) => changeHandler(e, "categoryBadge")}
                                    value={categoryData.categoryBadge}
                                    placeholder='You can enter a badge or choose one from the dropdown'
                                />
                                <i className='pr-[5px] cursor-pointer'>
                                    {" "}
                                    <MdArrowDropDown />{" "}
                                </i>
                            </div>
                            <input
                                type='hidden'
                                ref={hiddenInputRef}
                                onClick={(e) => inputBlurHandler(e, "categoryBadge", { optionalField: true })}
                                value={categoryData.categoryBadge}
                            />
                            <p
                                className='error'
                            ...
                            {/* Should come this in the place of <i>*/}
                            {openDropdowns.badgeDropdown && (
                                <div
                                    className='absolute top-[34px] flex flex-col justify-center items-center gap-[3px] w-full h-full
                                                rounded-[5px] bg-white border border-primary rounded-tl-none rounded-tr-none '
                                    ref={badgeListRef}>
                                    {commonBadges.current.map((name) => (
                                        <span
                                            key={name}
                                            className='text-[11px] text-secondary capitalize w-full text-center hover:bg-primary cursor-pointer'
