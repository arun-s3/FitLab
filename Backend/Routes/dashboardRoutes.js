...
} = require("../Controllers/dashboardControllers/salesInsightsController")

const {
    getOrdersStats,
    getMonthlyOrderStats,
    getTopFiveProductsByOrders,
    getOrderStatusDistribution,
} = require("../Controllers/dashboardControllers/ordersInsightsController")

const {
    getUserMetrics,
    getUserTypePercentages,
    getMonthlyCustomersGrowth,
    getTopVIPCustomers,
...
const {
    ...
    getLowStockProducts,
    getCategoryStockDatas,
} = require("../Controllers/dashboardControllers/inventoryInsightsController")

const {
    getCouponRevenueStats,
    getCouponStats,
    getCouponRedemptionDetails,
    getDiscountImpactDatas,
...
const {
    getWalletAndRefundStats,
    getPaymentMethodStats,
    getMonthlyRefundRequests,
} = require("../Controllers/dashboardControllers/paymentInsightsController")
