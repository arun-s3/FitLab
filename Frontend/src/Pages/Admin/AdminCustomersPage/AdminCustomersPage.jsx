...
export default function AdminCustomersPageV1() {
    ...
    const toggleBlockHandler = (id) => {
        setLocalUsers((prevUsers) =>
            prevUsers.map((user) => (user._id === id ? { ...user, isBlocked: !user.isBlocked } : user)),
        )
    ...
    return (
        <section className='h-screen z-[-1]' id='AdminCustomersPage'>
            ...
            <main
                className='p-[1rem] border border-secondary flex items-center justify-center w-[80%] 
                                    rounded-[9px] gap-[5px]'
                style={mainBgImg}>
                {openModal && (
                    <Modal
                        ...
                        title='Important'
                        content='You are about to mark this customer
                    ...
                    >
                        <p className='text-red-500 -mt-4 mb-6 text-[12px]'>
                            The customer will be flagged and automatically blocked. You can remove this flag later, but
                            you will also need to manually unblock the user.
                        </p>
                        <textarea
                            type='text'
                            rows={3}
                            cols={2}
                            maxLength={500}
                            placeholder='Customer suspicions/offences or criminal activities (required)'
                            value={riskyUserNotes}
                            onChange={(e) => setRiskyUserNotes(e.target.value)}
                            className='w-full text-[14px] bg-gray-50 border border-gray-300 
                ...
                <table cellSpacing={10} cellPadding={10} className='border-spacing-[24px]'>
                    <thead>
                        <tr>
                            <td colSpan='2'>
                                <div className='flex gap-[8px]' id='searcher'>
                                    <input
                                        type='search'
                                        placeholder='Search..'
                                        className='secondaryLight-box text-[13px] border-primary
                                                   rounded-[8px] text-secondary w-full h-[35px] pl-[10px] focus:ring-secondary'
                                        onChange={(e) => searchHandler(e.target.value)}
                                    />
                                    <span
                                        className='self-end px-[3px] mb-[3px] bg-primary rounded-[4px] cursor-pointer relative case-tooltip'
                                        style={
                                            matchCase
                                                ? {
                                                      outlineWidth: "1.5px",
                            ...
                            <td>
                                <div
                                    className='w-[9rem] inline-flex relative items-center justify-between secondaryLight-box 
                                        cursor-pointer text-[13px] px-[11px] h-[35px] border-solid bottom-0 border-secondary 
                                        customer-dropdown'
                                    onClick={(e) => toggleDropdown("statusDropdown")}
                                    ref={dropdownRefs.statusDropdown}
                                >
                                    {openDropdowns.statusDropdown && (
                                        <ul
                                            className='list-none w-full px-[10px] py-[1rem] absolute top-[44px] right-0 flex flex-col
                                        ...
                                        >
                                            {["active", "blocked", "all"].map((statusType) => (
                                                <li
                                                    key={`${statusType}`}
                                                    className={`px-[8px] py-[5px] flex items-center gap-[8px]
                                                ...
                                                >
                                                    ...
                                                    <span className='text-[12px]'>
                                                        {" "}
                                                        {camelToCapitalizedWords(statusType)}{" "}
                                                    </span>
                                                </li>
                                            ))}
                                        </ul>
                                    ...
                                    {status && (
                                        <button className='ml-[15px] whitespace-nowrap capitalize'>
                                            {" "}
                                            {`Status: ${status}`}{" "}
                                        </button>
                                    )}
                                    <RiArrowDropDownLine
                                        style={{ color: "rgba(159, 42, 240, 1)" }}
                            ...
                            <td>
                                <div
                                    className='relative w-[10rem] inline-flex items-center justify-between secondaryLight-box cursor-pointer
                                        text-[13px] px-[11px] h-[35px] customer-dropdown'
                                    onClick={(e) => toggleDropdown("limitDropdown")}
                                    ref={dropdownRefs.limitDropdown}
                                >
                                    {limit && <button className='ml-[15px]'> {`Show Entries:  ${limit}`} </button>}
                                    <RiArrowDropDownLine style={{ color: "rgba(159, 42, 240, 1) " }} />
                                    {limit && openDropdowns.limitDropdown && (
                                        <ul
                                            className='absolute top-[44px] right-[3px] py-[10px] w-[30%] rounded-b-[4px] flex 
                                        ...
                                        >
                                            {[6, 10, 15, 20, 25, 30, 35, 40].map((limit) => (
                                                <li key={limit} onClick={() => setLimit(limit)}>
                                                    {" "}
                                                    {limit}{" "}
                                                </li>
                                            ))}
                        ...
                        <tr className='secondaryLight-box border border-[rgb(220, 230, 166)] font-[500] text-secondary table-header'>
                            <td>
                                <div className='flex items-center'>
                                    ...
                                    <i className='flex flex-col h-[5px]'>
                                        <FaSortUp
                                            onClick={(e) => {
                                                sortHandler(e, "username", 1)
                                            }}
                                            style={{
                                                height:
                                                    activeSorter.field === "username" && activeSorter.order === 1
                                                        ? "15px"
                                                        : "10px",
                                                color:
                                                    activeSorter.field === "username" && activeSorter.order === 1
                                        ...
                                        />
                                        <FaSortDown
                                            onClick={(e) => sortHandler(e, "username", -1)}
                                            style={{
                                                height:
                                                    activeSorter.field === "username" && activeSorter.order === -1
                                                        ? "15px"
                            ...
                            <td>
                                <div className='flex items-center'>
                                    ...
                                    <i className='flex flex-col h-[5px]'>
                                        <FaSortUp
                                            onClick={(e) => sortHandler(e, "email", 1)}
                                            style={{
                                                height:
                                                    activeSorter.field === "email" && activeSorter.order === 1
                                                        ? "15px"
                                                        : "10px",
                                                color:
                                                    activeSorter.field === "email" && activeSorter.order === 1
                            ...
                            <td>
                                <div className='flex items-center'>
                                    ...
                                    <i className='flex flex-col h-[5px]'>
                                        <FaSortUp
                                            onClick={(e) => sortHandler(e, "mobile", 1)}
                                            style={{
                                                height:
                                                    activeSorter.field === "mobile" && activeSorter.order === 1
                                                        ? "15px"
                                                        : "10px",
                                                color:
                                                    activeSorter.field === "mobile" && activeSorter.order === 1
                            ...
                            <td>
                                <div className='flex items-center'>
                                    ...
                                    <i className='flex flex-col h-[5px]'>
                                        <FaSortUp
                                            onClick={(e) => sortHandler(e, "walletBalance", 1)}
                                            style={{
                                                height:
                                                    activeSorter.field === "walletBalance" && activeSorter.order === 1
                                                        ? "15px"
                                                        : "10px",
                                                color:
                                                    activeSorter.field === "walletBalance" && activeSorter.order === 1
                                    ...
                                    <span className='text-[12px]'>
                                        {timerDelay ? (
                                            <span className='text-red-500 ml-[6px] tracking-[0.3px] whitespace-nowrap align-[1px]'>
                                                <span
                                                    className='text-green-500 font-bold mr-[4px] cursor-pointer'
                                                    onClick={(e) => undoSuspicionChargeHandler()}
                                                >
                                                    Undo?
                                                </span>{" "}
                                                Flagging suspicious in {timerDelay} seconds...`
                                            </span>
                                        ) : null}
                                    </span>
                                </p>
                    ...
                    <tbody className='text-[13px]'>
                        {localUsers.length > 0 ? (
                            localUsers.map((user, index) => (
                                <tr
                                    key={user._id}
                                    className={`${index % 2 == 0 ? "bg-[#eee]" : "bg-transparent"} cursor-pointer hover:bg-[#f3f7df]`}>
                                    <td>
                                            ...
                                            {(() => {
                                                ...
                                                return (
                                                    <motion.span
                                                        ...
                                                        animate={
                                                            isOnline
                                                                ? { scale: [1, 1.2], opacity: [0.5, 1] }
                                                                : { scale: [1, 1.1], opacity: [0.4, 1] }
                                                        }
                                                        transition={{
                                                            duration: 1.5,
                                                            repeat: Infinity,
                                        ...
                                        <div className='flex items-center gap-[10px] text-[14px] action-buttons'>
                                            {!user?.riskyUserStatus ? (
                                                <SitePrimaryMinimalButtonWithShadow
                                                    type='button'
                                                    tailwindClasses='basis-[103px] !hover:bg-yellow-400'
