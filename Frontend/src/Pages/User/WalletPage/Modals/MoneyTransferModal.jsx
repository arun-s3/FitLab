...
export default function MoneyTransferModal({
    ...
    const { safeWallet, walletLoading, walletError, peerAccountAdded, moneySent, moneyRequested } = useSelector(
        (state) => state.wallet,
    )
    ...
    const handleTransferSubmit = (e) => {
        ...
        if (!userTermsConsent) {
            sonnerToast.warning("Please review and accept our Terms & Conditions and Privacy Policy to continue.", {
                duration: 5500,
            })
            return
        }
        ...
        const targetAccountNumber = isRequester
            ...
            >
                ...
                >
                    {transferSuccess ? (
                        ...
                        >
                            <div className='w-16 h-16 bg-green-100 dark:bg-green-900 rounded-full flex items-center 
                                justify-center mb-4'
                            >
                            ...
                            <motion.button
                                ...
                                className='inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background
                                    ...
                                    disabled:opacity-50 bg-primary text-primary-foreground hover:bg-green-400 h-10 px-4 py-2'
                            >
                                Done
                            </motion.button>
                        </motion.div>
                            ...
                            <div className='p-4 space-y-4'>
                                {!selectedPeerAccount ? (
                                    <div className='space-y-4'>
                                        {((!isRequester && decryptedWallet?.beneficiaryAccounts.length > 0) ||
                                            ...
                                            <div className='space-y-2'>
                                                <label className='text-sm font-medium'>
                                                    {" "}
                                                    {!isRequester ? "Select Recipient" : "Select Creditor"}{" "}
                                                </label>
                                                <div className='space-y-2'>
                                                    {(function generateRecepientOrCreditor() {
                                                        const accountGroup = !isRequester
                                                            ? decryptedWallet?.beneficiaryAccounts
                                                            : decryptedWallet?.creditorAccounts

                                                        return accountGroup.map((account) => (
                                                            <div
                                                                key={account._id}
                                        ...
                                        <div
                                            className={`relative 
                                                ${!isRequester && decryptedWallet?.beneficiaryAccounts.length <= 0 && "hidden"}
                                        ...
                                        {isAddingPeerAccount ? (
                                            <div className='border rounded-md p-4 space-y-4'>
                                                <div className='!mb-[2rem] flex items-center justify-between'>
                                                    <h3 className='text-[17px] text-secondary font-[550]'>
                                                        Add New Recipient
                                                    </h3>
                                                    <button
                                                        type='button'
                                                ...
                                                <div className='space-y-2'>
                                                    ...
                                                    <div className='relative'>
                                                        <input
                                                            ...
                                                            } rounded-md focus:outline-none focus:border-none focus-within:ring-0 
                                                            focus:ring-2 focus:ring-secondary dark:bg-gray-800`}
                                                        />
                                                        {newPeerAccountErrors.name && (
                                                            <p className='absolute mt-[4px] text-[11px] text-red-500'>
                                                                {newPeerAccountErrors.name}
                                                            </p>
                                                        )}
                                                    </div>
                                                ...
                                                <div className='!mt-[1.5rem] space-y-2'>
                                                    ...
                                                    <div className='relative'>
                                                        <input
                                                            id='accountNumber'
                                                            type='text'
                                                            value={newPeerAccount.accountNumber}
                                                ...
                                                <button
                                                    ...
                                                    className='w-full !mt-[1.5rem] px-4 py-2 text-sm
                                                        font-medium text-white bg-secondary rounded-md hover:bg-purple-700 
                                                        focus:outline-none focus:border-none focus:ring-purple-700'
                                                >
                                            ...
                                            <>
                                                ...
                                                <button
                                                    type='button'
                                                    onClick={() => setIsAddingPeerAccount(true)}
                                                    className='mt-[1rem] w-full flex items-center justify-center text-[15px] 
                                                        gap-2 border border-dashed p-[7px] rounded-md text-gray-500
                                    ...
                                    <>
                                        <div className='bg-gray-50 dark:bg-gray-800 p-4 border border-dashed 
                                            border-inputBorderLow rounded-lg'
                                        >
                                            <div className='flex items-center mb-2'>
                                                <User className='h-5 w-5 text-secondary dark:text-gray-400 mr-2' />
                                                <span className='text-[15px] font-medium'>
                                                    {" "}
                                                    {!isRequester ? "Recipient" : "Creditor"}{" "}
                                                </span>
                                                {complexModal && (
                                                    <button
                                                        type='button'
                                                        onClick={() => setSelectedPeerAccount(null)}
                                            ...
                                            <div className='pl-7'>
                                                ...
                                                <div className='flex items-center mt-1'>
                                                    <CreditCard className='h-[15px] w-[15px] text-gray-500 mr-1' />
                                        ...
                                        <div className='space-y-2'>
                                            ...
                                            <div className='relative'>
                                                <IndianRupee className='absolute left-3 top-1/2 -translate-y-1/2 h-[15px] w-[15px]' />
                                                <input
                                                    id='amount'
                                                    type='text'
                                        ...
                                        {!isRequester ? (
                                                ...
                                                <div className='flex items-start mt-4'>
                                                    <div className='flex items-center h-5'>
                                                        <input
                                                            id='confirmation'
                                                            type='checkbox'
                                                            checked={transferConfirmationChecked}
                                                            onChange={(e) =>
                                                                setTransferConfirmationChecked(e.target.checked)
                                                            }
                                                    ...
                                                    <label
                                                        ...
                                                        className='ml-2 text-[12px] text-gray-600 dark:text-gray-300'>
                                                        I confirm that I want to send money to this recipient and the
                                            ...
                                            <p className='text-[10px] text-muted whitespace-nowrap'>
                                                This is a request only. Funds will move only if the other user approves
                                                and sends money.
                                            </p>
                                        )}
                                                ...
                                                <div className='bg-blue-50 p-3 rounded-md mt-4'>
                                                    <div className='flex justify-between items-center'>
                                                        <span className='text-sm font-medium'>
                                                            {" "}
                                                            {!isRequester ? "You're sending" : "You're requesting"}{" "}
                                                        </span>
                                                    ...
                                                    <div className='flex items-center text-[13px] text-gray-600 mt-1'>
                                                        <span>
                                                            {!isRequester
                                                                ? "Your wallet"
                                                                : selectedPeerAccount.name
                                    ...
                                    <button
                                        ...
                                        disabled={
                                            ...
                                            (!transferAmount ||
                                                isNaN(Number.parseFloat(transferAmount)) ||
                                                Number.parseFloat(transferAmount) <= 0 ||
                                                Number.parseFloat(transferAmount) > walletBalance ||
                                                !transferConfirmationChecked)
                                        }
                                        className='px-4 py-2 text-sm font-medium text-white bg-secondary rounded-md 
                                            hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-700 
