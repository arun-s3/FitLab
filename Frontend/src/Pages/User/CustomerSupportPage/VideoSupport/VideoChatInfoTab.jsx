            ...
            {callState !== "hidden" && (
                ...
                >
                    <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                        <motion.div animate={{ height: isMinimized ? 60 : "auto" }} transition={{ duration: 0.3 }}>
                            {callState === "incoming" && (
                                <div className='py-6'>
                                    <div className='flex items-center justify-between'>
                                        ...
                                        <div className='flex items-center space-x-3'>
                                            <motion.button
                                                ...
                                                className='w-12 h-12 bg-red-500 hover:bg-red-600 rounded-full flex 
                                                    items-center justify-center text-white transition-colors z-[100]'
                                            >
                                            ...
                                            <motion.button
                                                ...
                                                className='w-12 h-12 bg-green-500 hover:bg-green-600 rounded-full flex 
                                    ...
                                    <div className='flex items-center justify-between'>
                                        <div className='flex items-center space-x-4'>
                                            ...
                                            <div className='flex-1'>
                                                ...
                                                {!isMinimized && (
                                                    <p className='text-[14px] text-gray-500'>Call in progress</p>
                                                )}
                                            </div>
                                        </div>
                                    </div>
