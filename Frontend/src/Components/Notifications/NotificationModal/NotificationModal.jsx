        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    >
                        <motion.div
                            className={`w-full max-w-sm rounded-lg border-2 ${currentStyle.bgColor} ${currentStyle.borderColor} 
                        ...
                        >
                                ...
                                <div className='flex items-center gap-4'>
                                    <motion.div
                                        ...
                                        className={`flex-shrink-0 w-12 h-12 rounded-full 
                                            ${currentStyle.iconBgColor} flex items-center justify-center`
                                        }
                                    >
                                        {IconComponent ? (
                            ...
                            <motion.div
                                ...
                                className='px-6 pb-4'
                            >
                                <p className='text-gray-700 dark:text-gray-300 leading-relaxed text-sm'>{content}</p>
                            </motion.div>
                                    ...
                                    <button
                                        ...
                                        className={`flex-1 px-4 py-2 rounded-md font-medium text-sm transition-all duration-200 ${
                                            actionButton.variant === "secondary"
                                                ...
                                                : "bg-blue-600 text-white hover:bg-blue-700 dark:hover:bg-blue-600 shadow-lg hover:shadow-xl"
                                        }`}
                                    >
                                        {actionButton.label}
                                    </button>
