...
import { PhoneOff, Video, Headset, Clock, Calendar, X, Dumbbell } from "lucide-react"
...
export default function VideoCallModal({ videoSessionInfo, onClose }) {
    ...
    const { socket, forceEndScheduledSession, setForceEndScheduledSession, scheduledVideoCallSessionId } =
        socketContextItems
                    ...
                    >
                        ...
                        >
                                ...
                                <div className='relative'>
                                    {!isScheduled && (
                                        <button
                                            ...
                                            className='absolute top-4 right-4 z-10 w-8 h-8 bg-white bg-opacity-20 
                                    ...
                                    <div
                                        ...
                                        <div className='relative z-10 text-center'>
                                            ...
                                            >
                                                <div
                                                    className='w-20 h-20 bg-white bg-opacity-20 rounded-full 
                                            ...
                                            <div
                                                className='inline-flex items-center space-x-1 bg-white bg-opacity-20 
                                    ...
                                    <div className='px-6 py-4 bg-gray-50'>
                                        <div className='text-center'>
                                            ...
                                            {isScheduled && (
                                                <div
                                                    className={`${callerInfo.customerNotes ? "flex flex-col gap-4" : "mt-4"}`}>
                                                    <p className={`text-xs text-muted`}>
                                                        Get personalized advice for all your concerns!
                                                    </p>
                                                    {callerInfo?.customerNotes && (
                                                        <p className='ml-[18px] text-left text-xs text-gray-400'>
                                                            <span className='text-secondary'> Your Notes: </span>
                                                            {callerInfo.customerNotes.length > 40
                                                                ? callerInfo.customerNotes.slice(0, 40) + "..."
                                                                : callerInfo.customerNotes}
                                                        </p>
                                                    )}
                                                </div>
                                        ...
                                        <div className='flex space-x-4'>
                                            <motion.button
                                                ...
                                                className='flex-1 bg-gray-100 hover:bg-gray-200 text-gray-700 py-3 px-4 
                                                    rounded-xl font-medium transition-colors flex items-center justify-center space-x-2'
                                            >
                                            ...
                                            <motion.button
                                                ...
                                                className='flex-1 bg-green-500 hover:bg-green-600 text-white py-3 px-4 
                                                    rounded-xl font-medium transition-colors flex items-center justify-center space-x-2'
                                            >
                            ...
                            {callState === "declined" && (
                                ...
                                >
                                    <div className='w-16 h-16 bg-red-100 rounded-full flex items-center j
                                        ustify-center mx-auto mb-4'>
                                    ...
                                    <div className='space-y-3'>
                                        ...
                                        <motion.button
                                            ...
                                            className='w-full bg-gray-100 hover:bg-gray-200 text-gray-700 py-3 
                                                px-4 rounded-xl font-medium transition-colors'
                                        >
                                            Close
                                        </motion.button>
                                    </div>
