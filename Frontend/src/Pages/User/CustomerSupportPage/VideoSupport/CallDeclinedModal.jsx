                        ...
                        >
                            ...
                            <div className='px-6 py-6'>
                                <div className='text-center mb-6'>
                                    ...
                                    >
                                        We apologize, but our customer care experts are currently assisting other
                                        members and cannot take your call right now.
                                    </motion.p>
                                </div>
                                ...
                                <div className='flex flex-col sm:flex-row gap-3'>
                                    <motion.button
                                        ...
                                        className='flex-1 bg-blue-600 hover:bg-blue-700 text-white font-medium py-3
                                            px-4 rounded-lg transition-colors duration-200 text-sm'
                                        onClick={onClose}
                                    >
                                        Try Again Later
                                    </motion.button>
