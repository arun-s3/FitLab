...
export default function UserQueueCard({ user, position, onAccept, onDecline, disabled }) {
    ...
    return (
        <motion.div
            ...
            className='bg-gradient-to-br from-gray-50 to-white rounded-2xl p-6 border border-gray-200 shadow-lg 
                hover:shadow-xl transition-all duration-300'
        >
            <div className='flex items-center mb-4'>
                <div className='w-12 h-12 bg-gradient-to-br from-purple-400 to-purple-600 rounded-full flex 
                ...
                <div>
                    <h3 className='font-semibold text-gray-800 flex items-center gap-[5px]'>
                        ...
                        {user.username.includes("guest") && (
                            <span className='italic text-[14px] text-secondary'> (Guest) </span>
                        )}
                    </h3>
            ...
            <div className='flex space-x-3'>
                <motion.button
                    ...
                    onClick={onAccept}
                    disabled={disabled}
                    className={`flex-1 flex items-center justify-center space-x-2 py-3 px-4 rounded-xl font-semibold 
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={onDecline}
                    className='flex items-center justify-center p-3 rounded-xl bg-red-100 text-red-600 
            ...
            <div className='mt-3 pt-3 border-t border-gray-200'>
                <button
                    ...
                    className='flex items-center space-x-2 text-sm text-gray-500 hover:text-secondary 
