...
export const InputLabelGenerator = React.memo(
    ({
        name,
        label,
        optionalField,
                        ...
                        <div>
                            {!(fieldType === "textarea") ? (
                                ...
                                <>
                                    <textarea
                                        id={inputName}
                                        className={`mt-[5px] w-full min-h-[2rem] px-[10px] text-[13px] 
                                            text-secondary resize-none border-[1.5px] border-inputBorderSecondary
                                            rounded-[4px] bg-inputBgSecondary ${inputStyles ? inputStyles : ""}
                                           caret-primaryDark`}
                                        rows={rows}
                                        onChange={onChange}
                                        value={inputValue}
                            ...
                            <p
                                className={`error ${optionalMsg?.includes("valid") && "text-red-500"}`}
                                onClick={(e) =>
                                    !optionalField
