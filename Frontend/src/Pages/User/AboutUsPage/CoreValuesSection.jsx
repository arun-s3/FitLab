                ...
                <div className='max-w-7xl mx-auto'>
                    ...
                    >
                        <motion.h2
                            ...
                            className='text-4xl md:text-5xl font-bold mb-[5px] text-gray-900'>
                            Our Core Values
                        </motion.h2>
                    ...
                    >
                        {coreValuesArr.map((value, index) => (
                            <motion.div
                                ...
                                className={
                                    `bg-white p-8 rounded-xl transition-all duration-300 ${index === 3 && "col-span-2"}`
                                }
                            >
                                <motion.div className='inline-block p-3 bg-orange-100 rounded-lg mb-4'>
