        ...
        <>
            {refundReqAccepted ? (
                <div className='mx-[1.5rem] mt-[1.5rem]'>
                    <div
                        className='p-[11px] text-[13px] font-[500] flex justify-between items-center
                    ...
                    >
                        <div className='flex items-center gap-[8px]'>
                            ...
                            <span className='font-[13px]'>
                                Your return request for the product has been thoroughly reviewed and approved. Your
