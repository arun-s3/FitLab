    ...
    return (
        <UserPageLayoutContext.Provider
            ...
            <section id='UserPageLayout'>
                ...
                <main
                    className={`${user ? "flex gap-[2rem]" : ""} 
                        ${pageWrapperClasses ? pageWrapperClasses : "gap-[2rem] px-[4rem] mb-[10rem]"} 
                    `}
                    ...
                    <div
                        className={` ${contentTileClasses ? contentTileClasses : "basis-[75%] mt-[2rem] content-tile"} `}
                    >
                        <Outlet />
                    </div>
                </main>
