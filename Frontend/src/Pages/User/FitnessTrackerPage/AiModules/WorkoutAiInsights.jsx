        ...
        try {
            ...
            if (latestWorkoutResponse.status === 200) {
                ...
                const canUseCachedAnalysis =
                    hasAIAnalysis &&
                    ((!hasPrevWorkout && !isRelativeAnalysis) || (hasPrevWorkout && isRelativeAnalysis))
                ...
                const workoutDatas = {
                    analysisType: "latestWorkout",
                    trackerId,
                    lastWorkout: latestWorkout,
                    prevWorkout: prevExercise || null,
                }
            ...
            setError(
                "Something went wrong while finding your workout history! Please check your network and retry later",
            )
        } finally {
            setLoading(false)
        }
