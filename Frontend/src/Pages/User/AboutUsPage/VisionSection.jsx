            ...
            <div className=''>
                <div className='mx-auto max-w-7xl px-6'>
                    ...
                    >
                        ...
                        <h2 className='text-[28px] md:text-[50px] font-bold text-gray-900 max-w-3xl'>
                    ...
                    >
                        We believe fitness is not just about buying equipment — it’s about building sustainable habits,
                        informed training, and measurable progress. FitLab brings together intelligent shopping,
                        personalized coaching, real-time insights, and a connected fitness community to help every
                        individual train smarter, grow stronger, and stay committed for life.
                    </motion.p>
