        ...
        <>
            <motion.button
                ...
                className={`fixed ${isOpen ? "bottom-[10px]" : "bottom-6"} left-6 z-50 flex h-14 w-14 items-center justify-center 
                    rounded-full bg-purple-600 text-white shadow-lg hover:bg-purple-700 focus:outline-none focus:ring-4
            ...
            >
                ...
                {!isOpen && (
                    <X
                        className={`absolute -top-[0.9rem] x-sm:-top-[1.7rem] -right-[9px] x-sm:right-0 p-1 w-[16px] x-sm:w-[20px] 
                            h-[16px] x-sm:h-[20px] text-secondary bg-white shadow-sm rounded-full cursor-pointer z-[70] 
                            hover:scale-105 hover:transition hover:duration-150 hover:ease-in`}
                        onClick={() => onCloseChat()}
                    />
                )}
            </motion.button>
                ...
                {isOpen && (
                    ...
                    >
                        <motion.div
                            ...
                            className='flex items-center justify-between bg-gradient-to-r from-purple-600 to-purple-700 px-6 
                                py-4 text-white'
                        >
                                ...
                                {isCoachLoading && (
                                    <motion.div
                                        ...
                                        <div className='flex gap-2'>
                                            ...
                                            <div className='flex items-center gap-1 rounded-2xl bg-white px-4 py-2 border
                                                border-gray-200'
                                            >
                                                <motion.div
                                                    animate={{ scale: [1, 1.2, 1] }}
                            ...
                            <AnimatePresence>
                                {!user && (
                                    <motion.div
                                        ...
                                        exit={{ opacity: 0, y: -10 }}
                                        className='flex justify-start'>
                                        <p className='p-4 text-[13px] text-secondary tracking-[0.3px] text-wrap 
                                            bg-purple-100 border border-purple-300 rounded-lg'
                                        >
                                            <span
                                            ...
                                            to unlock Coach+, your intelligent personal fitness assistant. Get precise,
                                            customized guidance for your fitness goals, equipment setup, lifestyle
                                            habits, supplements, products — just like having your own personal coach.
                                        </p>
                                    </motion.div>
                                )}
                            </AnimatePresence>
                            ...
                            <AnimatePresence>
                                {(coachError || connectionError) && (
                                    <motion.div
                                        ...
                                        className='flex justify-start'
                                    >
                                        <p className='p-4 text-[13px] text-red-500 tracking-[0.3px] text-wrap bg-red-100 border 
                                            border-red-300 rounded-lg'>
                                            {coachError
                                                ? coachError
                                                : connectionError && "Please check your internet and try again later! "}
                                        </p>
                                    </motion.div>
                                )}
                            </AnimatePresence>
                        ...
                        >
                            <div className='flex items-end gap-2'>
                                <textarea
                                    ...
                                    rows={1}
                                    className='flex-1 resize-none !text-[13px] rounded-[7px] border border-gray-300 
                                        bg-gray-50 px-4 py-3 text-sm text-gray-800 placeholder-gray-400 focus:border-purple-500
                                ...
                                <motion.button
                                    ...
                                    className='flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-purple-600
                                        text-white hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500
